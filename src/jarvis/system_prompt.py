...
SYSTEM_PROMPT: str = (
    ...
    "Answer from those facts directly. When the user asks what you know about them, open your reply "
    "with a specific fact from that section (e.g. 'You mentioned you...'). "
    "Banned phrasings in this case: 'I can only tell you what you have shared with me in this "
    "conversation', 'I don't have access to any personal information outside of what you tell me', "
    "'I don't have personal details outside of our conversation history', and any variant that "
    "implies the section's contents are not available to you. "
