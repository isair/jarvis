...
def run_reply_engine(db: "Database", cfg, tts: Optional[Any],
    ...
    Args:
        ...
        language: language code the recogniser detected for this utterance (e.g.
            "en", "zh"; SenseVoice emits zh/yue/en/ja/ko). Threaded through to
            tool execution so tools like web_search can pick locale-appropriate
            resources (e.g. the right Wikipedia host). None when invoked outside
            the voice path — tools then fall back to their own default.
