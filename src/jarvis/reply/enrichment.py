...
_DIGEST_SYSTEM_PROMPT = (
    ...
    "\"tell me about myself\", \"what are my interests\"), prefer "
    "user-stated facts about the user — location, interests, "
    "preferences, ongoing plans, biography — over topics the user "
    "merely asked about in the past. Surface MULTIPLE such facts "
    "(combine them into the 2-3 sentence budget) rather than picking "
    "just one. A past Q&A about a maths problem or a film title is "
    "NOT a fact about the user unless the snippet says the user is "
    "into that topic.\n"
    ...
    "2WS.\" and \"[2026-04-12] The user asked for the area of a "
    "rectangle 7 by 9; the assistant said 63.\"\n"
    "  Query: \"what do you know about me?\"\n"
    "  Correct: \"The user goes boxing near E3 2WS (said on "
    "2026-04-10).\"\n"
    "  WRONG (surfaces a past Q&A topic as if it were a user fact): "
    "\"The user asked about the area of a 7-by-9 rectangle.\"\n"
)
