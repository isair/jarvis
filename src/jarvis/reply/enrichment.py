...
_DIGEST_SYSTEM_PROMPT = (
    ...
    "concrete facts the user themselves stated. But stay faithful to the "
    "snippets:\n"
    ...
    "in your note must come from the snippets verbatim or be a clear "
    "paraphrase of what a snippet literally says.\n"
    "- You may add NOTHING about a named entity (film, book, product, "
    "person, place, event) beyond what the snippets contain. No year, "
    "cast, director, author, price, location, plot, biography, etc. "
    "unless that exact detail appears inside a snippet. The assistant "
    "has tools to look up entities fresh.\n"
    "- If a snippet says \"the assistant provided information stating X "
    "is Y\" or similar, treat the X=Y claim as UNVERIFIED: either drop "
    "it, or preface the note with \"(unverified prior claim)\". A past "
    "assistant answer is not the same as an established fact. The only "
    "statements you may freely quote are things the USER themselves said "
    "(preferences, biography, decisions, named intents).\n"
    ...
    "The assistant provided information stating it is a 2006 horror "
    "film by Brandon Cronenberg.\"\n"
    "  Query: \"tell me more about the movie Possessor\"\n"
    "  Correct: \"The user previously asked about Possessor on 2026-04-19 "
    "(unverified prior claim: 2006 film by Brandon Cronenberg).\"\n"
    "  WRONG (restates as fact): \"Possessor is a 2006 horror film by "
    "Brandon Cronenberg.\"\n\n"
