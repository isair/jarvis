...
_DIGEST_SYSTEM_PROMPT = (
    ...
    "past user interactions with items in the same domain are relevant as "
    "preference signals even when no explicit preference was stated. Surface "
    "the specific items the user has recently engaged with (films they asked "
    "about, dishes they cooked, artists they listened to, topics they read "
    "about), along with any reactions they expressed and any items they have "
    "already watched/read/tried so the assistant can avoid re-recommending "
    "them. Do NOT return NONE just because the user never stated a preference "
    "in plain words — engagement is itself a signal.\n"
