...
_EVALUATOR_SYSTEM_PROMPT = (
    ...
    "should be — return \"continue\" with a nudge like \"produce a "
    "natural-language reply\" or \"call a tool properly instead of "
    "emitting raw protocol syntax\". Shipping garbled text to the user "
    "is worse than one extra turn. The engine also catches the known "
    "shapes deterministically; your job here is defence-in-depth for "
    "novel leaks.\n\n"
