...
_PROMPT_TEMPLATE = (
    ...
    "meaningfully improve the answer. If the router included a tool "
    "(e.g. `webSearch` for a joke, a recipe, creative content, or any "
    "request where freshness or variety matters), PLAN TO USE IT. The "
    "router already judged the query likely needs external information; "
    "a reply-only plan overrides that judgment and produces a "
    "stale or dismissive answer. When in doubt, prefer a tool step "
    "over a direct reply.\n"
