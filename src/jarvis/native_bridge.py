"""Bridge to the Toustovač Windows audio stack: native audio engine + virtual microphone.
...
__all__ = [
    ...
    "ABI_VERSION",
    "AEC_MODE_OFF",
    "AEC_MODE_WEBRTC_AEC3",
    "AEC_MODE_WINDOWS_ENDPOINT_AEC",
    "PROFILE_STUDIO",
    "PROFILE_ASSISTANT",
    "PROFILE_HOSTILE_PLAYBACK",
    "CONV_DISABLED",
    "CONV_ACQUIRING",
    "CONV_CONVERGED",
    "CONV_DOUBLE_TALK",
    ...
    "DUCK_RELEASING",
    "DUCK_RESTORED_OK",
    "DUCK_RESTORE_PARTIAL",
    "CAP_RAW_CAPTURE",
    "CAP_LOOPBACK",
    "CAP_NATIVE_AEC",
    "CAP_ENDPOINT_REF_CTRL",
    "CAP_POST_VOLUME_REF",
    "OK",
    "STATUS_NAMES",
    "Cfg",
