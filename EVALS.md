...
**Generated:** 2026-04-20 00:42:21

## 📊 TL;DR

**Overall:** 🟢 **182/201 passed (90.5%)** across all categories

| Category | Model | Passed | Failed | Skipped | Pass Rate |
|----------|-------|-------:|-------:|--------:|----------:|
| 🤖 Agent behaviour | `gemma4:e2b` | 67 | 9 | 0 | 🟢 88.2% |
| 🤖 Agent behaviour | `gpt-oss:20b` | 74 | 6 | 0 | 🟢 92.5% |
| 🎤 Intent judge | `gemma4:e2b` (fixed) | 36 | 4 | 0 | 🟢 90.0% |
...
| Follow-up references previous turn context | ❌ 0/1 (0%) | ✅ 1/1 (100%) |
...
| Live unknown entity: Piranesi (book) | ✅ 1/1 (100%) | ❌ 0/1 (0%) |
| Live unknown entity: Possessor (film) | ✅ 1/1 (100%) | ✅ 1/1 (100%) |
| Live unknown entity: have-you-heard-of (Piranesi) | ✅ 1/1 (100%) | ❌ 0/1 (0%) |
...
| No deflection: weekly rain forecast | ❌ 0/1 (0%) | ✅ 1/1 (100%) |
...
| test_enrichment_skips_questions_answered_by_context | ✅ 1/1 (100%) | ❌ 0/1 (0%) |
| test_first_turn_calls_web_search_not_clarification | ✅ 1/1 (100%) | ❌ 0/1 (0%) |
| test_follow_up_after_correction_calls_web_search | ✅ 1/1 (100%) | ❌ 0/1 (0%) |
...
| test_omits_deflection_when_topic_never_resolved | ✅ 1/1 (100%) | ✅ 1/1 (100%) |
| test_open_ended_prompt_grounds_in_graph_context_live | ✅ 1/1 (100%) | ✅ 1/1 (100%) |
...
| test_unknown_entity_with_poisoned_diary_still_triggers_web_search_live | 🔸 1/1 XFAIL | ✅ 1/1 (100%) |
...
|-----------|-----------|:------:|
| alias_after_narrative_context | 0/1 (0%) | ❌ |
...
| multi_person_vague_reference | 0/1 (0%) | ❌ |
