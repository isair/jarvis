...
class FileFeature : public ::protozero::Message {
 public:
  ...
  static constexpr DsoType DSO_KERNEL = DsoType::DSO_KERNEL;
  static constexpr DsoType DSO_KERNEL_MODULE = DsoType::DSO_KERNEL_MODULE;
  static constexpr DsoType DSO_ELF_FILE = DsoType::DSO_ELF_FILE;
  static constexpr DsoType DSO_DEX_FILE = DsoType::DSO_DEX_FILE;
  static constexpr DsoType DSO_SYMBOL_MAP_FILE = DsoType::DSO_SYMBOL_MAP_FILE;
  static constexpr DsoType DSO_UNKNOWN_FILE = DsoType::DSO_UNKNOWN_FILE;
...
class FileFeature_DexFile_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/1, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  ::protozero::RepeatedFieldIterator<uint64_t> dex_file_offset() const { return GetRepeated<uint64_t>(1); }
};
...
void add_dex_file_offset(uint64_t value) {
  static constexpr uint32_t field_id = FieldMetadata_DexFileOffset::kFieldId;
  // Call the appropriate protozero::Message::Append(field_id, ...)
  // method based on the type of the field.
  ::protozero::internal::FieldWriter<
    ::protozero::proto_utils::ProtoSchemaType::kUint64>
