...
class Profile_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/14, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  ::protozero::RepeatedFieldIterator<int64_t> comment() const { return GetRepeated<int64_t>(13); }
...
void add_comment(int64_t value) {
  static constexpr uint32_t field_id = FieldMetadata_Comment::kFieldId;
  // Call the appropriate protozero::Message::Append(field_id, ...)
  // method based on the type of the field.
  ::protozero::internal::FieldWriter<
    ::protozero::proto_utils::ProtoSchemaType::kInt64>
...
class Sample_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  ::protozero::RepeatedFieldIterator<uint64_t> location_id() const { return GetRepeated<uint64_t>(1); }
  bool has_value() const { return at<2>().valid(); }
  ::protozero::RepeatedFieldIterator<int64_t> value() const { return GetRepeated<int64_t>(2); }
