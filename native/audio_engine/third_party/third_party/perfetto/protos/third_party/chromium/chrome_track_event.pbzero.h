...
constexpr BackForwardCacheCanStoreDocumentResult_BackForwardCacheNotRestoredReason BackForwardCacheCanStoreDocumentResult_BackForwardCacheNotRestoredReason_MAX = BackForwardCacheCanStoreDocumentResult_BackForwardCacheNotRestoredReason::CACHE_LIMIT_PRUNED_ON_CRITICAL_MEMORY_PRESSURE;
...
constexpr RendererMainThreadTaskExecution_TaskType RendererMainThreadTaskExecution_TaskType_MAX = RendererMainThreadTaskExecution_TaskType::TASK_TYPE_INTERNAL_AUTOFILL;
...
constexpr SequenceManagerTask_QueueName SequenceManagerTask_QueueName_MAX = SequenceManagerTask_QueueName::NETWORK_SERVICE_THREAD_DEFAULT_TQ;
...
constexpr InputTransferHandler_TransferInputToVizResult InputTransferHandler_TransferInputToVizResult_MAX = InputTransferHandler_TransferInputToVizResult::SEQUENCE_TRANSFERRED_BACK_FROM_VIZ;
...
class BlinkTaskScope : public ::protozero::Message {
 public:
  ...
  static constexpr TaskScopeType TASK_SCOPE_UNKNOWN = TaskScopeType::TASK_SCOPE_UNKNOWN;
  static constexpr TaskScopeType TASK_SCOPE_CALLBACK = TaskScopeType::TASK_SCOPE_CALLBACK;
  static constexpr TaskScopeType TASK_SCOPE_SCHEDULED_ACTION = TaskScopeType::TASK_SCOPE_SCHEDULED_ACTION;
  static constexpr TaskScopeType TASK_SCOPE_SCRIPT_EXECUTION = TaskScopeType::TASK_SCOPE_SCRIPT_EXECUTION;
  static constexpr TaskScopeType TASK_SCOPE_POST_MESSAGE = TaskScopeType::TASK_SCOPE_POST_MESSAGE;
  static constexpr TaskScopeType TASK_SCOPE_POP_STATE = TaskScopeType::TASK_SCOPE_POP_STATE;
  static constexpr TaskScopeType TASK_SCOPE_SCHEDULER_POST_TASK = TaskScopeType::TASK_SCOPE_SCHEDULER_POST_TASK;
  static constexpr TaskScopeType TASK_SCOPE_REQUEST_IDLE_CALLBACK = TaskScopeType::TASK_SCOPE_REQUEST_IDLE_CALLBACK;
  static constexpr TaskScopeType TASK_SCOPE_XML_HTTP_REQUEST = TaskScopeType::TASK_SCOPE_XML_HTTP_REQUEST;
  static constexpr TaskScopeType TASK_SCOPE_SOFT_NAVIGATION = TaskScopeType::TASK_SCOPE_SOFT_NAVIGATION;
...
class ChromeTaskAnnotator : public ::protozero::Message {
 public:
  ...
  static constexpr DelayPolicy FLEXIBLE_NO_SOONER = DelayPolicy::FLEXIBLE_NO_SOONER;
  static constexpr DelayPolicy FLEXIBLE_PREFER_EARLY = DelayPolicy::FLEXIBLE_PREFER_EARLY;
  static constexpr DelayPolicy PRECISE = DelayPolicy::PRECISE;
...
class FrameTreeNodeInfo : public ::protozero::Message {
 public:
  ...
  static constexpr FrameType UNSPECIFIED_FRAME_TYPE = FrameType::UNSPECIFIED_FRAME_TYPE;
  static constexpr FrameType SUBFRAME = FrameType::SUBFRAME;
  static constexpr FrameType PRIMARY_MAIN_FRAME = FrameType::PRIMARY_MAIN_FRAME;
  static constexpr FrameType PRERENDER_MAIN_FRAME = FrameType::PRERENDER_MAIN_FRAME;
  static constexpr FrameType FENCED_FRAME_ROOT = FrameType::FENCED_FRAME_ROOT;
...
class ChildProcessLauncherPriority : public ::protozero::Message {
 public:
  ...
  static constexpr Importance IMPORTANCE_NORMAL = Importance::IMPORTANCE_NORMAL;
  static constexpr Importance IMPORTANCE_MODERATE = Importance::IMPORTANCE_MODERATE;
  static constexpr Importance IMPORTANCE_IMPORTANT = Importance::IMPORTANCE_IMPORTANT;
  static constexpr Importance IMPORTANCE_PERCEPTIBLE = Importance::IMPORTANCE_PERCEPTIBLE;
...
class WebExposedIsolationInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class UrlInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class ChromeSamplingProfilerSampleCollected : public ::protozero::Message {
 public:
  ...
  static constexpr WriteStatus WRITE_STATUS_NONE = WriteStatus::WRITE_STATUS_NONE;
  static constexpr WriteStatus WRITE_STATUS_BUFFERING_SAMPLE = WriteStatus::WRITE_STATUS_BUFFERING_SAMPLE;
  static constexpr WriteStatus WRITE_STATUS_WRITING_BUFFERED = WriteStatus::WRITE_STATUS_WRITING_BUFFERED;
  static constexpr WriteStatus WRITE_STATUS_WRITING_TO_TRACE = WriteStatus::WRITE_STATUS_WRITING_TO_TRACE;
...
class RenderFrameHost : public ::protozero::Message {
 public:
  ...
  static constexpr LifecycleState UNSPECIFIED = LifecycleState::UNSPECIFIED;
  static constexpr LifecycleState SPECULATIVE = LifecycleState::SPECULATIVE;
  static constexpr LifecycleState PENDING_COMMIT = LifecycleState::PENDING_COMMIT;
  static constexpr LifecycleState PRERENDERING = LifecycleState::PRERENDERING;
  static constexpr LifecycleState ACTIVE = LifecycleState::ACTIVE;
  static constexpr LifecycleState IN_BACK_FORWARD_CACHE = LifecycleState::IN_BACK_FORWARD_CACHE;
  static constexpr LifecycleState RUNNING_UNLOAD_HANDLERS = LifecycleState::RUNNING_UNLOAD_HANDLERS;
  static constexpr LifecycleState READY_TO_BE_DELETED = LifecycleState::READY_TO_BE_DELETED;
...
class ChromeThreadPoolTask : public ::protozero::Message {
 public:
  ...
  static constexpr Priority PRIORITY_UNSPECIFIED = Priority::PRIORITY_UNSPECIFIED;
  static constexpr Priority PRIORITY_BEST_EFFORT = Priority::PRIORITY_BEST_EFFORT;
  static constexpr Priority PRIORITY_USER_VISIBLE = Priority::PRIORITY_USER_VISIBLE;
  static constexpr Priority PRIORITY_USER_BLOCKING = Priority::PRIORITY_USER_BLOCKING;
  static constexpr ExecutionMode EXECTUION_MODE_UNSPECIFIED = ExecutionMode::EXECTUION_MODE_UNSPECIFIED;
  static constexpr ExecutionMode EXECUTION_MODE_PARALLEL = ExecutionMode::EXECUTION_MODE_PARALLEL;
  static constexpr ExecutionMode EXECUTION_MODE_SEQUENCED = ExecutionMode::EXECUTION_MODE_SEQUENCED;
  static constexpr ExecutionMode EXECUTION_MODE_SINGLE_THREAD = ExecutionMode::EXECUTION_MODE_SINGLE_THREAD;
  static constexpr ExecutionMode EXECUTION_MODE_JOB = ExecutionMode::EXECUTION_MODE_JOB;
  static constexpr ShutdownBehavior SHUTDOWN_BEHAVIOR_UNSPECIFIED = ShutdownBehavior::SHUTDOWN_BEHAVIOR_UNSPECIFIED;
  static constexpr ShutdownBehavior SHUTDOWN_BEHAVIOR_CONTINUE_ON_SHUTDOWN = ShutdownBehavior::SHUTDOWN_BEHAVIOR_CONTINUE_ON_SHUTDOWN;
  static constexpr ShutdownBehavior SHUTDOWN_BEHAVIOR_SKIP_ON_SHUTDOWN = ShutdownBehavior::SHUTDOWN_BEHAVIOR_SKIP_ON_SHUTDOWN;
  static constexpr ShutdownBehavior SHUTDOWN_BEHAVIOR_BLOCK_SHUTDOWN = ShutdownBehavior::SHUTDOWN_BEHAVIOR_BLOCK_SHUTDOWN;
...
class BackForwardCacheCanStoreDocumentResult : public ::protozero::Message {
 public:
  ...
  static constexpr BackForwardCacheNotRestoredReason NOT_MAIN_FRAME = BackForwardCacheNotRestoredReason::NOT_MAIN_FRAME;
  static constexpr BackForwardCacheNotRestoredReason BACK_FORWARD_CACHE_DISABLED = BackForwardCacheNotRestoredReason::BACK_FORWARD_CACHE_DISABLED;
  static constexpr BackForwardCacheNotRestoredReason RELATED_ACTIVE_CONTENTS_EXIST = BackForwardCacheNotRestoredReason::RELATED_ACTIVE_CONTENTS_EXIST;
  static constexpr BackForwardCacheNotRestoredReason HTTP_STATUS_NOT_OK = BackForwardCacheNotRestoredReason::HTTP_STATUS_NOT_OK;
  static constexpr BackForwardCacheNotRestoredReason SCHEME_NOT_HTTP_OR_HTTPS = BackForwardCacheNotRestoredReason::SCHEME_NOT_HTTP_OR_HTTPS;
  static constexpr BackForwardCacheNotRestoredReason LOADING = BackForwardCacheNotRestoredReason::LOADING;
  static constexpr BackForwardCacheNotRestoredReason WAS_GRANTED_MEDIA_ACCESS = BackForwardCacheNotRestoredReason::WAS_GRANTED_MEDIA_ACCESS;
  static constexpr BackForwardCacheNotRestoredReason BLOCKLISTED_FEATURES = BackForwardCacheNotRestoredReason::BLOCKLISTED_FEATURES;
  static constexpr BackForwardCacheNotRestoredReason DISABLE_FOR_RENDER_FRAME_HOST_CALLED = BackForwardCacheNotRestoredReason::DISABLE_FOR_RENDER_FRAME_HOST_CALLED;
  static constexpr BackForwardCacheNotRestoredReason DOMAIN_NOT_ALLOWED = BackForwardCacheNotRestoredReason::DOMAIN_NOT_ALLOWED;
  static constexpr BackForwardCacheNotRestoredReason HTTP_METHOD_NOT_GET = BackForwardCacheNotRestoredReason::HTTP_METHOD_NOT_GET;
  static constexpr BackForwardCacheNotRestoredReason SUBFRAME_IS_NAVIGATING = BackForwardCacheNotRestoredReason::SUBFRAME_IS_NAVIGATING;
  static constexpr BackForwardCacheNotRestoredReason TIMEOUT = BackForwardCacheNotRestoredReason::TIMEOUT;
  static constexpr BackForwardCacheNotRestoredReason CACHE_LIMIT = BackForwardCacheNotRestoredReason::CACHE_LIMIT;
  static constexpr BackForwardCacheNotRestoredReason JAVASCRIPT_EXECUTION = BackForwardCacheNotRestoredReason::JAVASCRIPT_EXECUTION;
  static constexpr BackForwardCacheNotRestoredReason RENDERER_PROCESS_KILLED = BackForwardCacheNotRestoredReason::RENDERER_PROCESS_KILLED;
  static constexpr BackForwardCacheNotRestoredReason RENDERER_PROCESS_CRASHED = BackForwardCacheNotRestoredReason::RENDERER_PROCESS_CRASHED;
  static constexpr BackForwardCacheNotRestoredReason GRANTED_MEDIA_STREAM_ACCESS = BackForwardCacheNotRestoredReason::GRANTED_MEDIA_STREAM_ACCESS;
  static constexpr BackForwardCacheNotRestoredReason SCHEDULER_TRACKED_FEATURE_USED = BackForwardCacheNotRestoredReason::SCHEDULER_TRACKED_FEATURE_USED;
  static constexpr BackForwardCacheNotRestoredReason CONFLICTING_BROWSING_INSTANCE = BackForwardCacheNotRestoredReason::CONFLICTING_BROWSING_INSTANCE;
  static constexpr BackForwardCacheNotRestoredReason CACHE_FLUSHED = BackForwardCacheNotRestoredReason::CACHE_FLUSHED;
  static constexpr BackForwardCacheNotRestoredReason SERVICE_WORKER_VERSION_ACTIVATION = BackForwardCacheNotRestoredReason::SERVICE_WORKER_VERSION_ACTIVATION;
  static constexpr BackForwardCacheNotRestoredReason SESSION_RESTORED = BackForwardCacheNotRestoredReason::SESSION_RESTORED;
  static constexpr BackForwardCacheNotRestoredReason UNKNOWN = BackForwardCacheNotRestoredReason::UNKNOWN;
  static constexpr BackForwardCacheNotRestoredReason SERVICE_WORKER_POST_MESSAGE = BackForwardCacheNotRestoredReason::SERVICE_WORKER_POST_MESSAGE;
  static constexpr BackForwardCacheNotRestoredReason ENTERED_BACK_FORWARD_CACHE_BEFORE_SERVICE_WORKER_HOST_ADDED = BackForwardCacheNotRestoredReason::ENTERED_BACK_FORWARD_CACHE_BEFORE_SERVICE_WORKER_HOST_ADDED;
  static constexpr BackForwardCacheNotRestoredReason NOT_MOST_RECENT_NAVIGATION_ENTRY = BackForwardCacheNotRestoredReason::NOT_MOST_RECENT_NAVIGATION_ENTRY;
  static constexpr BackForwardCacheNotRestoredReason SERVICE_WORKER_CLAIM = BackForwardCacheNotRestoredReason::SERVICE_WORKER_CLAIM;
  static constexpr BackForwardCacheNotRestoredReason IGNORE_EVENT_AND_EVICT = BackForwardCacheNotRestoredReason::IGNORE_EVENT_AND_EVICT;
  static constexpr BackForwardCacheNotRestoredReason HAVE_INNER_CONTENTS = BackForwardCacheNotRestoredReason::HAVE_INNER_CONTENTS;
  static constexpr BackForwardCacheNotRestoredReason TIMEOUT_PUTTING_IN_CACHE = BackForwardCacheNotRestoredReason::TIMEOUT_PUTTING_IN_CACHE;
  static constexpr BackForwardCacheNotRestoredReason BACK_FORWARD_CACHE_DISABLED_BY_LOW_MEMORY = BackForwardCacheNotRestoredReason::BACK_FORWARD_CACHE_DISABLED_BY_LOW_MEMORY;
  static constexpr BackForwardCacheNotRestoredReason BACK_FORWARD_CACHE_DISABLED_BY_COMMAND_LINE = BackForwardCacheNotRestoredReason::BACK_FORWARD_CACHE_DISABLED_BY_COMMAND_LINE;
  static constexpr BackForwardCacheNotRestoredReason NETWORK_REQUEST_REDIRECTED = BackForwardCacheNotRestoredReason::NETWORK_REQUEST_REDIRECTED;
  static constexpr BackForwardCacheNotRestoredReason NETWORK_REQUEST_TIMEOUT = BackForwardCacheNotRestoredReason::NETWORK_REQUEST_TIMEOUT;
  static constexpr BackForwardCacheNotRestoredReason NETWORK_EXCEEDS_BUFFER_LIMIT = BackForwardCacheNotRestoredReason::NETWORK_EXCEEDS_BUFFER_LIMIT;
  static constexpr BackForwardCacheNotRestoredReason NAVIGATION_CANCELLED_WHILE_RESTORING = BackForwardCacheNotRestoredReason::NAVIGATION_CANCELLED_WHILE_RESTORING;
  static constexpr BackForwardCacheNotRestoredReason BACK_FORWARD_CACHE_DISABLED_FOR_PRERENDER = BackForwardCacheNotRestoredReason::BACK_FORWARD_CACHE_DISABLED_FOR_PRERENDER;
  static constexpr BackForwardCacheNotRestoredReason USER_AGENT_OVERRIDE_DIFFERS = BackForwardCacheNotRestoredReason::USER_AGENT_OVERRIDE_DIFFERS;
  static constexpr BackForwardCacheNotRestoredReason NETWORK_REQUEST_DATAPIPE_DRAINED_AS_BYTES_CONSUMER = BackForwardCacheNotRestoredReason::NETWORK_REQUEST_DATAPIPE_DRAINED_AS_BYTES_CONSUMER;
  static constexpr BackForwardCacheNotRestoredReason FOREGROUND_CACHE_LIMIT = BackForwardCacheNotRestoredReason::FOREGROUND_CACHE_LIMIT;
  static constexpr BackForwardCacheNotRestoredReason BROWSING_INSTANCE_NOT_SWAPPED = BackForwardCacheNotRestoredReason::BROWSING_INSTANCE_NOT_SWAPPED;
  static constexpr BackForwardCacheNotRestoredReason BACK_FORWARD_CACHE_DISABLED_FOR_DELEGATE = BackForwardCacheNotRestoredReason::BACK_FORWARD_CACHE_DISABLED_FOR_DELEGATE;
  static constexpr BackForwardCacheNotRestoredReason OPT_IN_UNLOAD_HEADER_NOT_PRESENT = BackForwardCacheNotRestoredReason::OPT_IN_UNLOAD_HEADER_NOT_PRESENT;
  static constexpr BackForwardCacheNotRestoredReason UNLOAD_HANDLER_EXISTS_IN_MAIN_FRAME = BackForwardCacheNotRestoredReason::UNLOAD_HANDLER_EXISTS_IN_MAIN_FRAME;
  static constexpr BackForwardCacheNotRestoredReason UNLOAD_HANDLER_EXISTS_IN_SUBFRAME = BackForwardCacheNotRestoredReason::UNLOAD_HANDLER_EXISTS_IN_SUBFRAME;
  static constexpr BackForwardCacheNotRestoredReason SERVICE_WORKER_UNREGISTRATION = BackForwardCacheNotRestoredReason::SERVICE_WORKER_UNREGISTRATION;
  static constexpr BackForwardCacheNotRestoredReason CACHE_CONTROL_NO_STORE = BackForwardCacheNotRestoredReason::CACHE_CONTROL_NO_STORE;
  static constexpr BackForwardCacheNotRestoredReason CACHE_CONTROL_NO_STORE_COOKIE_MODIFIED = BackForwardCacheNotRestoredReason::CACHE_CONTROL_NO_STORE_COOKIE_MODIFIED;
  static constexpr BackForwardCacheNotRestoredReason CACHE_CONTROL_NO_STORE_HTTP_ONLY_COOKIE_MODIFIED = BackForwardCacheNotRestoredReason::CACHE_CONTROL_NO_STORE_HTTP_ONLY_COOKIE_MODIFIED;
  static constexpr BackForwardCacheNotRestoredReason NO_RESPONSE_HEAD = BackForwardCacheNotRestoredReason::NO_RESPONSE_HEAD;
  static constexpr BackForwardCacheNotRestoredReason ACTIVATION_NAVIGATION_DISALLOWED_FOR_BUG_1234857 = BackForwardCacheNotRestoredReason::ACTIVATION_NAVIGATION_DISALLOWED_FOR_BUG_1234857;
  static constexpr BackForwardCacheNotRestoredReason ERROR_DOCUMENT = BackForwardCacheNotRestoredReason::ERROR_DOCUMENT;
  static constexpr BackForwardCacheNotRestoredReason FENCED_FRAMES_EMBEDDER = BackForwardCacheNotRestoredReason::FENCED_FRAMES_EMBEDDER;
  static constexpr BackForwardCacheNotRestoredReason COOKIE_DISABLED = BackForwardCacheNotRestoredReason::COOKIE_DISABLED;
  static constexpr BackForwardCacheNotRestoredReason HTTP_AUTH_REQUIRED = BackForwardCacheNotRestoredReason::HTTP_AUTH_REQUIRED;
  static constexpr BackForwardCacheNotRestoredReason COOKIE_FLUSHED = BackForwardCacheNotRestoredReason::COOKIE_FLUSHED;
  static constexpr BackForwardCacheNotRestoredReason BROADCAST_CHANNEL_ON_MESSAGE = BackForwardCacheNotRestoredReason::BROADCAST_CHANNEL_ON_MESSAGE;
  static constexpr BackForwardCacheNotRestoredReason WEBVIEW_SETTINGS_CHANGED = BackForwardCacheNotRestoredReason::WEBVIEW_SETTINGS_CHANGED;
  static constexpr BackForwardCacheNotRestoredReason WEBVIEW_JAVASCRIPT_OBJECT_CHANGED = BackForwardCacheNotRestoredReason::WEBVIEW_JAVASCRIPT_OBJECT_CHANGED;
  static constexpr BackForwardCacheNotRestoredReason WEBVIEW_MESSAGE_LISTENER_INJECTED = BackForwardCacheNotRestoredReason::WEBVIEW_MESSAGE_LISTENER_INJECTED;
  static constexpr BackForwardCacheNotRestoredReason WEBVIEW_SAFE_BROWSING_ALLOWLIST_CHANGED = BackForwardCacheNotRestoredReason::WEBVIEW_SAFE_BROWSING_ALLOWLIST_CHANGED;
  static constexpr BackForwardCacheNotRestoredReason WEBVIEW_DOCUMENT_START_JAVASCRIPT_CHANGED = BackForwardCacheNotRestoredReason::WEBVIEW_DOCUMENT_START_JAVASCRIPT_CHANGED;
  static constexpr BackForwardCacheNotRestoredReason CACHE_CONTROL_NO_STORE_DEVICE_BOUND_SESSION_TERMINATED = BackForwardCacheNotRestoredReason::CACHE_CONTROL_NO_STORE_DEVICE_BOUND_SESSION_TERMINATED;
  static constexpr BackForwardCacheNotRestoredReason CACHE_LIMIT_PRUNED_ON_MODERATE_MEMORY_PRESSURE = BackForwardCacheNotRestoredReason::CACHE_LIMIT_PRUNED_ON_MODERATE_MEMORY_PRESSURE;
  static constexpr BackForwardCacheNotRestoredReason CACHE_LIMIT_PRUNED_ON_CRITICAL_MEMORY_PRESSURE = BackForwardCacheNotRestoredReason::CACHE_LIMIT_PRUNED_ON_CRITICAL_MEMORY_PRESSURE;
...
class RendererMainThreadTaskExecution : public ::protozero::Message {
 public:
  ...
  static constexpr TaskType TASK_TYPE_UNKNOWN = TaskType::TASK_TYPE_UNKNOWN;
  static constexpr TaskType TASK_TYPE_DOM_MANIPULATION = TaskType::TASK_TYPE_DOM_MANIPULATION;
  static constexpr TaskType TASK_TYPE_USER_INTERACTION = TaskType::TASK_TYPE_USER_INTERACTION;
  static constexpr TaskType TASK_TYPE_NETWORKING = TaskType::TASK_TYPE_NETWORKING;
  static constexpr TaskType TASK_TYPE_NETWORKING_CONTROL = TaskType::TASK_TYPE_NETWORKING_CONTROL;
  static constexpr TaskType TASK_TYPE_HISTORY_TRAVERSAL = TaskType::TASK_TYPE_HISTORY_TRAVERSAL;
  static constexpr TaskType TASK_TYPE_EMBED = TaskType::TASK_TYPE_EMBED;
  static constexpr TaskType TASK_TYPE_MEDIA_ELEMENT_EVENT = TaskType::TASK_TYPE_MEDIA_ELEMENT_EVENT;
  static constexpr TaskType TASK_TYPE_CANVAS_BLOB_SERIALIZATION = TaskType::TASK_TYPE_CANVAS_BLOB_SERIALIZATION;
  static constexpr TaskType TASK_TYPE_MICROTASK = TaskType::TASK_TYPE_MICROTASK;
  static constexpr TaskType TASK_TYPE_JAVASCRIPT_TIMER_DELAYED_HIGH_NESTING = TaskType::TASK_TYPE_JAVASCRIPT_TIMER_DELAYED_HIGH_NESTING;
  static constexpr TaskType TASK_TYPE_REMOTE_EVENT = TaskType::TASK_TYPE_REMOTE_EVENT;
  static constexpr TaskType TASK_TYPE_WEB_SOCKET = TaskType::TASK_TYPE_WEB_SOCKET;
  static constexpr TaskType TASK_TYPE_POSTED_MESSAGE = TaskType::TASK_TYPE_POSTED_MESSAGE;
  static constexpr TaskType TASK_TYPE_UNSHIPPED_PORT_MESSAGE = TaskType::TASK_TYPE_UNSHIPPED_PORT_MESSAGE;
  static constexpr TaskType TASK_TYPE_FILE_READING = TaskType::TASK_TYPE_FILE_READING;
  static constexpr TaskType TASK_TYPE_DATABASE_ACCESS = TaskType::TASK_TYPE_DATABASE_ACCESS;
  static constexpr TaskType TASK_TYPE_PRESENTATION = TaskType::TASK_TYPE_PRESENTATION;
  static constexpr TaskType TASK_TYPE_SENSOR = TaskType::TASK_TYPE_SENSOR;
  static constexpr TaskType TASK_TYPE_PERFORMANCE_TIMELINE = TaskType::TASK_TYPE_PERFORMANCE_TIMELINE;
  static constexpr TaskType TASK_TYPE_WEB_GL = TaskType::TASK_TYPE_WEB_GL;
  static constexpr TaskType TASK_TYPE_IDLE_TASK = TaskType::TASK_TYPE_IDLE_TASK;
  static constexpr TaskType TASK_TYPE_MISC_PLATFORM_API = TaskType::TASK_TYPE_MISC_PLATFORM_API;
  static constexpr TaskType TASK_TYPE_INTERNAL_DEFAULT = TaskType::TASK_TYPE_INTERNAL_DEFAULT;
  static constexpr TaskType TASK_TYPE_INTERNAL_LOADING = TaskType::TASK_TYPE_INTERNAL_LOADING;
  static constexpr TaskType TASK_TYPE_INTERNAL_TEST = TaskType::TASK_TYPE_INTERNAL_TEST;
  static constexpr TaskType TASK_TYPE_INTERNAL_WEB_CRYPTO = TaskType::TASK_TYPE_INTERNAL_WEB_CRYPTO;
  static constexpr TaskType TASK_TYPE_INTERNAL_MEDIA = TaskType::TASK_TYPE_INTERNAL_MEDIA;
  static constexpr TaskType TASK_TYPE_INTERNAL_MEDIA_REALTIME = TaskType::TASK_TYPE_INTERNAL_MEDIA_REALTIME;
  static constexpr TaskType TASK_TYPE_INTERNAL_USER_INTERACTION = TaskType::TASK_TYPE_INTERNAL_USER_INTERACTION;
  static constexpr TaskType TASK_TYPE_INTERNAL_INSPECTOR = TaskType::TASK_TYPE_INTERNAL_INSPECTOR;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8 = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_COMPOSITOR = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_COMPOSITOR;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_DEFAULT = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_DEFAULT;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_INPUT = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_INPUT;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_IDLE = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_IDLE;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_CONTROL = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_CONTROL;
  static constexpr TaskType TASK_TYPE_INTERNAL_INTERSECTION_OBSERVER = TaskType::TASK_TYPE_INTERNAL_INTERSECTION_OBSERVER;
  static constexpr TaskType TASK_TYPE_COMPOSITOR_THREAD_TASK_QUEUE_DEFAULT = TaskType::TASK_TYPE_COMPOSITOR_THREAD_TASK_QUEUE_DEFAULT;
  static constexpr TaskType TASK_TYPE_WORKER_THREAD_TASK_QUEUE_DEFAULT = TaskType::TASK_TYPE_WORKER_THREAD_TASK_QUEUE_DEFAULT;
  static constexpr TaskType TASK_TYPE_WORKER_THREAD_TASK_QUEUE_V8 = TaskType::TASK_TYPE_WORKER_THREAD_TASK_QUEUE_V8;
  static constexpr TaskType TASK_TYPE_WORKER_THREAD_TASK_QUEUE_COMPOSITOR = TaskType::TASK_TYPE_WORKER_THREAD_TASK_QUEUE_COMPOSITOR;
  static constexpr TaskType TASK_TYPE_COMPOSITOR_THREAD_TASK_QUEUE_INPUT = TaskType::TASK_TYPE_COMPOSITOR_THREAD_TASK_QUEUE_INPUT;
  static constexpr TaskType TASK_TYPE_NETWORKING_WITH_URL_LOADER_ANNOTATION = TaskType::TASK_TYPE_NETWORKING_WITH_URL_LOADER_ANNOTATION;
  static constexpr TaskType TASK_TYPE_WORKER_ANIMATION = TaskType::TASK_TYPE_WORKER_ANIMATION;
  static constexpr TaskType TASK_TYPE_INTERNAL_TRANSLATION = TaskType::TASK_TYPE_INTERNAL_TRANSLATION;
  static constexpr TaskType TASK_TYPE_FONT_LOADING = TaskType::TASK_TYPE_FONT_LOADING;
  static constexpr TaskType TASK_TYPE_APPLICATION_LIFECYCLE = TaskType::TASK_TYPE_APPLICATION_LIFECYCLE;
  static constexpr TaskType TASK_TYPE_BACKGROUND_FETCH = TaskType::TASK_TYPE_BACKGROUND_FETCH;
  static constexpr TaskType TASK_TYPE_PERMISSION = TaskType::TASK_TYPE_PERMISSION;
  static constexpr TaskType TASK_TYPE_SERVICE_WORKER_CLIENT_MESSAGE = TaskType::TASK_TYPE_SERVICE_WORKER_CLIENT_MESSAGE;
  static constexpr TaskType TASK_TYPE_INTERNAL_CONTENT_CAPTURE = TaskType::TASK_TYPE_INTERNAL_CONTENT_CAPTURE;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_MEMORY_PURGE = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_MEMORY_PURGE;
  static constexpr TaskType TASK_TYPE_INTERNAL_NAVIGATION_ASSOCIATED = TaskType::TASK_TYPE_INTERNAL_NAVIGATION_ASSOCIATED;
  static constexpr TaskType TASK_TYPE_INTERNAL_NAVIGATION_ASSOCIATED_UNFREEZABLE = TaskType::TASK_TYPE_INTERNAL_NAVIGATION_ASSOCIATED_UNFREEZABLE;
  static constexpr TaskType TASK_TYPE_INTERNAL_CONTINUE_SCRIPT_LOADING = TaskType::TASK_TYPE_INTERNAL_CONTINUE_SCRIPT_LOADING;
  static constexpr TaskType TASK_TYPE_WEB_LOCKS = TaskType::TASK_TYPE_WEB_LOCKS;
  static constexpr TaskType TASK_TYPE_WEB_SCHEDULING_POSTED_TASK = TaskType::TASK_TYPE_WEB_SCHEDULING_POSTED_TASK;
  static constexpr TaskType TASK_TYPE_INTERNAL_FRAME_LIFE_CYCLE_CONTROL = TaskType::TASK_TYPE_INTERNAL_FRAME_LIFE_CYCLE_CONTROL;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_NON_WAKING = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_NON_WAKING;
  static constexpr TaskType TASK_TYPE_INTERNAL_FIND_IN_PAGE = TaskType::TASK_TYPE_INTERNAL_FIND_IN_PAGE;
  static constexpr TaskType TASK_TYPE_INTERNAL_HIGH_PRIORITY_LOCAL_FRAME = TaskType::TASK_TYPE_INTERNAL_HIGH_PRIORITY_LOCAL_FRAME;
  static constexpr TaskType TASK_TYPE_JAVASCRIPT_TIMER_IMMEDIATE = TaskType::TASK_TYPE_JAVASCRIPT_TIMER_IMMEDIATE;
  static constexpr TaskType TASK_TYPE_JAVASCRIPT_TIMER_DELAYED_LOW_NESTING = TaskType::TASK_TYPE_JAVASCRIPT_TIMER_DELAYED_LOW_NESTING;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_IPC_TRACKING = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_IPC_TRACKING;
  static constexpr TaskType TASK_TYPE_NETWORKING_UNFREEZABLE = TaskType::TASK_TYPE_NETWORKING_UNFREEZABLE;
  static constexpr TaskType TASK_TYPE_WAKE_LOCK = TaskType::TASK_TYPE_WAKE_LOCK;
  static constexpr TaskType TASK_TYPE_INTERNAL_INPUT_BLOCKING = TaskType::TASK_TYPE_INTERNAL_INPUT_BLOCKING;
  static constexpr TaskType TASK_TYPE_WEB_GPU = TaskType::TASK_TYPE_WEB_GPU;
  static constexpr TaskType TASK_TYPE_INTERNAL_POST_MESSAGE_FORWARDING = TaskType::TASK_TYPE_INTERNAL_POST_MESSAGE_FORWARDING;
  static constexpr TaskType TASK_TYPE_INTERNAL_NAVIGATION_CANCELLATION = TaskType::TASK_TYPE_INTERNAL_NAVIGATION_CANCELLATION;
  static constexpr TaskType TASK_TYPE_LOW_PRIORITY_SCRIPT_EXECUTION = TaskType::TASK_TYPE_LOW_PRIORITY_SCRIPT_EXECUTION;
  static constexpr TaskType TASK_TYPE_STORAGE = TaskType::TASK_TYPE_STORAGE;
  static constexpr TaskType TASK_TYPE_NETWORKING_UNFREEZABLE_RENDER_BLOCKING_LOADING = TaskType::TASK_TYPE_NETWORKING_UNFREEZABLE_RENDER_BLOCKING_LOADING;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8_USER_VISIBLE = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8_USER_VISIBLE;
  static constexpr TaskType TASK_TYPE_CLIPBOARD = TaskType::TASK_TYPE_CLIPBOARD;
  static constexpr TaskType TASK_TYPE_MACHINE_LEARNING = TaskType::TASK_TYPE_MACHINE_LEARNING;
  static constexpr TaskType TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8_BEST_EFFORT = TaskType::TASK_TYPE_MAIN_THREAD_TASK_QUEUE_V8_BEST_EFFORT;
  static constexpr TaskType TASK_TYPE_INTERNAL_AUTOFILL = TaskType::TASK_TYPE_INTERNAL_AUTOFILL;
  static constexpr FrameType FRAME_TYPE_UNSPECIFIED = FrameType::FRAME_TYPE_UNSPECIFIED;
  static constexpr FrameType FRAME_TYPE_MAIN_FRAME = FrameType::FRAME_TYPE_MAIN_FRAME;
  static constexpr FrameType FRAME_TYPE_SAME_ORIGIN_SUBFRAME = FrameType::FRAME_TYPE_SAME_ORIGIN_SUBFRAME;
  static constexpr FrameType FRAME_TYPE_CROSS_ORIGIN_SUBFRAME = FrameType::FRAME_TYPE_CROSS_ORIGIN_SUBFRAME;
...
class EventLatency_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class EventLatency : public ::protozero::Message {
 public:
  ...
  static constexpr EventType EVENT_TYPE_UNSPECIFIED = EventType::EVENT_TYPE_UNSPECIFIED;
  static constexpr EventType MOUSE_PRESSED = EventType::MOUSE_PRESSED;
  static constexpr EventType MOUSE_RELEASED = EventType::MOUSE_RELEASED;
  static constexpr EventType MOUSE_WHEEL = EventType::MOUSE_WHEEL;
  static constexpr EventType KEY_PRESSED = EventType::KEY_PRESSED;
  static constexpr EventType KEY_RELEASED = EventType::KEY_RELEASED;
  static constexpr EventType TOUCH_PRESSED = EventType::TOUCH_PRESSED;
  static constexpr EventType TOUCH_RELEASED = EventType::TOUCH_RELEASED;
  static constexpr EventType TOUCH_MOVED = EventType::TOUCH_MOVED;
  static constexpr EventType GESTURE_SCROLL_BEGIN = EventType::GESTURE_SCROLL_BEGIN;
  static constexpr EventType GESTURE_SCROLL_UPDATE = EventType::GESTURE_SCROLL_UPDATE;
  static constexpr EventType GESTURE_SCROLL_END = EventType::GESTURE_SCROLL_END;
  static constexpr EventType GESTURE_DOUBLE_TAP = EventType::GESTURE_DOUBLE_TAP;
  static constexpr EventType GESTURE_LONG_PRESS = EventType::GESTURE_LONG_PRESS;
  static constexpr EventType GESTURE_LONG_TAP = EventType::GESTURE_LONG_TAP;
  static constexpr EventType GESTURE_SHOW_PRESS = EventType::GESTURE_SHOW_PRESS;
  static constexpr EventType GESTURE_TAP = EventType::GESTURE_TAP;
  static constexpr EventType GESTURE_TAP_CANCEL = EventType::GESTURE_TAP_CANCEL;
  static constexpr EventType GESTURE_TAP_DOWN = EventType::GESTURE_TAP_DOWN;
  static constexpr EventType GESTURE_TAP_UNCONFIRMED = EventType::GESTURE_TAP_UNCONFIRMED;
  static constexpr EventType GESTURE_TWO_FINGER_TAP = EventType::GESTURE_TWO_FINGER_TAP;
  static constexpr EventType FIRST_GESTURE_SCROLL_UPDATE = EventType::FIRST_GESTURE_SCROLL_UPDATE;
  static constexpr EventType MOUSE_DRAGGED = EventType::MOUSE_DRAGGED;
  static constexpr EventType GESTURE_PINCH_BEGIN = EventType::GESTURE_PINCH_BEGIN;
  static constexpr EventType GESTURE_PINCH_END = EventType::GESTURE_PINCH_END;
  static constexpr EventType GESTURE_PINCH_UPDATE = EventType::GESTURE_PINCH_UPDATE;
  static constexpr EventType INERTIAL_GESTURE_SCROLL_UPDATE = EventType::INERTIAL_GESTURE_SCROLL_UPDATE;
  static constexpr EventType MOUSE_MOVED_EVENT = EventType::MOUSE_MOVED_EVENT;
...
class ProcessSingleton : public ::protozero::Message {
 public:
  ...
  static constexpr RemoteProcessInteractionResult INTERACTION_RESULT_UNSPECIFIED = RemoteProcessInteractionResult::INTERACTION_RESULT_UNSPECIFIED;
  static constexpr RemoteProcessInteractionResult TERMINATE_FAILED = RemoteProcessInteractionResult::TERMINATE_FAILED;
  static constexpr RemoteProcessInteractionResult REMOTE_PROCESS_NOT_FOUND = RemoteProcessInteractionResult::REMOTE_PROCESS_NOT_FOUND;
  static constexpr RemoteProcessInteractionResult TERMINATE_WAIT_TIMEOUT = RemoteProcessInteractionResult::TERMINATE_WAIT_TIMEOUT;
  static constexpr RemoteProcessInteractionResult RUNNING_PROCESS_NOTIFY_ERROR = RemoteProcessInteractionResult::RUNNING_PROCESS_NOTIFY_ERROR;
  static constexpr RemoteProcessInteractionResult TERMINATE_NOT_ENOUGH_PERMISSIONS = RemoteProcessInteractionResult::TERMINATE_NOT_ENOUGH_PERMISSIONS;
  static constexpr RemoteProcessInteractionResult REMOTE_PROCESS_SHUTTING_DOWN = RemoteProcessInteractionResult::REMOTE_PROCESS_SHUTTING_DOWN;
  static constexpr RemoteProcessInteractionResult PROFILE_UNLOCKED = RemoteProcessInteractionResult::PROFILE_UNLOCKED;
  static constexpr RemoteProcessInteractionResult PROFILE_UNLOCKED_BEFORE_KILL = RemoteProcessInteractionResult::PROFILE_UNLOCKED_BEFORE_KILL;
  static constexpr RemoteProcessInteractionResult SAME_BROWSER_INSTANCE = RemoteProcessInteractionResult::SAME_BROWSER_INSTANCE;
  static constexpr RemoteProcessInteractionResult SAME_BROWSER_INSTANCE_BEFORE_KILL = RemoteProcessInteractionResult::SAME_BROWSER_INSTANCE_BEFORE_KILL;
  static constexpr RemoteProcessInteractionResult FAILED_TO_EXTRACT_PID = RemoteProcessInteractionResult::FAILED_TO_EXTRACT_PID;
  static constexpr RemoteProcessInteractionResult INVALID_LOCK_FILE = RemoteProcessInteractionResult::INVALID_LOCK_FILE;
  static constexpr RemoteProcessInteractionResult ORPHANED_LOCK_FILE = RemoteProcessInteractionResult::ORPHANED_LOCK_FILE;
  static constexpr RemoteProcessInteractionResult USER_REFUSED_TERMINATION = RemoteProcessInteractionResult::USER_REFUSED_TERMINATION;
  static constexpr RemoteProcessInteractionResult TERMINATE_SUCCEEDED = RemoteProcessInteractionResult::TERMINATE_SUCCEEDED;
  static constexpr RemoteHungProcessTerminateReason TERMINATE_REASON_UNSPECIFIED = RemoteHungProcessTerminateReason::TERMINATE_REASON_UNSPECIFIED;
  static constexpr RemoteHungProcessTerminateReason USER_ACCEPTED_TERMINATION = RemoteHungProcessTerminateReason::USER_ACCEPTED_TERMINATION;
  static constexpr RemoteHungProcessTerminateReason NO_VISIBLE_WINDOW_FOUND = RemoteHungProcessTerminateReason::NO_VISIBLE_WINDOW_FOUND;
  static constexpr RemoteHungProcessTerminateReason NOTIFY_ATTEMPTS_EXCEEDED = RemoteHungProcessTerminateReason::NOTIFY_ATTEMPTS_EXCEEDED;
  static constexpr RemoteHungProcessTerminateReason SOCKET_WRITE_FAILED = RemoteHungProcessTerminateReason::SOCKET_WRITE_FAILED;
  static constexpr RemoteHungProcessTerminateReason SOCKET_READ_FAILED = RemoteHungProcessTerminateReason::SOCKET_READ_FAILED;
...
class SequenceManagerTask : public ::protozero::Message {
 public:
  ...
  static constexpr Priority UNKNOWN = Priority::UNKNOWN;
  static constexpr Priority CONTROL_PRIORITY = Priority::CONTROL_PRIORITY;
  static constexpr Priority HIGHEST_PRIORITY = Priority::HIGHEST_PRIORITY;
  static constexpr Priority VERY_HIGH_PRIORITY = Priority::VERY_HIGH_PRIORITY;
  static constexpr Priority HIGH_PRIORITY = Priority::HIGH_PRIORITY;
  static constexpr Priority NORMAL_PRIORITY = Priority::NORMAL_PRIORITY;
  static constexpr Priority LOW_PRIORITY = Priority::LOW_PRIORITY;
  static constexpr Priority BEST_EFFORT_PRIORITY = Priority::BEST_EFFORT_PRIORITY;
  static constexpr Priority HIGH_PRIORITY_CONTINUATION = Priority::HIGH_PRIORITY_CONTINUATION;
  static constexpr Priority NORMAL_PRIORITY_CONTINUATION = Priority::NORMAL_PRIORITY_CONTINUATION;
  static constexpr Priority LOW_PRIORITY_CONTINUATION = Priority::LOW_PRIORITY_CONTINUATION;
  static constexpr Priority EXTREMELY_HIGH_PRIORITY = Priority::EXTREMELY_HIGH_PRIORITY;
  static constexpr QueueName UNKNOWN_TQ = QueueName::UNKNOWN_TQ;
  static constexpr QueueName DEFAULT_TQ = QueueName::DEFAULT_TQ;
  static constexpr QueueName TASK_ENVIRONMENT_DEFAULT_TQ = QueueName::TASK_ENVIRONMENT_DEFAULT_TQ;
  static constexpr QueueName TEST2_TQ = QueueName::TEST2_TQ;
  static constexpr QueueName TEST_TQ = QueueName::TEST_TQ;
  static constexpr QueueName CONTROL_TQ = QueueName::CONTROL_TQ;
  static constexpr QueueName SUBTHREAD_CONTROL_TQ = QueueName::SUBTHREAD_CONTROL_TQ;
  static constexpr QueueName SUBTHREAD_DEFAULT_TQ = QueueName::SUBTHREAD_DEFAULT_TQ;
  static constexpr QueueName SUBTHREAD_INPUT_TQ = QueueName::SUBTHREAD_INPUT_TQ;
  static constexpr QueueName UI_BEST_EFFORT_TQ = QueueName::UI_BEST_EFFORT_TQ;
  static constexpr QueueName UI_BOOTSTRAP_TQ = QueueName::UI_BOOTSTRAP_TQ;
  static constexpr QueueName UI_CONTROL_TQ = QueueName::UI_CONTROL_TQ;
  static constexpr QueueName UI_DEFAULT_TQ = QueueName::UI_DEFAULT_TQ;
  static constexpr QueueName UI_NAVIGATION_NETWORK_RESPONSE_TQ = QueueName::UI_NAVIGATION_NETWORK_RESPONSE_TQ;
  static constexpr QueueName UI_RUN_ALL_PENDING_TQ = QueueName::UI_RUN_ALL_PENDING_TQ;
  static constexpr QueueName UI_SERVICE_WORKER_STORAGE_CONTROL_RESPONSE_TQ = QueueName::UI_SERVICE_WORKER_STORAGE_CONTROL_RESPONSE_TQ;
  static constexpr QueueName UI_THREAD_TQ = QueueName::UI_THREAD_TQ;
  static constexpr QueueName UI_USER_BLOCKING_TQ = QueueName::UI_USER_BLOCKING_TQ;
  static constexpr QueueName UI_USER_INPUT_TQ = QueueName::UI_USER_INPUT_TQ;
  static constexpr QueueName UI_USER_VISIBLE_TQ = QueueName::UI_USER_VISIBLE_TQ;
  static constexpr QueueName IO_BEST_EFFORT_TQ = QueueName::IO_BEST_EFFORT_TQ;
  static constexpr QueueName IO_BOOTSTRAP_TQ = QueueName::IO_BOOTSTRAP_TQ;
  static constexpr QueueName IO_CONTROL_TQ = QueueName::IO_CONTROL_TQ;
  static constexpr QueueName IO_DEFAULT_TQ = QueueName::IO_DEFAULT_TQ;
  static constexpr QueueName IO_NAVIGATION_NETWORK_RESPONSE_TQ = QueueName::IO_NAVIGATION_NETWORK_RESPONSE_TQ;
  static constexpr QueueName IO_RUN_ALL_PENDING_TQ = QueueName::IO_RUN_ALL_PENDING_TQ;
  static constexpr QueueName IO_SERVICE_WORKER_STORAGE_CONTROL_RESPONSE_TQ = QueueName::IO_SERVICE_WORKER_STORAGE_CONTROL_RESPONSE_TQ;
  static constexpr QueueName IO_THREAD_TQ = QueueName::IO_THREAD_TQ;
  static constexpr QueueName IO_USER_BLOCKING_TQ = QueueName::IO_USER_BLOCKING_TQ;
  static constexpr QueueName IO_USER_INPUT_TQ = QueueName::IO_USER_INPUT_TQ;
  static constexpr QueueName IO_USER_VISIBLE_TQ = QueueName::IO_USER_VISIBLE_TQ;
  static constexpr QueueName COMPOSITOR_TQ = QueueName::COMPOSITOR_TQ;
  static constexpr QueueName DETACHED_TQ = QueueName::DETACHED_TQ;
  static constexpr QueueName FRAME_DEFERRABLE_TQ = QueueName::FRAME_DEFERRABLE_TQ;
  static constexpr QueueName FRAME_LOADING_CONTROL_TQ = QueueName::FRAME_LOADING_CONTROL_TQ;
  static constexpr QueueName FRAME_LOADING_TQ = QueueName::FRAME_LOADING_TQ;
  static constexpr QueueName FRAME_PAUSABLE_TQ = QueueName::FRAME_PAUSABLE_TQ;
  static constexpr QueueName FRAME_THROTTLEABLE_TQ = QueueName::FRAME_THROTTLEABLE_TQ;
  static constexpr QueueName FRAME_UNPAUSABLE_TQ = QueueName::FRAME_UNPAUSABLE_TQ;
  static constexpr QueueName IDLE_TQ = QueueName::IDLE_TQ;
  static constexpr QueueName INPUT_TQ = QueueName::INPUT_TQ;
  static constexpr QueueName IPC_TRACKING_FOR_CACHED_PAGES_TQ = QueueName::IPC_TRACKING_FOR_CACHED_PAGES_TQ;
  static constexpr QueueName NON_WAKING_TQ = QueueName::NON_WAKING_TQ;
  static constexpr QueueName OTHER_TQ = QueueName::OTHER_TQ;
  static constexpr QueueName V8_TQ = QueueName::V8_TQ;
  static constexpr QueueName WEB_SCHEDULING_TQ = QueueName::WEB_SCHEDULING_TQ;
  static constexpr QueueName WORKER_IDLE_TQ = QueueName::WORKER_IDLE_TQ;
  static constexpr QueueName WORKER_PAUSABLE_TQ = QueueName::WORKER_PAUSABLE_TQ;
  static constexpr QueueName WORKER_THREAD_INTERNAL_TQ = QueueName::WORKER_THREAD_INTERNAL_TQ;
  static constexpr QueueName WORKER_THROTTLEABLE_TQ = QueueName::WORKER_THROTTLEABLE_TQ;
  static constexpr QueueName WORKER_UNPAUSABLE_TQ = QueueName::WORKER_UNPAUSABLE_TQ;
  static constexpr QueueName WORKER_WEB_SCHEDULING_TQ = QueueName::WORKER_WEB_SCHEDULING_TQ;
  static constexpr QueueName UI_USER_BLOCKING_DEFERRABLE_TQ = QueueName::UI_USER_BLOCKING_DEFERRABLE_TQ;
  static constexpr QueueName IO_USER_BLOCKING_DEFERRABLE_TQ = QueueName::IO_USER_BLOCKING_DEFERRABLE_TQ;
  static constexpr QueueName UI_BEFORE_UNLOAD_BROWSER_RESPONSE_TQ = QueueName::UI_BEFORE_UNLOAD_BROWSER_RESPONSE_TQ;
  static constexpr QueueName IO_BEFORE_UNLOAD_BROWSER_RESPONSE_TQ = QueueName::IO_BEFORE_UNLOAD_BROWSER_RESPONSE_TQ;
  static constexpr QueueName V8_USER_VISIBLE_TQ = QueueName::V8_USER_VISIBLE_TQ;
  static constexpr QueueName V8_BEST_EFFORT_TQ = QueueName::V8_BEST_EFFORT_TQ;
  static constexpr QueueName NETWORK_SERVICE_THREAD_HIGH_TQ = QueueName::NETWORK_SERVICE_THREAD_HIGH_TQ;
  static constexpr QueueName NETWORK_SERVICE_THREAD_DEFAULT_TQ = QueueName::NETWORK_SERVICE_THREAD_DEFAULT_TQ;
...
class AndroidToolbar : public ::protozero::Message {
 public:
  ...
  static constexpr BlockCaptureReason BLOCKED_UNKNOWN = BlockCaptureReason::BLOCKED_UNKNOWN;
  static constexpr BlockCaptureReason BLOCKED_TOOLBAR_OR_RESULT_NULL = BlockCaptureReason::BLOCKED_TOOLBAR_OR_RESULT_NULL;
  static constexpr BlockCaptureReason BLOCKED_VIEW_NOT_DIRTY = BlockCaptureReason::BLOCKED_VIEW_NOT_DIRTY;
  static constexpr BlockCaptureReason BLOCKED_SNAPSHOT_SAME = BlockCaptureReason::BLOCKED_SNAPSHOT_SAME;
  static constexpr BlockCaptureReason BLOCKED_URL_BAR_HAS_FOCUS = BlockCaptureReason::BLOCKED_URL_BAR_HAS_FOCUS;
  static constexpr BlockCaptureReason BLOCKED_URL_BAR_FOCUS_IN_PROGRESS = BlockCaptureReason::BLOCKED_URL_BAR_FOCUS_IN_PROGRESS;
  static constexpr BlockCaptureReason BLOCKED_OPTIONAL_BUTTON_ANIMATION_IN_PROGRESS = BlockCaptureReason::BLOCKED_OPTIONAL_BUTTON_ANIMATION_IN_PROGRESS;
  static constexpr BlockCaptureReason BLOCKED_STATUS_ICON_ANIMATION_IN_PROGRESS = BlockCaptureReason::BLOCKED_STATUS_ICON_ANIMATION_IN_PROGRESS;
  static constexpr BlockCaptureReason BLOCKED_SCROLL_ABLATION = BlockCaptureReason::BLOCKED_SCROLL_ABLATION;
  static constexpr BlockCaptureReason BLOCKED_BROWSER_CONTROLS_LOCKED = BlockCaptureReason::BLOCKED_BROWSER_CONTROLS_LOCKED;
  static constexpr BlockCaptureReason BLOCKED_TAB_SWITCHER_MODE = BlockCaptureReason::BLOCKED_TAB_SWITCHER_MODE;
  static constexpr BlockCaptureReason BLOCKED_COMPOSITOR_IN_MOTION = BlockCaptureReason::BLOCKED_COMPOSITOR_IN_MOTION;
  static constexpr BlockCaptureReason BLOCKED_NTP_Y_TRANSLATION = BlockCaptureReason::BLOCKED_NTP_Y_TRANSLATION;
  static constexpr BlockCaptureReason BLOCKED_FULLSCREEN = BlockCaptureReason::BLOCKED_FULLSCREEN;
  static constexpr AllowCaptureReason ALLOWED_UNKNOWN = AllowCaptureReason::ALLOWED_UNKNOWN;
  static constexpr AllowCaptureReason ALLOWED_FORCE_CAPTURE = AllowCaptureReason::ALLOWED_FORCE_CAPTURE;
  static constexpr AllowCaptureReason ALLOWED_SNAPSHOT_DIFFERENCE = AllowCaptureReason::ALLOWED_SNAPSHOT_DIFFERENCE;
  static constexpr SnapshotDifference DIFF_NONE = SnapshotDifference::DIFF_NONE;
  static constexpr SnapshotDifference DIFF_NULL = SnapshotDifference::DIFF_NULL;
  static constexpr SnapshotDifference DIFF_TINT = SnapshotDifference::DIFF_TINT;
  static constexpr SnapshotDifference DIFF_TAB_COUNT = SnapshotDifference::DIFF_TAB_COUNT;
  static constexpr SnapshotDifference DIFF_OPTIONAL_BUTTON = SnapshotDifference::DIFF_OPTIONAL_BUTTON;
  static constexpr SnapshotDifference DIFF_VISUAL_STATE = SnapshotDifference::DIFF_VISUAL_STATE;
  static constexpr SnapshotDifference DIFF_SECURITY_ICON = SnapshotDifference::DIFF_SECURITY_ICON;
  static constexpr SnapshotDifference DIFF_SHOWING_UPDATE_BADGE = SnapshotDifference::DIFF_SHOWING_UPDATE_BADGE;
  static constexpr SnapshotDifference DIFF_PAINT_PREVIEW = SnapshotDifference::DIFF_PAINT_PREVIEW;
  static constexpr SnapshotDifference DIFF_PROGRESS = SnapshotDifference::DIFF_PROGRESS;
  static constexpr SnapshotDifference DIFF_LOCATION_BAR_WIDTH = SnapshotDifference::DIFF_LOCATION_BAR_WIDTH;
  static constexpr SnapshotDifference DIFF_URL_TEXT = SnapshotDifference::DIFF_URL_TEXT;
  static constexpr SnapshotDifference DIFF_HOME_BUTTON = SnapshotDifference::DIFF_HOME_BUTTON;
  static constexpr SnapshotDifference DIFF_TITLE_TEXT = SnapshotDifference::DIFF_TITLE_TEXT;
  static constexpr SnapshotDifference DIFF_CCT_ANIMATION = SnapshotDifference::DIFF_CCT_ANIMATION;
  static constexpr SnapshotDifference DIFF_BOOKMARK_BUTTON = SnapshotDifference::DIFF_BOOKMARK_BUTTON;
  static constexpr SnapshotDifference DIFF_BACK_BUTTON = SnapshotDifference::DIFF_BACK_BUTTON;
  static constexpr SnapshotDifference DIFF_FORWARD_BUTTON = SnapshotDifference::DIFF_FORWARD_BUTTON;
  static constexpr SnapshotDifference DIFF_RELOAD_BUTTON = SnapshotDifference::DIFF_RELOAD_BUTTON;
...
class BlinkExecutionContext : public ::protozero::Message {
 public:
  ...
  static constexpr ContextType UNKNOWN_CONTEXT = ContextType::UNKNOWN_CONTEXT;
  static constexpr ContextType WINDOW = ContextType::WINDOW;
  static constexpr ContextType WORKLET = ContextType::WORKLET;
  static constexpr ContextType DEDICATED_WORKER = ContextType::DEDICATED_WORKER;
  static constexpr ContextType SHARED_WORKER = ContextType::SHARED_WORKER;
  static constexpr ContextType SERVICE_WORKER = ContextType::SERVICE_WORKER;
  static constexpr WorldType WORLD_UNKNOWN = WorldType::WORLD_UNKNOWN;
  static constexpr WorldType WORLD_MAIN = WorldType::WORLD_MAIN;
  static constexpr WorldType WORLD_ISOLATED = WorldType::WORLD_ISOLATED;
  static constexpr WorldType WORLD_INSPECTOR_ISOLATED = WorldType::WORLD_INSPECTOR_ISOLATED;
  static constexpr WorldType WORLD_REG_EXP = WorldType::WORLD_REG_EXP;
  static constexpr WorldType WORLD_FOR_V8_CONTEXT_SNAPSHOT_NON_MAIN = WorldType::WORLD_FOR_V8_CONTEXT_SNAPSHOT_NON_MAIN;
  static constexpr WorldType WORLD_WORKER = WorldType::WORLD_WORKER;
  static constexpr WorldType WORLD_SHADOW_REALM = WorldType::WORLD_SHADOW_REALM;
...
class BlinkHighEntropyAPI_FontLookup : public ::protozero::Message {
 public:
  ...
  static constexpr FontLookupType FONT_LOOKUP_UNKNOWN_TYPE = FontLookupType::FONT_LOOKUP_UNKNOWN_TYPE;
  static constexpr FontLookupType FONT_LOOKUP_UNIQUE_OR_FAMILY_NAME = FontLookupType::FONT_LOOKUP_UNIQUE_OR_FAMILY_NAME;
  static constexpr FontLookupType FONT_LOOKUP_UNIQUE_NAME_ONLY = FontLookupType::FONT_LOOKUP_UNIQUE_NAME_ONLY;
...
class BlinkHighEntropyAPI_JSFunctionArgument : public ::protozero::Message {
 public:
  ...
  static constexpr ArgumentType UNKNOWN_TYPE = ArgumentType::UNKNOWN_TYPE;
  static constexpr ArgumentType NULL_TYPE = ArgumentType::NULL_TYPE;
  static constexpr ArgumentType UNDEFINED = ArgumentType::UNDEFINED;
  static constexpr ArgumentType BIGINT = ArgumentType::BIGINT;
  static constexpr ArgumentType BOOLEAN = ArgumentType::BOOLEAN;
  static constexpr ArgumentType FUNCTION = ArgumentType::FUNCTION;
  static constexpr ArgumentType NUMBER = ArgumentType::NUMBER;
  static constexpr ArgumentType STRING = ArgumentType::STRING;
  static constexpr ArgumentType SYMBOL = ArgumentType::SYMBOL;
  static constexpr ArgumentType OBJECT = ArgumentType::OBJECT;
...
class TabSwitchMeasurement : public ::protozero::Message {
 public:
  ...
  static constexpr Result RESULT_UNSPECIFIED = Result::RESULT_UNSPECIFIED;
  static constexpr Result RESULT_SUCCESS = Result::RESULT_SUCCESS;
  static constexpr Result RESULT_INCOMPLETE = Result::RESULT_INCOMPLETE;
  static constexpr Result RESULT_MISSED_TAB_HIDE = Result::RESULT_MISSED_TAB_HIDE;
  static constexpr TabState STATE_UNSPECIFIED = TabState::STATE_UNSPECIFIED;
  static constexpr TabState STATE_WITH_SAVED_FRAMES = TabState::STATE_WITH_SAVED_FRAMES;
  static constexpr TabState STATE_LOADED_NO_SAVED_FRAMES = TabState::STATE_LOADED_NO_SAVED_FRAMES;
  static constexpr TabState STATE_NOT_LOADED_NO_SAVED_FRAMES = TabState::STATE_NOT_LOADED_NO_SAVED_FRAMES;
...
class ScrollDeltas_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/17, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class ChromeGraphicsPipeline_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/11, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  bool has_possible_deadlines() const { return at<11>().valid(); }
  ::protozero::ConstBytes possible_deadlines() const { return at<11>().as_bytes(); }
};
...
class ChromeGraphicsPipeline : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kPossibleDeadlinesFieldNumber = 11,
  };
  ...
  static constexpr StepName STEP_UNKNOWN = StepName::STEP_UNKNOWN;
  static constexpr StepName STEP_DID_NOT_PRODUCE_FRAME = StepName::STEP_DID_NOT_PRODUCE_FRAME;
  static constexpr StepName STEP_DID_NOT_PRODUCE_COMPOSITOR_FRAME = StepName::STEP_DID_NOT_PRODUCE_COMPOSITOR_FRAME;
  static constexpr StepName STEP_GENERATE_COMPOSITOR_FRAME = StepName::STEP_GENERATE_COMPOSITOR_FRAME;
  static constexpr StepName STEP_GENERATE_RENDER_PASS = StepName::STEP_GENERATE_RENDER_PASS;
  static constexpr StepName STEP_ISSUE_BEGIN_FRAME = StepName::STEP_ISSUE_BEGIN_FRAME;
  static constexpr StepName STEP_RECEIVE_COMPOSITOR_FRAME = StepName::STEP_RECEIVE_COMPOSITOR_FRAME;
  static constexpr StepName STEP_RECEIVE_BEGIN_FRAME = StepName::STEP_RECEIVE_BEGIN_FRAME;
  static constexpr StepName STEP_RECEIVE_BEGIN_FRAME_DISCARD = StepName::STEP_RECEIVE_BEGIN_FRAME_DISCARD;
  static constexpr StepName STEP_SEND_BEGIN_MAIN_FRAME = StepName::STEP_SEND_BEGIN_MAIN_FRAME;
  static constexpr StepName STEP_SUBMIT_COMPOSITOR_FRAME = StepName::STEP_SUBMIT_COMPOSITOR_FRAME;
  static constexpr StepName STEP_DRAW_AND_SWAP = StepName::STEP_DRAW_AND_SWAP;
  static constexpr StepName STEP_SURFACE_AGGREGATION = StepName::STEP_SURFACE_AGGREGATION;
  static constexpr StepName STEP_SEND_BUFFER_SWAP = StepName::STEP_SEND_BUFFER_SWAP;
  static constexpr StepName STEP_BUFFER_SWAP_POST_SUBMIT = StepName::STEP_BUFFER_SWAP_POST_SUBMIT;
  static constexpr StepName STEP_FINISH_BUFFER_SWAP = StepName::STEP_FINISH_BUFFER_SWAP;
  static constexpr StepName STEP_SWAP_BUFFERS_ACK = StepName::STEP_SWAP_BUFFERS_ACK;
  static constexpr StepName STEP_EXO_CONSTRUCT_COMPOSITOR_FRAME = StepName::STEP_EXO_CONSTRUCT_COMPOSITOR_FRAME;
  static constexpr StepName STEP_EXO_SUBMIT_COMPOSITOR_FRAME = StepName::STEP_EXO_SUBMIT_COMPOSITOR_FRAME;
  static constexpr StepName STEP_EXO_DISCARD_COMPOSITOR_FRAME = StepName::STEP_EXO_DISCARD_COMPOSITOR_FRAME;
  static constexpr StepName STEP_BACKEND_SEND_BUFFER_SWAP = StepName::STEP_BACKEND_SEND_BUFFER_SWAP;
  static constexpr StepName STEP_BACKEND_SEND_BUFFER_POST_SUBMIT = StepName::STEP_BACKEND_SEND_BUFFER_POST_SUBMIT;
  static constexpr StepName STEP_BACKEND_FINISH_BUFFER_SWAP = StepName::STEP_BACKEND_FINISH_BUFFER_SWAP;
  static constexpr StepName STEP_SEND_ON_BEGIN_FRAME_MOJO_MESSAGE = StepName::STEP_SEND_ON_BEGIN_FRAME_MOJO_MESSAGE;
  static constexpr StepName STEP_SEND_ON_STANDALONE_BEGIN_FRAME_MOJO_MESSAGE = StepName::STEP_SEND_ON_STANDALONE_BEGIN_FRAME_MOJO_MESSAGE;
  static constexpr StepName STEP_SEND_SUBMIT_COMPOSITOR_FRAME_MOJO_MESSAGE = StepName::STEP_SEND_SUBMIT_COMPOSITOR_FRAME_MOJO_MESSAGE;
  static constexpr FrameSkippedReason SKIPPED_REASON_UNKNOWN = FrameSkippedReason::SKIPPED_REASON_UNKNOWN;
  static constexpr FrameSkippedReason SKIPPED_REASON_RECOVER_LATENCY = FrameSkippedReason::SKIPPED_REASON_RECOVER_LATENCY;
  static constexpr FrameSkippedReason SKIPPED_REASON_NO_DAMAGE = FrameSkippedReason::SKIPPED_REASON_NO_DAMAGE;
  static constexpr FrameSkippedReason SKIPPED_REASON_WAITING_ON_MAIN = FrameSkippedReason::SKIPPED_REASON_WAITING_ON_MAIN;
  static constexpr FrameSkippedReason SKIPPED_REASON_DRAW_THROTTLED = FrameSkippedReason::SKIPPED_REASON_DRAW_THROTTLED;
...
using FieldMetadata_PossibleDeadlines =
  ::protozero::proto_utils::FieldMetadata<
    11,
    ::protozero::proto_utils::RepetitionType::kNotRepeated,
    ::protozero::proto_utils::ProtoSchemaType::kMessage,
...
static constexpr FieldMetadata_PossibleDeadlines kPossibleDeadlines{};
template <typename T = AndroidChoreographerFrameCallbackData> T* set_possible_deadlines() {
  return BeginNestedMessage<T>(11);
}
...
class LibunwindstackUnwinder : public ::protozero::Message {
 public:
  ...
  static constexpr ErrorCode ERROR_NONE = ErrorCode::ERROR_NONE;
  static constexpr ErrorCode ERROR_MEMORY_INVALID = ErrorCode::ERROR_MEMORY_INVALID;
  static constexpr ErrorCode ERROR_UNWIND_INFO = ErrorCode::ERROR_UNWIND_INFO;
  static constexpr ErrorCode ERROR_UNSUPPORTED = ErrorCode::ERROR_UNSUPPORTED;
  static constexpr ErrorCode ERROR_INVALID_MAP = ErrorCode::ERROR_INVALID_MAP;
  static constexpr ErrorCode ERROR_MAX_FRAMES_EXCEEDED = ErrorCode::ERROR_MAX_FRAMES_EXCEEDED;
  static constexpr ErrorCode ERROR_REPEATED_FRAME = ErrorCode::ERROR_REPEATED_FRAME;
  static constexpr ErrorCode ERROR_INVALID_ELF = ErrorCode::ERROR_INVALID_ELF;
  static constexpr ErrorCode ERROR_THREAD_DOES_NOT_EXIST = ErrorCode::ERROR_THREAD_DOES_NOT_EXIST;
  static constexpr ErrorCode ERROR_THREAD_TIMEOUT = ErrorCode::ERROR_THREAD_TIMEOUT;
  static constexpr ErrorCode ERROR_SYSTEM_CALL = ErrorCode::ERROR_SYSTEM_CALL;
  static constexpr ErrorCode ERROR_BAD_ARCH = ErrorCode::ERROR_BAD_ARCH;
  static constexpr ErrorCode ERROR_MAPS_PARSE = ErrorCode::ERROR_MAPS_PARSE;
  static constexpr ErrorCode ERROR_INVALID_PARAMETER_LIBUNWINDSTACK = ErrorCode::ERROR_INVALID_PARAMETER_LIBUNWINDSTACK;
  static constexpr ErrorCode ERROR_PTRACE_CALL = ErrorCode::ERROR_PTRACE_CALL;
...
class StartUp : public ::protozero::Message {
 public:
  ...
  static constexpr LaunchCauseType UNINITIALIZED = LaunchCauseType::UNINITIALIZED;
  static constexpr LaunchCauseType OTHER = LaunchCauseType::OTHER;
  static constexpr LaunchCauseType CUSTOM_TAB = LaunchCauseType::CUSTOM_TAB;
  static constexpr LaunchCauseType TWA = LaunchCauseType::TWA;
  static constexpr LaunchCauseType RECENTS = LaunchCauseType::RECENTS;
  static constexpr LaunchCauseType RECENTS_OR_BACK = LaunchCauseType::RECENTS_OR_BACK;
  static constexpr LaunchCauseType FOREGROUND_WHEN_LOCKED = LaunchCauseType::FOREGROUND_WHEN_LOCKED;
  static constexpr LaunchCauseType MAIN_LAUNCHER_ICON = LaunchCauseType::MAIN_LAUNCHER_ICON;
  static constexpr LaunchCauseType MAIN_LAUNCHER_ICON_SHORTCUT = LaunchCauseType::MAIN_LAUNCHER_ICON_SHORTCUT;
  static constexpr LaunchCauseType HOME_SCREEN_WIDGET = LaunchCauseType::HOME_SCREEN_WIDGET;
  static constexpr LaunchCauseType OPEN_IN_BROWSER_FROM_MENU = LaunchCauseType::OPEN_IN_BROWSER_FROM_MENU;
  static constexpr LaunchCauseType EXTERNAL_SEARCH_ACTION_INTENT = LaunchCauseType::EXTERNAL_SEARCH_ACTION_INTENT;
  static constexpr LaunchCauseType NOTIFICATION = LaunchCauseType::NOTIFICATION;
  static constexpr LaunchCauseType EXTERNAL_VIEW_INTENT = LaunchCauseType::EXTERNAL_VIEW_INTENT;
  static constexpr LaunchCauseType OTHER_CHROME = LaunchCauseType::OTHER_CHROME;
  static constexpr LaunchCauseType WEBAPK_CHROME_DISTRIBUTOR = LaunchCauseType::WEBAPK_CHROME_DISTRIBUTOR;
  static constexpr LaunchCauseType WEBAPK_OTHER_DISTRIBUTOR = LaunchCauseType::WEBAPK_OTHER_DISTRIBUTOR;
  static constexpr LaunchCauseType HOME_SCREEN_SHORTCUT = LaunchCauseType::HOME_SCREEN_SHORTCUT;
  static constexpr LaunchCauseType SHARE_INTENT = LaunchCauseType::SHARE_INTENT;
  static constexpr LaunchCauseType NFC = LaunchCauseType::NFC;
  static constexpr LaunchCauseType AUTH_TAB = LaunchCauseType::AUTH_TAB;
...
class WebContentInteraction : public ::protozero::Message {
 public:
  ...
  static constexpr Type INTERACTION_UNSPECIFIED = Type::INTERACTION_UNSPECIFIED;
  static constexpr Type INTERACTION_KEYBOARD = Type::INTERACTION_KEYBOARD;
  static constexpr Type INTERACTION_CLICK_TAP = Type::INTERACTION_CLICK_TAP;
  static constexpr Type INTERACTION_DRAG = Type::INTERACTION_DRAG;
...
class EventForwarder_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class EventForwarder : public ::protozero::Message {
 public:
  ...
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_DOWN = AMotionEventAction::AMOTION_EVENT_ACTION_DOWN;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_UP = AMotionEventAction::AMOTION_EVENT_ACTION_UP;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_MOVE = AMotionEventAction::AMOTION_EVENT_ACTION_MOVE;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_CANCEL = AMotionEventAction::AMOTION_EVENT_ACTION_CANCEL;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_OUTSIDE = AMotionEventAction::AMOTION_EVENT_ACTION_OUTSIDE;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_POINTER_DOWN = AMotionEventAction::AMOTION_EVENT_ACTION_POINTER_DOWN;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_POINTER_UP = AMotionEventAction::AMOTION_EVENT_ACTION_POINTER_UP;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_HOVER_MOVE = AMotionEventAction::AMOTION_EVENT_ACTION_HOVER_MOVE;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_SCROLL = AMotionEventAction::AMOTION_EVENT_ACTION_SCROLL;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_HOVER_ENTER = AMotionEventAction::AMOTION_EVENT_ACTION_HOVER_ENTER;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_HOVER_EXIT = AMotionEventAction::AMOTION_EVENT_ACTION_HOVER_EXIT;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_BUTTON_PRESS = AMotionEventAction::AMOTION_EVENT_ACTION_BUTTON_PRESS;
  static constexpr AMotionEventAction AMOTION_EVENT_ACTION_BUTTON_RELEASE = AMotionEventAction::AMOTION_EVENT_ACTION_BUTTON_RELEASE;
...
class ChromeCompositorSchedulerStateV2 : public ::protozero::Message {
 public:
  ...
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_UNSPECIFIED = BeginImplFrameDeadlineMode::DEADLINE_MODE_UNSPECIFIED;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_NONE = BeginImplFrameDeadlineMode::DEADLINE_MODE_NONE;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_IMMEDIATE = BeginImplFrameDeadlineMode::DEADLINE_MODE_IMMEDIATE;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_REGULAR = BeginImplFrameDeadlineMode::DEADLINE_MODE_REGULAR;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_LATE = BeginImplFrameDeadlineMode::DEADLINE_MODE_LATE;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_BLOCKED = BeginImplFrameDeadlineMode::DEADLINE_MODE_BLOCKED;
  static constexpr BeginImplFrameDeadlineMode DEADLINE_MODE_WAIT_FOR_SCROLL = BeginImplFrameDeadlineMode::DEADLINE_MODE_WAIT_FOR_SCROLL;
...
class ChromeCompositorStateMachineV2_MinorStateV2 : public ::protozero::Message {
 public:
  ...
  static constexpr TreePriority TREE_PRIORITY_UNSPECIFIED = TreePriority::TREE_PRIORITY_UNSPECIFIED;
  static constexpr TreePriority TREE_PRIORITY_SAME_PRIORITY_FOR_BOTH_TREES = TreePriority::TREE_PRIORITY_SAME_PRIORITY_FOR_BOTH_TREES;
  static constexpr TreePriority TREE_PRIORITY_SMOOTHNESS_TAKES_PRIORITY = TreePriority::TREE_PRIORITY_SMOOTHNESS_TAKES_PRIORITY;
  static constexpr TreePriority TREE_PRIORITY_NEW_CONTENT_TAKES_PRIORITY = TreePriority::TREE_PRIORITY_NEW_CONTENT_TAKES_PRIORITY;
  static constexpr ScrollHandlerState SCROLL_HANDLER_UNSPECIFIED = ScrollHandlerState::SCROLL_HANDLER_UNSPECIFIED;
  static constexpr ScrollHandlerState SCROLL_AFFECTS_SCROLL_HANDLER = ScrollHandlerState::SCROLL_AFFECTS_SCROLL_HANDLER;
  static constexpr ScrollHandlerState SCROLL_DOES_NOT_AFFECT_SCROLL_HANDLER = ScrollHandlerState::SCROLL_DOES_NOT_AFFECT_SCROLL_HANDLER;
...
class ChromeCompositorStateMachineV2_MajorStateV2 : public ::protozero::Message {
 public:
  ...
  static constexpr BeginImplFrameState BEGIN_IMPL_FRAME_UNSPECIFIED = BeginImplFrameState::BEGIN_IMPL_FRAME_UNSPECIFIED;
  static constexpr BeginImplFrameState BEGIN_IMPL_FRAME_IDLE = BeginImplFrameState::BEGIN_IMPL_FRAME_IDLE;
  static constexpr BeginImplFrameState BEGIN_IMPL_FRAME_INSIDE_BEGIN_FRAME = BeginImplFrameState::BEGIN_IMPL_FRAME_INSIDE_BEGIN_FRAME;
  static constexpr BeginImplFrameState BEGIN_IMPL_FRAME_INSIDE_DEADLINE = BeginImplFrameState::BEGIN_IMPL_FRAME_INSIDE_DEADLINE;
  static constexpr BeginMainFrameState BEGIN_MAIN_FRAME_UNSPECIFIED = BeginMainFrameState::BEGIN_MAIN_FRAME_UNSPECIFIED;
  static constexpr BeginMainFrameState BEGIN_MAIN_FRAME_IDLE = BeginMainFrameState::BEGIN_MAIN_FRAME_IDLE;
  static constexpr BeginMainFrameState BEGIN_MAIN_FRAME_SENT = BeginMainFrameState::BEGIN_MAIN_FRAME_SENT;
  static constexpr BeginMainFrameState BEGIN_MAIN_FRAME_READY_TO_COMMIT = BeginMainFrameState::BEGIN_MAIN_FRAME_READY_TO_COMMIT;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_UNSPECIFIED = LayerTreeFrameSinkState::LAYER_TREE_FRAME_UNSPECIFIED;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_NONE = LayerTreeFrameSinkState::LAYER_TREE_FRAME_NONE;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_ACTIVE = LayerTreeFrameSinkState::LAYER_TREE_FRAME_ACTIVE;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_CREATING = LayerTreeFrameSinkState::LAYER_TREE_FRAME_CREATING;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_WAITING_FOR_FIRST_COMMIT = LayerTreeFrameSinkState::LAYER_TREE_FRAME_WAITING_FOR_FIRST_COMMIT;
  static constexpr LayerTreeFrameSinkState LAYER_TREE_FRAME_WAITING_FOR_FIRST_ACTIVATION = LayerTreeFrameSinkState::LAYER_TREE_FRAME_WAITING_FOR_FIRST_ACTIVATION;
  static constexpr ForcedRedrawOnTimeoutState FORCED_REDRAW_UNSPECIFIED = ForcedRedrawOnTimeoutState::FORCED_REDRAW_UNSPECIFIED;
  static constexpr ForcedRedrawOnTimeoutState FORCED_REDRAW_IDLE = ForcedRedrawOnTimeoutState::FORCED_REDRAW_IDLE;
  static constexpr ForcedRedrawOnTimeoutState FORCED_REDRAW_WAITING_FOR_COMMIT = ForcedRedrawOnTimeoutState::FORCED_REDRAW_WAITING_FOR_COMMIT;
  static constexpr ForcedRedrawOnTimeoutState FORCED_REDRAW_WAITING_FOR_ACTIVATION = ForcedRedrawOnTimeoutState::FORCED_REDRAW_WAITING_FOR_ACTIVATION;
  static constexpr ForcedRedrawOnTimeoutState FORCED_REDRAW_WAITING_FOR_DRAW = ForcedRedrawOnTimeoutState::FORCED_REDRAW_WAITING_FOR_DRAW;
...
class BeginFrameArgsV2 : public ::protozero::Message {
 public:
  ...
  static constexpr BeginFrameArgsType BEGIN_FRAME_ARGS_TYPE_UNSPECIFIED = BeginFrameArgsType::BEGIN_FRAME_ARGS_TYPE_UNSPECIFIED;
  static constexpr BeginFrameArgsType BEGIN_FRAME_ARGS_TYPE_INVALID = BeginFrameArgsType::BEGIN_FRAME_ARGS_TYPE_INVALID;
  static constexpr BeginFrameArgsType BEGIN_FRAME_ARGS_TYPE_NORMAL = BeginFrameArgsType::BEGIN_FRAME_ARGS_TYPE_NORMAL;
  static constexpr BeginFrameArgsType BEGIN_FRAME_ARGS_TYPE_MISSED = BeginFrameArgsType::BEGIN_FRAME_ARGS_TYPE_MISSED;
...
class BeginImplFrameArgsV2 : public ::protozero::Message {
 public:
  ...
  static constexpr State BEGIN_FRAME_FINISHED = State::BEGIN_FRAME_FINISHED;
  static constexpr State BEGIN_FRAME_USING = State::BEGIN_FRAME_USING;
...
class WebViewStartup_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class WebViewStartup : public ::protozero::Message {
 public:
  ...
  static constexpr CallSite GET_AW_TRACING_CONTROLLER = CallSite::GET_AW_TRACING_CONTROLLER;
  static constexpr CallSite GET_AW_PROXY_CONTROLLER = CallSite::GET_AW_PROXY_CONTROLLER;
  static constexpr CallSite WEBVIEW_INSTANCE = CallSite::WEBVIEW_INSTANCE;
  static constexpr CallSite GET_STATICS = CallSite::GET_STATICS;
  static constexpr CallSite GET_DEFAULT_GEOLOCATION_PERMISSIONS = CallSite::GET_DEFAULT_GEOLOCATION_PERMISSIONS;
  static constexpr CallSite GET_DEFAULT_SERVICE_WORKER_CONTROLLER = CallSite::GET_DEFAULT_SERVICE_WORKER_CONTROLLER;
  static constexpr CallSite GET_WEB_ICON_DATABASE = CallSite::GET_WEB_ICON_DATABASE;
  static constexpr CallSite GET_DEFAULT_WEB_STORAGE = CallSite::GET_DEFAULT_WEB_STORAGE;
  static constexpr CallSite GET_DEFAULT_WEBVIEW_DATABASE = CallSite::GET_DEFAULT_WEBVIEW_DATABASE;
  static constexpr CallSite GET_TRACING_CONTROLLER = CallSite::GET_TRACING_CONTROLLER;
  static constexpr CallSite ASYNC_WEBVIEW_STARTUP = CallSite::ASYNC_WEBVIEW_STARTUP;
  static constexpr StartupMode FULLY_SYNC = StartupMode::FULLY_SYNC;
  static constexpr StartupMode FULLY_ASYNC = StartupMode::FULLY_ASYNC;
  static constexpr StartupMode PARTIAL_ASYNC_THEN_SYNC = StartupMode::PARTIAL_ASYNC_THEN_SYNC;
  static constexpr StartupMode ASYNC_BUT_FULLY_SYNC = StartupMode::ASYNC_BUT_FULLY_SYNC;
...
class AnimationFrameTimingInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class AnimationFrameScriptTimingInfo : public ::protozero::Message {
 public:
  ...
  static constexpr InvokerType UNDEFINED = InvokerType::UNDEFINED;
  static constexpr InvokerType CLASSIC_SCRIPT = InvokerType::CLASSIC_SCRIPT;
  static constexpr InvokerType MODULE_SCRIPT = InvokerType::MODULE_SCRIPT;
  static constexpr InvokerType USER_CALLBACK = InvokerType::USER_CALLBACK;
  static constexpr InvokerType EVENT_HANDLER = InvokerType::EVENT_HANDLER;
  static constexpr InvokerType PROMISE_RESOLVE = InvokerType::PROMISE_RESOLVE;
  static constexpr InvokerType PROMISE_REJECT = InvokerType::PROMISE_REJECT;
  static constexpr ThirdPartyTechnology UNSPECIFIED = ThirdPartyTechnology::UNSPECIFIED;
  static constexpr ThirdPartyTechnology NONE = ThirdPartyTechnology::NONE;
  static constexpr ThirdPartyTechnology WORD_PRESS = ThirdPartyTechnology::WORD_PRESS;
  static constexpr ThirdPartyTechnology GOOGLE_ANALYTICS = ThirdPartyTechnology::GOOGLE_ANALYTICS;
  static constexpr ThirdPartyTechnology GOOGLE_FONT_API = ThirdPartyTechnology::GOOGLE_FONT_API;
  static constexpr ThirdPartyTechnology GOOGLE_TAG_MANAGER = ThirdPartyTechnology::GOOGLE_TAG_MANAGER;
  static constexpr ThirdPartyTechnology GOOGLE_MAPS = ThirdPartyTechnology::GOOGLE_MAPS;
  static constexpr ThirdPartyTechnology META_PIXEL = ThirdPartyTechnology::META_PIXEL;
  static constexpr ThirdPartyTechnology YOUTUBE = ThirdPartyTechnology::YOUTUBE;
  static constexpr ThirdPartyTechnology ADOBE_ANALYTICS = ThirdPartyTechnology::ADOBE_ANALYTICS;
  static constexpr ThirdPartyTechnology TIKTOK_PIXEL = ThirdPartyTechnology::TIKTOK_PIXEL;
  static constexpr ThirdPartyTechnology HOTJAR = ThirdPartyTechnology::HOTJAR;
  static constexpr ThirdPartyTechnology GOOGLE_ADSENSE = ThirdPartyTechnology::GOOGLE_ADSENSE;
  static constexpr ThirdPartyTechnology GOOGLE_PUBLISHER_TAG = ThirdPartyTechnology::GOOGLE_PUBLISHER_TAG;
  static constexpr ThirdPartyTechnology GOOGLE_ADS_LIBRARIES = ThirdPartyTechnology::GOOGLE_ADS_LIBRARIES;
  static constexpr ThirdPartyTechnology FUNDING_CHOICES = ThirdPartyTechnology::FUNDING_CHOICES;
  static constexpr ThirdPartyTechnology ELEMENTOR = ThirdPartyTechnology::ELEMENTOR;
  static constexpr ThirdPartyTechnology SLIDER_REVOLUTION = ThirdPartyTechnology::SLIDER_REVOLUTION;
...
class MainFramePipeline : public ::protozero::Message {
 public:
  ...
  static constexpr Step UNKNOWN = Step::UNKNOWN;
  static constexpr Step SEND_BEGIN_MAIN_FRAME = Step::SEND_BEGIN_MAIN_FRAME;
  static constexpr Step BEGIN_MAIN_FRAME = Step::BEGIN_MAIN_FRAME;
  static constexpr Step ABORTED_ON_MAIN = Step::ABORTED_ON_MAIN;
  static constexpr Step COMMIT_ON_MAIN = Step::COMMIT_ON_MAIN;
  static constexpr Step READY_TO_COMMIT_ON_IMPL = Step::READY_TO_COMMIT_ON_IMPL;
  static constexpr Step COMMIT_ON_IMPL = Step::COMMIT_ON_IMPL;
  static constexpr Step COMMIT_COMPLETE = Step::COMMIT_COMPLETE;
  static constexpr Step READY_TO_ACTIVATE = Step::READY_TO_ACTIVATE;
  static constexpr Step ACTIVATE = Step::ACTIVATE;
  static constexpr Step DRAW = Step::DRAW;
  static constexpr Step UPDATE_DISPLAY_TREE = Step::UPDATE_DISPLAY_TREE;
  static constexpr AbortedOnMainReason ABORTED_MAIN_REASON_UNKNOWN = AbortedOnMainReason::ABORTED_MAIN_REASON_UNKNOWN;
  static constexpr AbortedOnMainReason NOT_VISIBLE = AbortedOnMainReason::NOT_VISIBLE;
  static constexpr AbortedOnMainReason DEFERRED_UPDATE = AbortedOnMainReason::DEFERRED_UPDATE;
  static constexpr AbortedOnMainReason DEFERRED_COMMIT_ABORTED = AbortedOnMainReason::DEFERRED_COMMIT_ABORTED;
  static constexpr AbortedOnMainReason NO_UPDATE = AbortedOnMainReason::NO_UPDATE;
...
class ChromeLatencyInfo2 : public ::protozero::Message {
 public:
  ...
  static constexpr Step STEP_UNSPECIFIED = Step::STEP_UNSPECIFIED;
  static constexpr Step STEP_SEND_INPUT_EVENT_UI = Step::STEP_SEND_INPUT_EVENT_UI;
  static constexpr Step STEP_SEND_DISPATCH_EVENT_MOJO_MESSAGE = Step::STEP_SEND_DISPATCH_EVENT_MOJO_MESSAGE;
  static constexpr Step STEP_HANDLE_INPUT_EVENT_IMPL = Step::STEP_HANDLE_INPUT_EVENT_IMPL;
  static constexpr Step STEP_RESAMPLE_SCROLL_EVENTS = Step::STEP_RESAMPLE_SCROLL_EVENTS;
  static constexpr Step STEP_DID_HANDLE_INPUT_AND_OVERSCROLL = Step::STEP_DID_HANDLE_INPUT_AND_OVERSCROLL;
  static constexpr Step STEP_HANDLE_INPUT_EVENT_MAIN = Step::STEP_HANDLE_INPUT_EVENT_MAIN;
  static constexpr Step STEP_MAIN_THREAD_SCROLL_UPDATE = Step::STEP_MAIN_THREAD_SCROLL_UPDATE;
  static constexpr Step STEP_HANDLE_INPUT_EVENT_MAIN_COMMIT = Step::STEP_HANDLE_INPUT_EVENT_MAIN_COMMIT;
  static constexpr Step STEP_HANDLED_INPUT_EVENT_MAIN_OR_IMPL = Step::STEP_HANDLED_INPUT_EVENT_MAIN_OR_IMPL;
  static constexpr Step STEP_HANDLED_INPUT_EVENT_IMPL = Step::STEP_HANDLED_INPUT_EVENT_IMPL;
  static constexpr Step STEP_TOUCH_EVENT_HANDLED = Step::STEP_TOUCH_EVENT_HANDLED;
  static constexpr Step STEP_GESTURE_EVENT_HANDLED = Step::STEP_GESTURE_EVENT_HANDLED;
  static constexpr Step STEP_SWAP_BUFFERS = Step::STEP_SWAP_BUFFERS;
  static constexpr Step STEP_DRAW_AND_SWAP = Step::STEP_DRAW_AND_SWAP;
  static constexpr Step STEP_FINISHED_SWAP_BUFFERS = Step::STEP_FINISHED_SWAP_BUFFERS;
  static constexpr LatencyComponentType COMPONENT_UNSPECIFIED = LatencyComponentType::COMPONENT_UNSPECIFIED;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_BEGIN_RWH = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_BEGIN_RWH;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_SCROLL_UPDATE_ORIGINAL = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_SCROLL_UPDATE_ORIGINAL;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_FIRST_SCROLL_UPDATE_ORIGINAL = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_FIRST_SCROLL_UPDATE_ORIGINAL;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_ORIGINAL = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_ORIGINAL;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_UI = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_UI;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_RENDERER_MAIN = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_RENDERER_MAIN;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_RENDERING_SCHEDULED_MAIN = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_RENDERING_SCHEDULED_MAIN;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_RENDERING_SCHEDULED_IMPL = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_RENDERING_SCHEDULED_IMPL;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_SCROLL_UPDATE_LAST_EVENT = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_SCROLL_UPDATE_LAST_EVENT;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_ACK_RWH = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_ACK_RWH;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_RENDERER_SWAP = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_RENDERER_SWAP;
  static constexpr LatencyComponentType COMPONENT_DISPLAY_COMPOSITOR_RECEIVED_FRAME = LatencyComponentType::COMPONENT_DISPLAY_COMPOSITOR_RECEIVED_FRAME;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_GPU_SWAP_BUFFER = LatencyComponentType::COMPONENT_INPUT_EVENT_GPU_SWAP_BUFFER;
  static constexpr LatencyComponentType COMPONENT_INPUT_EVENT_LATENCY_FRAME_SWAP = LatencyComponentType::COMPONENT_INPUT_EVENT_LATENCY_FRAME_SWAP;
  static constexpr InputType UNDEFINED_EVENT = InputType::UNDEFINED_EVENT;
  static constexpr InputType MOUSE_DOWN_EVENT = InputType::MOUSE_DOWN_EVENT;
  static constexpr InputType MOUSE_UP_EVENT = InputType::MOUSE_UP_EVENT;
  static constexpr InputType MOUSE_MOVE_EVENT = InputType::MOUSE_MOVE_EVENT;
  static constexpr InputType MOUSE_ENTER_EVENT = InputType::MOUSE_ENTER_EVENT;
  static constexpr InputType MOUSE_LEAVE_EVENT = InputType::MOUSE_LEAVE_EVENT;
  static constexpr InputType CONTEXT_MENU_EVENT = InputType::CONTEXT_MENU_EVENT;
  static constexpr InputType MOUSE_WHEEL_EVENT = InputType::MOUSE_WHEEL_EVENT;
  static constexpr InputType RAW_KEY_DOWN_EVENT = InputType::RAW_KEY_DOWN_EVENT;
  static constexpr InputType KEY_DOWN_EVENT = InputType::KEY_DOWN_EVENT;
  static constexpr InputType KEY_UP_EVENT = InputType::KEY_UP_EVENT;
  static constexpr InputType CHAR_EVENT = InputType::CHAR_EVENT;
  static constexpr InputType GESTURE_SCROLL_BEGIN_EVENT = InputType::GESTURE_SCROLL_BEGIN_EVENT;
  static constexpr InputType GESTURE_SCROLL_END_EVENT = InputType::GESTURE_SCROLL_END_EVENT;
  static constexpr InputType GESTURE_SCROLL_UPDATE_EVENT = InputType::GESTURE_SCROLL_UPDATE_EVENT;
  static constexpr InputType GESTURE_FLING_START_EVENT = InputType::GESTURE_FLING_START_EVENT;
  static constexpr InputType GESTURE_FLING_CANCEL_EVENT = InputType::GESTURE_FLING_CANCEL_EVENT;
  static constexpr InputType GESTURE_PINCH_BEGIN_EVENT = InputType::GESTURE_PINCH_BEGIN_EVENT;
  static constexpr InputType GESTURE_PINCH_END_EVENT = InputType::GESTURE_PINCH_END_EVENT;
  static constexpr InputType GESTURE_PINCH_UPDATE_EVENT = InputType::GESTURE_PINCH_UPDATE_EVENT;
  static constexpr InputType GESTURE_BEGIN_EVENT = InputType::GESTURE_BEGIN_EVENT;
  static constexpr InputType GESTURE_TAP_DOWN_EVENT = InputType::GESTURE_TAP_DOWN_EVENT;
  static constexpr InputType GESTURE_SHOW_PRESS_EVENT = InputType::GESTURE_SHOW_PRESS_EVENT;
  static constexpr InputType GESTURE_TAP_EVENT = InputType::GESTURE_TAP_EVENT;
  static constexpr InputType GESTURE_TAP_CANCEL_EVENT = InputType::GESTURE_TAP_CANCEL_EVENT;
  static constexpr InputType GESTURE_SHORT_PRESS_EVENT = InputType::GESTURE_SHORT_PRESS_EVENT;
  static constexpr InputType GESTURE_LONG_PRESS_EVENT = InputType::GESTURE_LONG_PRESS_EVENT;
  static constexpr InputType GESTURE_LONG_TAP_EVENT = InputType::GESTURE_LONG_TAP_EVENT;
  static constexpr InputType GESTURE_TWO_FINGER_TAP_EVENT = InputType::GESTURE_TWO_FINGER_TAP_EVENT;
  static constexpr InputType GESTURE_TAP_UNCONFIRMED_EVENT = InputType::GESTURE_TAP_UNCONFIRMED_EVENT;
  static constexpr InputType GESTURE_DOUBLE_TAP_EVENT = InputType::GESTURE_DOUBLE_TAP_EVENT;
  static constexpr InputType GESTURE_END_EVENT = InputType::GESTURE_END_EVENT;
  static constexpr InputType TOUCH_START_EVENT = InputType::TOUCH_START_EVENT;
  static constexpr InputType TOUCH_MOVE_EVENT = InputType::TOUCH_MOVE_EVENT;
  static constexpr InputType TOUCH_END_EVENT = InputType::TOUCH_END_EVENT;
  static constexpr InputType TOUCH_CANCEL_EVENT = InputType::TOUCH_CANCEL_EVENT;
  static constexpr InputType TOUCH_SCROLL_STARTED_EVENT = InputType::TOUCH_SCROLL_STARTED_EVENT;
  static constexpr InputType POINTER_DOWN_EVENT = InputType::POINTER_DOWN_EVENT;
  static constexpr InputType POINTER_UP_EVENT = InputType::POINTER_UP_EVENT;
  static constexpr InputType POINTER_MOVE_EVENT = InputType::POINTER_MOVE_EVENT;
  static constexpr InputType POINTER_RAW_UPDATE_EVENT = InputType::POINTER_RAW_UPDATE_EVENT;
  static constexpr InputType POINTER_CANCEL_EVENT = InputType::POINTER_CANCEL_EVENT;
  static constexpr InputType POINTER_CAUSED_UA_ACTION_EVENT = InputType::POINTER_CAUSED_UA_ACTION_EVENT;
  static constexpr InputResultState UNKNOWN = InputResultState::UNKNOWN;
  static constexpr InputResultState CONSUMED = InputResultState::CONSUMED;
  static constexpr InputResultState NOT_CONSUMED = InputResultState::NOT_CONSUMED;
  static constexpr InputResultState NO_CONSUMER_EXISTS = InputResultState::NO_CONSUMER_EXISTS;
  static constexpr InputResultState IGNORED = InputResultState::IGNORED;
  static constexpr InputResultState SET_NON_BLOCKING = InputResultState::SET_NON_BLOCKING;
  static constexpr InputResultState SET_NON_BLOCKING_DUE_TO_FLING = InputResultState::SET_NON_BLOCKING_DUE_TO_FLING;
...
class EventTiming : public ::protozero::Message {
 public:
  ...
  static constexpr EventType UNDEFINED = EventType::UNDEFINED;
  static constexpr EventType AUX_CLICK_EVENT = EventType::AUX_CLICK_EVENT;
  static constexpr EventType CLICK_EVENT = EventType::CLICK_EVENT;
  static constexpr EventType CONTEXT_MENU_EVENT = EventType::CONTEXT_MENU_EVENT;
  static constexpr EventType DOUBLE_CLICK_EVENT = EventType::DOUBLE_CLICK_EVENT;
  static constexpr EventType MOUSE_DOWN_EVENT = EventType::MOUSE_DOWN_EVENT;
  static constexpr EventType MOUSE_ENTER_EVENT = EventType::MOUSE_ENTER_EVENT;
  static constexpr EventType MOUSE_LEAVE_EVENT = EventType::MOUSE_LEAVE_EVENT;
  static constexpr EventType MOUSE_OUT_EVENT = EventType::MOUSE_OUT_EVENT;
  static constexpr EventType MOUSE_OVER_EVENT = EventType::MOUSE_OVER_EVENT;
  static constexpr EventType MOUSE_UP_EVENT = EventType::MOUSE_UP_EVENT;
  static constexpr EventType POINTER_OVER_EVENT = EventType::POINTER_OVER_EVENT;
  static constexpr EventType POINTER_ENTER_EVENT = EventType::POINTER_ENTER_EVENT;
  static constexpr EventType POINTER_DOWN_EVENT = EventType::POINTER_DOWN_EVENT;
  static constexpr EventType POINTER_UP_EVENT = EventType::POINTER_UP_EVENT;
  static constexpr EventType POINTER_CANCEL_EVENT = EventType::POINTER_CANCEL_EVENT;
  static constexpr EventType POINTER_OUT_EVENT = EventType::POINTER_OUT_EVENT;
  static constexpr EventType POINTER_LEAVE_EVENT = EventType::POINTER_LEAVE_EVENT;
  static constexpr EventType GOT_POINTER_CAPTURE_EVENT = EventType::GOT_POINTER_CAPTURE_EVENT;
  static constexpr EventType LOST_POINTER_CAPTURE_EVENT = EventType::LOST_POINTER_CAPTURE_EVENT;
  static constexpr EventType TOUCH_START_EVENT = EventType::TOUCH_START_EVENT;
  static constexpr EventType TOUCH_END_EVENT = EventType::TOUCH_END_EVENT;
  static constexpr EventType TOUCH_CANCEL_EVENT = EventType::TOUCH_CANCEL_EVENT;
  static constexpr EventType KEY_DOWN_EVENT = EventType::KEY_DOWN_EVENT;
  static constexpr EventType KEY_PRESS_EVENT = EventType::KEY_PRESS_EVENT;
  static constexpr EventType KEY_UP_EVENT = EventType::KEY_UP_EVENT;
  static constexpr EventType BEFORE_INPUT_EVENT = EventType::BEFORE_INPUT_EVENT;
  static constexpr EventType INPUT_EVENT = EventType::INPUT_EVENT;
  static constexpr EventType COMPOSITION_START_EVENT = EventType::COMPOSITION_START_EVENT;
  static constexpr EventType COMPOSITION_UPDATE_EVENT = EventType::COMPOSITION_UPDATE_EVENT;
  static constexpr EventType COMPOSITION_END_EVENT = EventType::COMPOSITION_END_EVENT;
  static constexpr EventType DRAG_START_EVENT = EventType::DRAG_START_EVENT;
  static constexpr EventType DRAG_END_EVENT = EventType::DRAG_END_EVENT;
  static constexpr EventType DRAG_ENTER_EVENT = EventType::DRAG_ENTER_EVENT;
  static constexpr EventType DRAG_LEAVE_EVENT = EventType::DRAG_LEAVE_EVENT;
  static constexpr EventType DRAG_OVER_EVENT = EventType::DRAG_OVER_EVENT;
  static constexpr EventType DROP_EVENT = EventType::DROP_EVENT;
...
class ChromeFrameReporter2_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/18, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class ChromeFrameReporter2 : public ::protozero::Message {
 public:
  ...
  static constexpr State STATE_NO_UPDATE_DESIRED = State::STATE_NO_UPDATE_DESIRED;
  static constexpr State STATE_PRESENTED_ALL = State::STATE_PRESENTED_ALL;
  static constexpr State STATE_PRESENTED_PARTIAL = State::STATE_PRESENTED_PARTIAL;
  static constexpr State STATE_DROPPED = State::STATE_DROPPED;
  static constexpr FrameDropReason REASON_UNSPECIFIED = FrameDropReason::REASON_UNSPECIFIED;
  static constexpr FrameDropReason REASON_DISPLAY_COMPOSITOR = FrameDropReason::REASON_DISPLAY_COMPOSITOR;
  static constexpr FrameDropReason REASON_MAIN_THREAD = FrameDropReason::REASON_MAIN_THREAD;
  static constexpr FrameDropReason REASON_CLIENT_COMPOSITOR = FrameDropReason::REASON_CLIENT_COMPOSITOR;
  static constexpr ScrollState SCROLL_NONE = ScrollState::SCROLL_NONE;
  static constexpr ScrollState SCROLL_MAIN_THREAD = ScrollState::SCROLL_MAIN_THREAD;
  static constexpr ScrollState SCROLL_COMPOSITOR_THREAD = ScrollState::SCROLL_COMPOSITOR_THREAD;
  static constexpr ScrollState SCROLL_RASTER = ScrollState::SCROLL_RASTER;
  static constexpr ScrollState SCROLL_UNKNOWN = ScrollState::SCROLL_UNKNOWN;
  static constexpr FrameType FORKED = FrameType::FORKED;
  static constexpr FrameType BACKFILL = FrameType::BACKFILL;
...
class InputTransferHandler_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/1, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
...
class InputTransferHandler : public ::protozero::Message {
 public:
  ...
  static constexpr TransferInputToVizResult UNKNOWN = TransferInputToVizResult::UNKNOWN;
  static constexpr TransferInputToVizResult SUCCESSFULLY_TRANSFERRED = TransferInputToVizResult::SUCCESSFULLY_TRANSFERRED;
  static constexpr TransferInputToVizResult INPUT_TRANSFER_HANDLER_NOT_FOUND_IN_MAP = TransferInputToVizResult::INPUT_TRANSFER_HANDLER_NOT_FOUND_IN_MAP;
  static constexpr TransferInputToVizResult NON_FINGER_TOOL_TYPE = TransferInputToVizResult::NON_FINGER_TOOL_TYPE;
  static constexpr TransferInputToVizResult VIZ_INITIALIZATION_NOT_COMPLETE = TransferInputToVizResult::VIZ_INITIALIZATION_NOT_COMPLETE;
  static constexpr TransferInputToVizResult SELECTION_HANDLES_ACTIVE = TransferInputToVizResult::SELECTION_HANDLES_ACTIVE;
  static constexpr TransferInputToVizResult CAN_TRIGGER_BACK_GESTURE = TransferInputToVizResult::CAN_TRIGGER_BACK_GESTURE;
  static constexpr TransferInputToVizResult IME_IS_ACTIVE = TransferInputToVizResult::IME_IS_ACTIVE;
  static constexpr TransferInputToVizResult REQUESTED_BY_EMBEDDER = TransferInputToVizResult::REQUESTED_BY_EMBEDDER;
  static constexpr TransferInputToVizResult SYSTEM_SERVER_DID_NOT_TRANSFER = TransferInputToVizResult::SYSTEM_SERVER_DID_NOT_TRANSFER;
  static constexpr TransferInputToVizResult BROWSER_TOKEN_CHANGED = TransferInputToVizResult::BROWSER_TOKEN_CHANGED;
  static constexpr TransferInputToVizResult MULTIPLE_BROWSER_WINDOWS_OPEN = TransferInputToVizResult::MULTIPLE_BROWSER_WINDOWS_OPEN;
  static constexpr TransferInputToVizResult DOWN_TIME_AFTER_EVENT_TIME = TransferInputToVizResult::DOWN_TIME_AFTER_EVENT_TIME;
  static constexpr TransferInputToVizResult SEQUENCE_TRANSFERRED_BACK_FROM_VIZ = TransferInputToVizResult::SEQUENCE_TRANSFERRED_BACK_FROM_VIZ;
...
class ChromeTrackEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/0, /*HAS_NONPACKED_REPEATED_FIELDS=*/false> {
 public:
  ChromeTrackEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit ChromeTrackEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit ChromeTrackEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
};

class ChromeTrackEvent : public ::protozero::Message {
 public:
  using Decoder = ChromeTrackEvent_Decoder;
  static constexpr const char* GetName() { return ".perfetto.protos.ChromeTrackEvent"; }
