...
class PERFETTO_EXPORT_COMPONENT ChromeLegacyIpc : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeLegacyIpc_MessageClass& message_class() const { return message_class_; }
  void set_message_class(const ChromeLegacyIpc_MessageClass& value) { message_class_ = value; _has_field_.set(1); }
