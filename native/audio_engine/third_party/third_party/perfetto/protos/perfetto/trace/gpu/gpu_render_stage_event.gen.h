...
class PERFETTO_EXPORT_COMPONENT InternedGraphicsContext : public ::protozero::CppMessageObj {
 public:
  ...
  const InternedGraphicsContext_Api& api() const { return api_; }
  void set_api(const InternedGraphicsContext_Api& value) { api_ = value; _has_field_.set(3); }
...
class PERFETTO_EXPORT_COMPONENT InternedGpuRenderStageSpecification : public ::protozero::CppMessageObj {
 public:
  ...
  const InternedGpuRenderStageSpecification_RenderStageCategory& category() const { return category_; }
  void set_category(const InternedGpuRenderStageSpecification_RenderStageCategory& value) { category_ = value; _has_field_.set(4); }
