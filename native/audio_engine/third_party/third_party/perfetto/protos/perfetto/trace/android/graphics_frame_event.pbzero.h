...
class GraphicsFrameEvent : public ::protozero::Message {
 public:
  ...
  static constexpr BufferEventType UNSPECIFIED = BufferEventType::UNSPECIFIED;
  static constexpr BufferEventType DEQUEUE = BufferEventType::DEQUEUE;
  static constexpr BufferEventType QUEUE = BufferEventType::QUEUE;
  static constexpr BufferEventType POST = BufferEventType::POST;
  static constexpr BufferEventType ACQUIRE_FENCE = BufferEventType::ACQUIRE_FENCE;
  static constexpr BufferEventType LATCH = BufferEventType::LATCH;
  static constexpr BufferEventType HWC_COMPOSITION_QUEUED = BufferEventType::HWC_COMPOSITION_QUEUED;
  static constexpr BufferEventType FALLBACK_COMPOSITION = BufferEventType::FALLBACK_COMPOSITION;
  static constexpr BufferEventType PRESENT_FENCE = BufferEventType::PRESENT_FENCE;
  static constexpr BufferEventType RELEASE_FENCE = BufferEventType::RELEASE_FENCE;
  static constexpr BufferEventType MODIFY = BufferEventType::MODIFY;
  static constexpr BufferEventType DETACH = BufferEventType::DETACH;
  static constexpr BufferEventType ATTACH = BufferEventType::ATTACH;
  static constexpr BufferEventType CANCEL = BufferEventType::CANCEL;
