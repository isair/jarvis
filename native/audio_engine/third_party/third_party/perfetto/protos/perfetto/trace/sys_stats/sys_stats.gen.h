...
class PERFETTO_EXPORT_COMPONENT SysStats : public ::protozero::CppMessageObj {
 public:
  ...
  const std::vector<SysStats_ThermalZone>& thermal_zone() const { return thermal_zone_; }
  std::vector<SysStats_ThermalZone>* mutable_thermal_zone() { return &thermal_zone_; }
  int thermal_zone_size() const;
  void clear_thermal_zone();
  SysStats_ThermalZone* add_thermal_zone();

  const std::vector<SysStats_CpuIdleState>& cpuidle_state() const { return cpuidle_state_; }
  std::vector<SysStats_CpuIdleState>* mutable_cpuidle_state() { return &cpuidle_state_; }
  int cpuidle_state_size() const;
  void clear_cpuidle_state();
  SysStats_CpuIdleState* add_cpuidle_state();

  const std::vector<uint64_t>& gpufreq_mhz() const { return gpufreq_mhz_; }
  std::vector<uint64_t>* mutable_gpufreq_mhz() { return &gpufreq_mhz_; }
  int gpufreq_mhz_size() const { return static_cast<int>(gpufreq_mhz_.size()); }
  void clear_gpufreq_mhz() { gpufreq_mhz_.clear(); }
  void add_gpufreq_mhz(uint64_t value) { gpufreq_mhz_.emplace_back(value); }
  uint64_t* add_gpufreq_mhz() { gpufreq_mhz_.emplace_back(); return &gpufreq_mhz_.back(); }
 ...
 private:
  ...
  std::vector<SysStats_ThermalZone> thermal_zone_;
  std::vector<SysStats_CpuIdleState> cpuidle_state_;
  std::vector<uint64_t> gpufreq_mhz_;
...
class PERFETTO_EXPORT_COMPONENT SysStats_CpuIdleState : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCpuIdFieldNumber = 1,
  ...
  SysStats_CpuIdleState(SysStats_CpuIdleState&&) noexcept;
  SysStats_CpuIdleState& operator=(SysStats_CpuIdleState&&);
  SysStats_CpuIdleState(const SysStats_CpuIdleState&);
  SysStats_CpuIdleState& operator=(const SysStats_CpuIdleState&);
  bool operator==(const SysStats_CpuIdleState&) const;
  bool operator!=(const SysStats_CpuIdleState& other) const { return !(*this == other); }
  ...
  const std::vector<SysStats_CpuIdleStateEntry>& cpuidle_state_entry() const { return cpuidle_state_entry_; }
  std::vector<SysStats_CpuIdleStateEntry>* mutable_cpuidle_state_entry() { return &cpuidle_state_entry_; }
  int cpuidle_state_entry_size() const;
  void clear_cpuidle_state_entry();
  SysStats_CpuIdleStateEntry* add_cpuidle_state_entry();

 private:
  uint32_t cpu_id_;
  std::vector<SysStats_CpuIdleStateEntry> cpuidle_state_entry_;
...
class PERFETTO_EXPORT_COMPONENT SysStats_CpuIdleStateEntry : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kStateFieldNumber = 1,
  ...
  SysStats_CpuIdleStateEntry(SysStats_CpuIdleStateEntry&&) noexcept;
  SysStats_CpuIdleStateEntry& operator=(SysStats_CpuIdleStateEntry&&);
  SysStats_CpuIdleStateEntry(const SysStats_CpuIdleStateEntry&);
  SysStats_CpuIdleStateEntry& operator=(const SysStats_CpuIdleStateEntry&);
  bool operator==(const SysStats_CpuIdleStateEntry&) const;
  bool operator!=(const SysStats_CpuIdleStateEntry& other) const { return !(*this == other); }
  ...
  void set_state(const std::string& value) { state_ = value; _has_field_.set(1); }

  bool has_duration_us() const { return _has_field_[2]; }
  uint64_t duration_us() const { return duration_us_; }
  void set_duration_us(uint64_t value) { duration_us_ = value; _has_field_.set(2); }
...
class PERFETTO_EXPORT_COMPONENT SysStats_ThermalZone : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kTempFieldNumber = 2,
  ...
  SysStats_ThermalZone(SysStats_ThermalZone&&) noexcept;
  SysStats_ThermalZone& operator=(SysStats_ThermalZone&&);
  SysStats_ThermalZone(const SysStats_ThermalZone&);
  SysStats_ThermalZone& operator=(const SysStats_ThermalZone&);
  bool operator==(const SysStats_ThermalZone&) const;
  bool operator!=(const SysStats_ThermalZone& other) const { return !(*this == other); }
  ...
  uint64_t temp() const { return temp_; }
  void set_temp(uint64_t value) { temp_ = value; _has_field_.set(2); }
...
class PERFETTO_EXPORT_COMPONENT SysStats_PsiSample : public ::protozero::CppMessageObj {
 public:
  ...
  const SysStats_PsiSample_PsiResource& resource() const { return resource_; }
  void set_resource(const SysStats_PsiSample_PsiResource& value) { resource_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT SysStats_CpuTimes : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_steal_ns() const { return _has_field_[9]; }
  uint64_t steal_ns() const { return steal_ns_; }
  void set_steal_ns(uint64_t value) { steal_ns_ = value; _has_field_.set(9); }
...
class PERFETTO_EXPORT_COMPONENT SysStats_VmstatValue : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_key() const { return _has_field_[1]; }
  const VmstatCounters& key() const { return key_; }
  void set_key(const VmstatCounters& value) { key_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT SysStats_MeminfoValue : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_key() const { return _has_field_[1]; }
  const MeminfoCounters& key() const { return key_; }
  void set_key(const MeminfoCounters& value) { key_ = value; _has_field_.set(1); }
