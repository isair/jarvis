...
class CounterDescriptor : public ::protozero::Message {
 public:
  ...
  static constexpr BuiltinCounterType COUNTER_UNSPECIFIED = BuiltinCounterType::COUNTER_UNSPECIFIED;
  static constexpr BuiltinCounterType COUNTER_THREAD_TIME_NS = BuiltinCounterType::COUNTER_THREAD_TIME_NS;
  static constexpr BuiltinCounterType COUNTER_THREAD_INSTRUCTION_COUNT = BuiltinCounterType::COUNTER_THREAD_INSTRUCTION_COUNT;
  static constexpr Unit UNIT_UNSPECIFIED = Unit::UNIT_UNSPECIFIED;
  static constexpr Unit UNIT_TIME_NS = Unit::UNIT_TIME_NS;
  static constexpr Unit UNIT_COUNT = Unit::UNIT_COUNT;
  static constexpr Unit UNIT_SIZE_BYTES = Unit::UNIT_SIZE_BYTES;
