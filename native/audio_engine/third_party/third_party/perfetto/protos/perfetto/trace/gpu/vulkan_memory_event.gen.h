...
class PERFETTO_EXPORT_COMPONENT VulkanMemoryEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const VulkanMemoryEvent_Source& source() const { return source_; }
  void set_source(const VulkanMemoryEvent_Source& value) { source_ = value; _has_field_.set(1); }

  bool has_operation() const { return _has_field_[2]; }
  const VulkanMemoryEvent_Operation& operation() const { return operation_; }
  void set_operation(const VulkanMemoryEvent_Operation& value) { operation_ = value; _has_field_.set(2); }
  ...
  const VulkanMemoryEvent_AllocationScope& allocation_scope() const { return allocation_scope_; }
  void set_allocation_scope(const VulkanMemoryEvent_AllocationScope& value) { allocation_scope_ = value; _has_field_.set(8); }
