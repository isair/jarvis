...
bool HeapGraphObject::operator==(const HeapGraphObject& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(heap_type_delta_, other.heap_type_delta_)
    && ::protozero::internal::gen_helpers::EqualsField(runtime_internal_object_id_, other.runtime_internal_object_id_);
}

bool HeapGraphObject::ParseFromArray(const void* raw, size_t size) {
  reference_field_id_.clear();
  reference_object_id_.clear();
  runtime_internal_object_id_.clear();
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 8 /* native_allocation_registry_size_field */:
        ...
        break;
      case 9 /* heap_type_delta */:
        field.get(&heap_type_delta_);
        break;
      case 10 /* runtime_internal_object_id */:
        if (!::protozero::internal::gen_helpers::DeserializePackedRepeated<::protozero::proto_utils::ProtoWireType::kVarInt, uint64_t>(field, &runtime_internal_object_id_)) {
          packed_error = true;
        }
        break;
      default:
...
void HeapGraphObject::Serialize(::protozero::Message* msg) const {
  ...
  // Field 9: heap_type_delta
  if (_has_field_[9]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(9, heap_type_delta_, msg);
  }

  // Field 10: runtime_internal_object_id
  {
    ::protozero::PackedVarInt pack;
    for (auto& it : runtime_internal_object_id_)
      pack.Append(it);
