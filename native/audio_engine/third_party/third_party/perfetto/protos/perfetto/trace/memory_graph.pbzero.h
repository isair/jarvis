...
class MemoryTrackerSnapshot : public ::protozero::Message {
 public:
  ...
  static constexpr LevelOfDetail DETAIL_FULL = LevelOfDetail::DETAIL_FULL;
  static constexpr LevelOfDetail DETAIL_LIGHT = LevelOfDetail::DETAIL_LIGHT;
  static constexpr LevelOfDetail DETAIL_BACKGROUND = LevelOfDetail::DETAIL_BACKGROUND;
...
class MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode_MemoryNodeEntry : public ::protozero::Message {
 public:
  ...
  static constexpr Units UNSPECIFIED = Units::UNSPECIFIED;
  static constexpr Units BYTES = Units::BYTES;
  static constexpr Units COUNT = Units::COUNT;
