...
class ChromeLegacyIpc : public ::protozero::Message {
 public:
  ...
  static constexpr MessageClass CLASS_UNSPECIFIED = MessageClass::CLASS_UNSPECIFIED;
  static constexpr MessageClass CLASS_AUTOMATION = MessageClass::CLASS_AUTOMATION;
  static constexpr MessageClass CLASS_FRAME = MessageClass::CLASS_FRAME;
  static constexpr MessageClass CLASS_PAGE = MessageClass::CLASS_PAGE;
  static constexpr MessageClass CLASS_VIEW = MessageClass::CLASS_VIEW;
  static constexpr MessageClass CLASS_WIDGET = MessageClass::CLASS_WIDGET;
  static constexpr MessageClass CLASS_INPUT = MessageClass::CLASS_INPUT;
  static constexpr MessageClass CLASS_TEST = MessageClass::CLASS_TEST;
  static constexpr MessageClass CLASS_WORKER = MessageClass::CLASS_WORKER;
  static constexpr MessageClass CLASS_NACL = MessageClass::CLASS_NACL;
  static constexpr MessageClass CLASS_GPU_CHANNEL = MessageClass::CLASS_GPU_CHANNEL;
  static constexpr MessageClass CLASS_MEDIA = MessageClass::CLASS_MEDIA;
  static constexpr MessageClass CLASS_PPAPI = MessageClass::CLASS_PPAPI;
  static constexpr MessageClass CLASS_CHROME = MessageClass::CLASS_CHROME;
  static constexpr MessageClass CLASS_DRAG = MessageClass::CLASS_DRAG;
  static constexpr MessageClass CLASS_PRINT = MessageClass::CLASS_PRINT;
  static constexpr MessageClass CLASS_EXTENSION = MessageClass::CLASS_EXTENSION;
  static constexpr MessageClass CLASS_TEXT_INPUT_CLIENT = MessageClass::CLASS_TEXT_INPUT_CLIENT;
  static constexpr MessageClass CLASS_BLINK_TEST = MessageClass::CLASS_BLINK_TEST;
  static constexpr MessageClass CLASS_ACCESSIBILITY = MessageClass::CLASS_ACCESSIBILITY;
  static constexpr MessageClass CLASS_PRERENDER = MessageClass::CLASS_PRERENDER;
  static constexpr MessageClass CLASS_CHROMOTING = MessageClass::CLASS_CHROMOTING;
  static constexpr MessageClass CLASS_BROWSER_PLUGIN = MessageClass::CLASS_BROWSER_PLUGIN;
  static constexpr MessageClass CLASS_ANDROID_WEB_VIEW = MessageClass::CLASS_ANDROID_WEB_VIEW;
  static constexpr MessageClass CLASS_NACL_HOST = MessageClass::CLASS_NACL_HOST;
  static constexpr MessageClass CLASS_ENCRYPTED_MEDIA = MessageClass::CLASS_ENCRYPTED_MEDIA;
  static constexpr MessageClass CLASS_CAST = MessageClass::CLASS_CAST;
  static constexpr MessageClass CLASS_GIN_JAVA_BRIDGE = MessageClass::CLASS_GIN_JAVA_BRIDGE;
  static constexpr MessageClass CLASS_CHROME_UTILITY_PRINTING = MessageClass::CLASS_CHROME_UTILITY_PRINTING;
  static constexpr MessageClass CLASS_OZONE_GPU = MessageClass::CLASS_OZONE_GPU;
  static constexpr MessageClass CLASS_WEB_TEST = MessageClass::CLASS_WEB_TEST;
  static constexpr MessageClass CLASS_NETWORK_HINTS = MessageClass::CLASS_NETWORK_HINTS;
  static constexpr MessageClass CLASS_EXTENSIONS_GUEST_VIEW = MessageClass::CLASS_EXTENSIONS_GUEST_VIEW;
  static constexpr MessageClass CLASS_GUEST_VIEW = MessageClass::CLASS_GUEST_VIEW;
  static constexpr MessageClass CLASS_MEDIA_PLAYER_DELEGATE = MessageClass::CLASS_MEDIA_PLAYER_DELEGATE;
  static constexpr MessageClass CLASS_EXTENSION_WORKER = MessageClass::CLASS_EXTENSION_WORKER;
  static constexpr MessageClass CLASS_SUBRESOURCE_FILTER = MessageClass::CLASS_SUBRESOURCE_FILTER;
  static constexpr MessageClass CLASS_UNFREEZABLE_FRAME = MessageClass::CLASS_UNFREEZABLE_FRAME;
