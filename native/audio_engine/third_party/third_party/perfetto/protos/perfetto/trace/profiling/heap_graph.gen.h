...
class PERFETTO_EXPORT_COMPONENT HeapGraphRoot : public ::protozero::CppMessageObj {
 public:
  ...
  const HeapGraphRoot_Type& root_type() const { return root_type_; }
  void set_root_type(const HeapGraphRoot_Type& value) { root_type_ = value; _has_field_.set(2); }
...
class PERFETTO_EXPORT_COMPONENT HeapGraphType : public ::protozero::CppMessageObj {
 public:
  ...
  const HeapGraphType_Kind& kind() const { return kind_; }
  void set_kind(const HeapGraphType_Kind& value) { kind_ = value; _has_field_.set(7); }
...
class PERFETTO_EXPORT_COMPONENT HeapGraphObject : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto HEAP_TYPE_UNKNOWN = HeapGraphObject_HeapType_HEAP_TYPE_UNKNOWN;
  static constexpr auto HEAP_TYPE_APP = HeapGraphObject_HeapType_HEAP_TYPE_APP;
  static constexpr auto HEAP_TYPE_ZYGOTE = HeapGraphObject_HeapType_HEAP_TYPE_ZYGOTE;
  static constexpr auto HEAP_TYPE_BOOT_IMAGE = HeapGraphObject_HeapType_HEAP_TYPE_BOOT_IMAGE;
  static constexpr auto HeapType_MIN = HeapGraphObject_HeapType_HEAP_TYPE_UNKNOWN;
  static constexpr auto HeapType_MAX = HeapGraphObject_HeapType_HEAP_TYPE_BOOT_IMAGE;
  ...
  bool has_heap_type_delta() const { return _has_field_[9]; }
  const HeapGraphObject_HeapType& heap_type_delta() const { return heap_type_delta_; }
  void set_heap_type_delta(const HeapGraphObject_HeapType& value) { heap_type_delta_ = value; _has_field_.set(9); }

  const std::vector<uint64_t>& runtime_internal_object_id() const { return runtime_internal_object_id_; }
  std::vector<uint64_t>* mutable_runtime_internal_object_id() { return &runtime_internal_object_id_; }
  int runtime_internal_object_id_size() const { return static_cast<int>(runtime_internal_object_id_.size()); }
  void clear_runtime_internal_object_id() { runtime_internal_object_id_.clear(); }
  void add_runtime_internal_object_id(uint64_t value) { runtime_internal_object_id_.emplace_back(value); }
  uint64_t* add_runtime_internal_object_id() { runtime_internal_object_id_.emplace_back(); return &runtime_internal_object_id_.back(); }
 ...
 private:
  ...
  HeapGraphObject_HeapType heap_type_delta_;
  std::vector<uint64_t> runtime_internal_object_id_;
