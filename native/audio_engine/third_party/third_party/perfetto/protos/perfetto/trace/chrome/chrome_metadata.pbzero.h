...
class BackgroundTracingMetadata_TriggerRule : public ::protozero::Message {
 public:
  ...
  static constexpr TriggerType TRIGGER_UNSPECIFIED = TriggerType::TRIGGER_UNSPECIFIED;
  static constexpr TriggerType MONITOR_AND_DUMP_WHEN_SPECIFIC_HISTOGRAM_AND_VALUE = TriggerType::MONITOR_AND_DUMP_WHEN_SPECIFIC_HISTOGRAM_AND_VALUE;
  static constexpr TriggerType MONITOR_AND_DUMP_WHEN_TRIGGER_NAMED = TriggerType::MONITOR_AND_DUMP_WHEN_TRIGGER_NAMED;
...
class BackgroundTracingMetadata_TriggerRule_NamedRule : public ::protozero::Message {
 public:
  ...
  static constexpr EventType UNSPECIFIED = EventType::UNSPECIFIED;
  static constexpr EventType SESSION_RESTORE = EventType::SESSION_RESTORE;
  static constexpr EventType NAVIGATION = EventType::NAVIGATION;
  static constexpr EventType STARTUP = EventType::STARTUP;
  static constexpr EventType REACHED_CODE = EventType::REACHED_CODE;
  static constexpr EventType CONTENT_TRIGGER = EventType::CONTENT_TRIGGER;
  static constexpr EventType TEST_RULE = EventType::TEST_RULE;
