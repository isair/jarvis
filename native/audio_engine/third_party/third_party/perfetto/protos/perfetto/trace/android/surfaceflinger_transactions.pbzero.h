...
class TransactionTraceFile : public ::protozero::Message {
 public:
  ...
  static constexpr MagicNumber INVALID = MagicNumber::INVALID;
  static constexpr MagicNumber MAGIC_NUMBER_L = MagicNumber::MAGIC_NUMBER_L;
  static constexpr MagicNumber MAGIC_NUMBER_H = MagicNumber::MAGIC_NUMBER_H;
...
class TransactionState_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class LayerState : public ::protozero::Message {
 public:
  ...
  static constexpr ChangesLsb eChangesLsbNone = ChangesLsb::eChangesLsbNone;
  static constexpr ChangesLsb ePositionChanged = ChangesLsb::ePositionChanged;
  static constexpr ChangesLsb eLayerChanged = ChangesLsb::eLayerChanged;
  static constexpr ChangesLsb eAlphaChanged = ChangesLsb::eAlphaChanged;
  static constexpr ChangesLsb eMatrixChanged = ChangesLsb::eMatrixChanged;
  static constexpr ChangesLsb eTransparentRegionChanged = ChangesLsb::eTransparentRegionChanged;
  static constexpr ChangesLsb eFlagsChanged = ChangesLsb::eFlagsChanged;
  static constexpr ChangesLsb eLayerStackChanged = ChangesLsb::eLayerStackChanged;
  static constexpr ChangesLsb eReleaseBufferListenerChanged = ChangesLsb::eReleaseBufferListenerChanged;
  static constexpr ChangesLsb eShadowRadiusChanged = ChangesLsb::eShadowRadiusChanged;
  static constexpr ChangesLsb eBufferCropChanged = ChangesLsb::eBufferCropChanged;
  static constexpr ChangesLsb eRelativeLayerChanged = ChangesLsb::eRelativeLayerChanged;
  static constexpr ChangesLsb eReparent = ChangesLsb::eReparent;
  static constexpr ChangesLsb eColorChanged = ChangesLsb::eColorChanged;
  static constexpr ChangesLsb eBufferTransformChanged = ChangesLsb::eBufferTransformChanged;
  static constexpr ChangesLsb eTransformToDisplayInverseChanged = ChangesLsb::eTransformToDisplayInverseChanged;
  static constexpr ChangesLsb eCropChanged = ChangesLsb::eCropChanged;
  static constexpr ChangesLsb eBufferChanged = ChangesLsb::eBufferChanged;
  static constexpr ChangesLsb eAcquireFenceChanged = ChangesLsb::eAcquireFenceChanged;
  static constexpr ChangesLsb eDataspaceChanged = ChangesLsb::eDataspaceChanged;
  static constexpr ChangesLsb eHdrMetadataChanged = ChangesLsb::eHdrMetadataChanged;
  static constexpr ChangesLsb eSurfaceDamageRegionChanged = ChangesLsb::eSurfaceDamageRegionChanged;
  static constexpr ChangesLsb eApiChanged = ChangesLsb::eApiChanged;
  static constexpr ChangesLsb eSidebandStreamChanged = ChangesLsb::eSidebandStreamChanged;
  static constexpr ChangesLsb eColorTransformChanged = ChangesLsb::eColorTransformChanged;
  static constexpr ChangesLsb eHasListenerCallbacksChanged = ChangesLsb::eHasListenerCallbacksChanged;
  static constexpr ChangesLsb eInputInfoChanged = ChangesLsb::eInputInfoChanged;
  static constexpr ChangesLsb eCornerRadiusChanged = ChangesLsb::eCornerRadiusChanged;
  static constexpr ChangesMsb eChangesMsbNone = ChangesMsb::eChangesMsbNone;
  static constexpr ChangesMsb eDestinationFrameChanged = ChangesMsb::eDestinationFrameChanged;
  static constexpr ChangesMsb eCachedBufferChanged = ChangesMsb::eCachedBufferChanged;
  static constexpr ChangesMsb eBackgroundColorChanged = ChangesMsb::eBackgroundColorChanged;
  static constexpr ChangesMsb eMetadataChanged = ChangesMsb::eMetadataChanged;
  static constexpr ChangesMsb eColorSpaceAgnosticChanged = ChangesMsb::eColorSpaceAgnosticChanged;
  static constexpr ChangesMsb eFrameRateSelectionPriority = ChangesMsb::eFrameRateSelectionPriority;
  static constexpr ChangesMsb eFrameRateChanged = ChangesMsb::eFrameRateChanged;
  static constexpr ChangesMsb eBackgroundBlurRadiusChanged = ChangesMsb::eBackgroundBlurRadiusChanged;
  static constexpr ChangesMsb eProducerDisconnect = ChangesMsb::eProducerDisconnect;
  static constexpr ChangesMsb eFixedTransformHintChanged = ChangesMsb::eFixedTransformHintChanged;
  static constexpr ChangesMsb eFrameNumberChanged = ChangesMsb::eFrameNumberChanged;
  static constexpr ChangesMsb eBlurRegionsChanged = ChangesMsb::eBlurRegionsChanged;
  static constexpr ChangesMsb eAutoRefreshChanged = ChangesMsb::eAutoRefreshChanged;
  static constexpr ChangesMsb eStretchChanged = ChangesMsb::eStretchChanged;
  static constexpr ChangesMsb eTrustedOverlayChanged = ChangesMsb::eTrustedOverlayChanged;
  static constexpr ChangesMsb eDropInputModeChanged = ChangesMsb::eDropInputModeChanged;
  static constexpr Flags eFlagsNone = Flags::eFlagsNone;
  static constexpr Flags eLayerHidden = Flags::eLayerHidden;
  static constexpr Flags eLayerOpaque = Flags::eLayerOpaque;
  static constexpr Flags eLayerSkipScreenshot = Flags::eLayerSkipScreenshot;
  static constexpr Flags eLayerSecure = Flags::eLayerSecure;
  static constexpr Flags eEnableBackpressure = Flags::eEnableBackpressure;
  static constexpr Flags eLayerIsDisplayDecoration = Flags::eLayerIsDisplayDecoration;
  static constexpr DropInputMode NONE = DropInputMode::NONE;
  static constexpr DropInputMode ALL = DropInputMode::ALL;
  static constexpr DropInputMode OBSCURED = DropInputMode::OBSCURED;
...
class LayerState_BufferData : public ::protozero::Message {
 public:
  ...
  static constexpr BufferDataChange BufferDataChangeNone = BufferDataChange::BufferDataChangeNone;
  static constexpr BufferDataChange fenceChanged = BufferDataChange::fenceChanged;
  static constexpr BufferDataChange frameNumberChanged = BufferDataChange::frameNumberChanged;
  static constexpr BufferDataChange cachedBufferChanged = BufferDataChange::cachedBufferChanged;
  static constexpr PixelFormat PIXEL_FORMAT_UNKNOWN = PixelFormat::PIXEL_FORMAT_UNKNOWN;
  static constexpr PixelFormat PIXEL_FORMAT_CUSTOM = PixelFormat::PIXEL_FORMAT_CUSTOM;
  static constexpr PixelFormat PIXEL_FORMAT_TRANSLUCENT = PixelFormat::PIXEL_FORMAT_TRANSLUCENT;
  static constexpr PixelFormat PIXEL_FORMAT_TRANSPARENT = PixelFormat::PIXEL_FORMAT_TRANSPARENT;
  static constexpr PixelFormat PIXEL_FORMAT_OPAQUE = PixelFormat::PIXEL_FORMAT_OPAQUE;
  static constexpr PixelFormat PIXEL_FORMAT_RGBA_8888 = PixelFormat::PIXEL_FORMAT_RGBA_8888;
  static constexpr PixelFormat PIXEL_FORMAT_RGBX_8888 = PixelFormat::PIXEL_FORMAT_RGBX_8888;
  static constexpr PixelFormat PIXEL_FORMAT_RGB_888 = PixelFormat::PIXEL_FORMAT_RGB_888;
  static constexpr PixelFormat PIXEL_FORMAT_RGB_565 = PixelFormat::PIXEL_FORMAT_RGB_565;
  static constexpr PixelFormat PIXEL_FORMAT_BGRA_8888 = PixelFormat::PIXEL_FORMAT_BGRA_8888;
  static constexpr PixelFormat PIXEL_FORMAT_RGBA_5551 = PixelFormat::PIXEL_FORMAT_RGBA_5551;
  static constexpr PixelFormat PIXEL_FORMAT_RGBA_4444 = PixelFormat::PIXEL_FORMAT_RGBA_4444;
  static constexpr PixelFormat PIXEL_FORMAT_RGBA_FP16 = PixelFormat::PIXEL_FORMAT_RGBA_FP16;
  static constexpr PixelFormat PIXEL_FORMAT_RGBA_1010102 = PixelFormat::PIXEL_FORMAT_RGBA_1010102;
  static constexpr PixelFormat PIXEL_FORMAT_R_8 = PixelFormat::PIXEL_FORMAT_R_8;
...
class DisplayState : public ::protozero::Message {
 public:
  ...
  static constexpr Changes eChangesNone = Changes::eChangesNone;
  static constexpr Changes eSurfaceChanged = Changes::eSurfaceChanged;
  static constexpr Changes eLayerStackChanged = Changes::eLayerStackChanged;
  static constexpr Changes eDisplayProjectionChanged = Changes::eDisplayProjectionChanged;
  static constexpr Changes eDisplaySizeChanged = Changes::eDisplaySizeChanged;
  static constexpr Changes eFlagsChanged = Changes::eFlagsChanged;
