...
class PERFETTO_EXPORT_COMPONENT LayerProto : public ::protozero::CppMessageObj {
 public:
  ...
  const HwcCompositionType& hwc_composition_type() const { return hwc_composition_type_; }
  void set_hwc_composition_type(const HwcCompositionType& value) { hwc_composition_type_ = value; _has_field_.set(35); }
  ...
  void set_trusted_overlay(const TrustedOverlay& value) { trusted_overlay_ = value; _has_field_.set(59); }

  bool has_background_blur_scale() const { return _has_field_[60]; }
  float background_blur_scale() const { return background_blur_scale_; }
  void set_background_blur_scale(float value) { background_blur_scale_ = value; _has_field_.set(60); }
