...
class ChromeThreadDescriptor : public ::protozero::Message {
 public:
  ...
  static constexpr ThreadType THREAD_UNSPECIFIED = ThreadType::THREAD_UNSPECIFIED;
  static constexpr ThreadType THREAD_MAIN = ThreadType::THREAD_MAIN;
  static constexpr ThreadType THREAD_IO = ThreadType::THREAD_IO;
  static constexpr ThreadType THREAD_POOL_BG_WORKER = ThreadType::THREAD_POOL_BG_WORKER;
  static constexpr ThreadType THREAD_POOL_FG_WORKER = ThreadType::THREAD_POOL_FG_WORKER;
  static constexpr ThreadType THREAD_POOL_FG_BLOCKING = ThreadType::THREAD_POOL_FG_BLOCKING;
  static constexpr ThreadType THREAD_POOL_BG_BLOCKING = ThreadType::THREAD_POOL_BG_BLOCKING;
  static constexpr ThreadType THREAD_POOL_SERVICE = ThreadType::THREAD_POOL_SERVICE;
  static constexpr ThreadType THREAD_COMPOSITOR = ThreadType::THREAD_COMPOSITOR;
  static constexpr ThreadType THREAD_VIZ_COMPOSITOR = ThreadType::THREAD_VIZ_COMPOSITOR;
  static constexpr ThreadType THREAD_COMPOSITOR_WORKER = ThreadType::THREAD_COMPOSITOR_WORKER;
  static constexpr ThreadType THREAD_SERVICE_WORKER = ThreadType::THREAD_SERVICE_WORKER;
  static constexpr ThreadType THREAD_NETWORK_SERVICE = ThreadType::THREAD_NETWORK_SERVICE;
  static constexpr ThreadType THREAD_CHILD_IO = ThreadType::THREAD_CHILD_IO;
  static constexpr ThreadType THREAD_BROWSER_IO = ThreadType::THREAD_BROWSER_IO;
  static constexpr ThreadType THREAD_BROWSER_MAIN = ThreadType::THREAD_BROWSER_MAIN;
  static constexpr ThreadType THREAD_RENDERER_MAIN = ThreadType::THREAD_RENDERER_MAIN;
  static constexpr ThreadType THREAD_UTILITY_MAIN = ThreadType::THREAD_UTILITY_MAIN;
  static constexpr ThreadType THREAD_GPU_MAIN = ThreadType::THREAD_GPU_MAIN;
  static constexpr ThreadType THREAD_CACHE_BLOCKFILE = ThreadType::THREAD_CACHE_BLOCKFILE;
  static constexpr ThreadType THREAD_MEDIA = ThreadType::THREAD_MEDIA;
  static constexpr ThreadType THREAD_AUDIO_OUTPUTDEVICE = ThreadType::THREAD_AUDIO_OUTPUTDEVICE;
  static constexpr ThreadType THREAD_AUDIO_INPUTDEVICE = ThreadType::THREAD_AUDIO_INPUTDEVICE;
  static constexpr ThreadType THREAD_GPU_MEMORY = ThreadType::THREAD_GPU_MEMORY;
  static constexpr ThreadType THREAD_GPU_VSYNC = ThreadType::THREAD_GPU_VSYNC;
  static constexpr ThreadType THREAD_DXA_VIDEODECODER = ThreadType::THREAD_DXA_VIDEODECODER;
  static constexpr ThreadType THREAD_BROWSER_WATCHDOG = ThreadType::THREAD_BROWSER_WATCHDOG;
  static constexpr ThreadType THREAD_WEBRTC_NETWORK = ThreadType::THREAD_WEBRTC_NETWORK;
  static constexpr ThreadType THREAD_WINDOW_OWNER = ThreadType::THREAD_WINDOW_OWNER;
  static constexpr ThreadType THREAD_WEBRTC_SIGNALING = ThreadType::THREAD_WEBRTC_SIGNALING;
  static constexpr ThreadType THREAD_WEBRTC_WORKER = ThreadType::THREAD_WEBRTC_WORKER;
  static constexpr ThreadType THREAD_PPAPI_MAIN = ThreadType::THREAD_PPAPI_MAIN;
  static constexpr ThreadType THREAD_GPU_WATCHDOG = ThreadType::THREAD_GPU_WATCHDOG;
  static constexpr ThreadType THREAD_SWAPPER = ThreadType::THREAD_SWAPPER;
  static constexpr ThreadType THREAD_GAMEPAD_POLLING = ThreadType::THREAD_GAMEPAD_POLLING;
  static constexpr ThreadType THREAD_WEBCRYPTO = ThreadType::THREAD_WEBCRYPTO;
  static constexpr ThreadType THREAD_DATABASE = ThreadType::THREAD_DATABASE;
  static constexpr ThreadType THREAD_PROXYRESOLVER = ThreadType::THREAD_PROXYRESOLVER;
  static constexpr ThreadType THREAD_DEVTOOLSADB = ThreadType::THREAD_DEVTOOLSADB;
  static constexpr ThreadType THREAD_NETWORKCONFIGWATCHER = ThreadType::THREAD_NETWORKCONFIGWATCHER;
  static constexpr ThreadType THREAD_WASAPI_RENDER = ThreadType::THREAD_WASAPI_RENDER;
  static constexpr ThreadType THREAD_LOADER_LOCK_SAMPLER = ThreadType::THREAD_LOADER_LOCK_SAMPLER;
  static constexpr ThreadType THREAD_MEMORY_INFRA = ThreadType::THREAD_MEMORY_INFRA;
  static constexpr ThreadType THREAD_SAMPLING_PROFILER = ThreadType::THREAD_SAMPLING_PROFILER;
  static constexpr ThreadType THREAD_COMPOSITOR_GPU = ThreadType::THREAD_COMPOSITOR_GPU;
