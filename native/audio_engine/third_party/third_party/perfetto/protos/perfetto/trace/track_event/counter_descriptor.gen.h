...
class PERFETTO_EXPORT_COMPONENT CounterDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const CounterDescriptor_BuiltinCounterType& type() const { return type_; }
  void set_type(const CounterDescriptor_BuiltinCounterType& value) { type_ = value; _has_field_.set(1); }
  ...
  const CounterDescriptor_Unit& unit() const { return unit_; }
  void set_unit(const CounterDescriptor_Unit& value) { unit_ = value; _has_field_.set(3); }
