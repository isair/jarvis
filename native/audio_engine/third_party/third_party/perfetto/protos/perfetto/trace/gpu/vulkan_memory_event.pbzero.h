...
class VulkanMemoryEvent : public ::protozero::Message {
 public:
  ...
  static constexpr Source SOURCE_UNSPECIFIED = Source::SOURCE_UNSPECIFIED;
  static constexpr Source SOURCE_DRIVER = Source::SOURCE_DRIVER;
  static constexpr Source SOURCE_DEVICE = Source::SOURCE_DEVICE;
  static constexpr Source SOURCE_DEVICE_MEMORY = Source::SOURCE_DEVICE_MEMORY;
  static constexpr Source SOURCE_BUFFER = Source::SOURCE_BUFFER;
  static constexpr Source SOURCE_IMAGE = Source::SOURCE_IMAGE;
  static constexpr Operation OP_UNSPECIFIED = Operation::OP_UNSPECIFIED;
  static constexpr Operation OP_CREATE = Operation::OP_CREATE;
  static constexpr Operation OP_DESTROY = Operation::OP_DESTROY;
  static constexpr Operation OP_BIND = Operation::OP_BIND;
  static constexpr Operation OP_DESTROY_BOUND = Operation::OP_DESTROY_BOUND;
  static constexpr Operation OP_ANNOTATIONS = Operation::OP_ANNOTATIONS;
  static constexpr AllocationScope SCOPE_UNSPECIFIED = AllocationScope::SCOPE_UNSPECIFIED;
  static constexpr AllocationScope SCOPE_COMMAND = AllocationScope::SCOPE_COMMAND;
  static constexpr AllocationScope SCOPE_OBJECT = AllocationScope::SCOPE_OBJECT;
  static constexpr AllocationScope SCOPE_CACHE = AllocationScope::SCOPE_CACHE;
  static constexpr AllocationScope SCOPE_DEVICE = AllocationScope::SCOPE_DEVICE;
  static constexpr AllocationScope SCOPE_INSTANCE = AllocationScope::SCOPE_INSTANCE;
