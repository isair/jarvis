...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ActualDisplayFrameStart : public ::protozero::CppMessageObj {
 public:
  ...
  const FrameTimelineEvent_PresentType& present_type() const { return present_type_; }
  void set_present_type(const FrameTimelineEvent_PresentType& value) { present_type_ = value; _has_field_.set(4); }
  ...
  const FrameTimelineEvent_PredictionType& prediction_type() const { return prediction_type_; }
  void set_prediction_type(const FrameTimelineEvent_PredictionType& value) { prediction_type_ = value; _has_field_.set(8); }

  bool has_jank_severity_type() const { return _has_field_[9]; }
  const FrameTimelineEvent_JankSeverityType& jank_severity_type() const { return jank_severity_type_; }
  void set_jank_severity_type(const FrameTimelineEvent_JankSeverityType& value) { jank_severity_type_ = value; _has_field_.set(9); }
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ActualSurfaceFrameStart : public ::protozero::CppMessageObj {
 public:
  ...
  const FrameTimelineEvent_PresentType& present_type() const { return present_type_; }
  void set_present_type(const FrameTimelineEvent_PresentType& value) { present_type_ = value; _has_field_.set(6); }
  ...
  const FrameTimelineEvent_PredictionType& prediction_type() const { return prediction_type_; }
  void set_prediction_type(const FrameTimelineEvent_PredictionType& value) { prediction_type_ = value; _has_field_.set(10); }
  ...
  const FrameTimelineEvent_JankSeverityType& jank_severity_type() const { return jank_severity_type_; }
  void set_jank_severity_type(const FrameTimelineEvent_JankSeverityType& value) { jank_severity_type_ = value; _has_field_.set(12); }
