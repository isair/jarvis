...
class TrackDescriptor : public ::protozero::Message {
 public:
  ...
  static constexpr ChildTracksOrdering UNKNOWN = ChildTracksOrdering::UNKNOWN;
  static constexpr ChildTracksOrdering LEXICOGRAPHIC = ChildTracksOrdering::LEXICOGRAPHIC;
  static constexpr ChildTracksOrdering CHRONOLOGICAL = ChildTracksOrdering::CHRONOLOGICAL;
  static constexpr ChildTracksOrdering EXPLICIT = ChildTracksOrdering::EXPLICIT;
