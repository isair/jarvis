...
class LogMessage : public ::protozero::Message {
 public:
  ...
  static constexpr Priority PRIO_UNSPECIFIED = Priority::PRIO_UNSPECIFIED;
  static constexpr Priority PRIO_UNUSED = Priority::PRIO_UNUSED;
  static constexpr Priority PRIO_VERBOSE = Priority::PRIO_VERBOSE;
  static constexpr Priority PRIO_DEBUG = Priority::PRIO_DEBUG;
  static constexpr Priority PRIO_INFO = Priority::PRIO_INFO;
  static constexpr Priority PRIO_WARN = Priority::PRIO_WARN;
  static constexpr Priority PRIO_ERROR = Priority::PRIO_ERROR;
  static constexpr Priority PRIO_FATAL = Priority::PRIO_FATAL;
