...
bool ProcessTree_Process::operator==(const ProcessTree_Process& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(cmdline_is_comm_, other.cmdline_is_comm_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(is_kthread_, other.is_kthread_);
}
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 3 /* cmdline */:
        ...
        break;
      case 9 /* cmdline_is_comm */:
        field.get(&cmdline_is_comm_);
        break;
      case 5 /* uid */:
        field.get(&uid_);
        break;
...
void ProcessTree_Process::Serialize(::protozero::Message* msg) const {
  ...
  // Field 9: cmdline_is_comm
  if (_has_field_[9]) {
    ::protozero::internal::gen_helpers::SerializeTinyVarInt(9, cmdline_is_comm_, msg);
  }
  ...
  // Field 8: is_kthread
  if (_has_field_[8]) {
    ::protozero::internal::gen_helpers::SerializeTinyVarInt(8, is_kthread_, msg);
  }
