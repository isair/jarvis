...
class CSwitchEtwEvent : public ::protozero::Message {
 public:
  ...
  static constexpr OldThreadWaitReason EXECUTIVE = OldThreadWaitReason::EXECUTIVE;
  static constexpr OldThreadWaitReason FREE_PAGE = OldThreadWaitReason::FREE_PAGE;
  static constexpr OldThreadWaitReason PAGE_IN = OldThreadWaitReason::PAGE_IN;
  static constexpr OldThreadWaitReason POOL_ALLOCATION = OldThreadWaitReason::POOL_ALLOCATION;
  static constexpr OldThreadWaitReason DELAY_EXECUTION = OldThreadWaitReason::DELAY_EXECUTION;
  static constexpr OldThreadWaitReason SUSPEND = OldThreadWaitReason::SUSPEND;
  static constexpr OldThreadWaitReason USER_REQUEST = OldThreadWaitReason::USER_REQUEST;
  static constexpr OldThreadWaitReason WR_EXECUTIVE = OldThreadWaitReason::WR_EXECUTIVE;
  static constexpr OldThreadWaitReason WR_FREE_PAGE = OldThreadWaitReason::WR_FREE_PAGE;
  static constexpr OldThreadWaitReason WR_PAGE_IN = OldThreadWaitReason::WR_PAGE_IN;
  static constexpr OldThreadWaitReason WR_POOL_ALLOCATION = OldThreadWaitReason::WR_POOL_ALLOCATION;
  static constexpr OldThreadWaitReason WR_DELAY_EXECUTION = OldThreadWaitReason::WR_DELAY_EXECUTION;
  static constexpr OldThreadWaitReason WR_SUSPENDED = OldThreadWaitReason::WR_SUSPENDED;
  static constexpr OldThreadWaitReason WR_USER_REQUEST = OldThreadWaitReason::WR_USER_REQUEST;
  static constexpr OldThreadWaitReason WR_EVENT_PAIR = OldThreadWaitReason::WR_EVENT_PAIR;
  static constexpr OldThreadWaitReason WR_QUEUE = OldThreadWaitReason::WR_QUEUE;
  static constexpr OldThreadWaitReason WR_LPC_RECEIVER = OldThreadWaitReason::WR_LPC_RECEIVER;
  static constexpr OldThreadWaitReason WR_LPC_REPLY = OldThreadWaitReason::WR_LPC_REPLY;
  static constexpr OldThreadWaitReason WR_VIRTUAL_MEMORY = OldThreadWaitReason::WR_VIRTUAL_MEMORY;
  static constexpr OldThreadWaitReason WR_PAGE_OUT = OldThreadWaitReason::WR_PAGE_OUT;
  static constexpr OldThreadWaitReason WR_RENDEZ_VOUS = OldThreadWaitReason::WR_RENDEZ_VOUS;
  static constexpr OldThreadWaitReason WR_KEYED_EVENT = OldThreadWaitReason::WR_KEYED_EVENT;
  static constexpr OldThreadWaitReason WR_TERMINATED = OldThreadWaitReason::WR_TERMINATED;
  static constexpr OldThreadWaitReason WR_PROCESS_IN_SWAP = OldThreadWaitReason::WR_PROCESS_IN_SWAP;
  static constexpr OldThreadWaitReason WR_CPU_RATE_CONTROL = OldThreadWaitReason::WR_CPU_RATE_CONTROL;
  static constexpr OldThreadWaitReason WR_CALLOUT_STACK = OldThreadWaitReason::WR_CALLOUT_STACK;
  static constexpr OldThreadWaitReason WR_KERNEL = OldThreadWaitReason::WR_KERNEL;
  static constexpr OldThreadWaitReason WR_RESOURCE = OldThreadWaitReason::WR_RESOURCE;
  static constexpr OldThreadWaitReason WR_PUSH_LOCK = OldThreadWaitReason::WR_PUSH_LOCK;
  static constexpr OldThreadWaitReason WR_MUTEX = OldThreadWaitReason::WR_MUTEX;
  static constexpr OldThreadWaitReason WR_QUANTUM_END = OldThreadWaitReason::WR_QUANTUM_END;
  static constexpr OldThreadWaitReason WR_DISPATCH_INT = OldThreadWaitReason::WR_DISPATCH_INT;
  static constexpr OldThreadWaitReason WR_PREEMPTED = OldThreadWaitReason::WR_PREEMPTED;
  static constexpr OldThreadWaitReason WR_YIELD_EXECUTION = OldThreadWaitReason::WR_YIELD_EXECUTION;
  static constexpr OldThreadWaitReason WR_FAST_MUTEX = OldThreadWaitReason::WR_FAST_MUTEX;
  static constexpr OldThreadWaitReason WR_GUARD_MUTEX = OldThreadWaitReason::WR_GUARD_MUTEX;
  static constexpr OldThreadWaitReason WR_RUNDOWN = OldThreadWaitReason::WR_RUNDOWN;
  static constexpr OldThreadWaitReason MAXIMUM_WAIT_REASON = OldThreadWaitReason::MAXIMUM_WAIT_REASON;
  static constexpr OldThreadWaitMode KERNEL_MODE = OldThreadWaitMode::KERNEL_MODE;
  static constexpr OldThreadWaitMode USER_MODE = OldThreadWaitMode::USER_MODE;
  static constexpr OldThreadState INITIALIZED = OldThreadState::INITIALIZED;
  static constexpr OldThreadState READY = OldThreadState::READY;
  static constexpr OldThreadState RUNNING = OldThreadState::RUNNING;
  static constexpr OldThreadState STANDBY = OldThreadState::STANDBY;
  static constexpr OldThreadState TERMINATED = OldThreadState::TERMINATED;
  static constexpr OldThreadState WAITING = OldThreadState::WAITING;
  static constexpr OldThreadState TRANSITION = OldThreadState::TRANSITION;
  static constexpr OldThreadState DEFERRED_READY = OldThreadState::DEFERRED_READY;
...
class ReadyThreadEtwEvent : public ::protozero::Message {
 public:
  ...
  static constexpr AdjustReason IGNORE_THE_INCREMENT = AdjustReason::IGNORE_THE_INCREMENT;
  static constexpr AdjustReason APPLY_INCREMENT = AdjustReason::APPLY_INCREMENT;
  static constexpr AdjustReason APPLY_INCREMENT_BOOST = AdjustReason::APPLY_INCREMENT_BOOST;
  static constexpr TraceFlag TRACE_FLAG_UNSPECIFIED = TraceFlag::TRACE_FLAG_UNSPECIFIED;
  static constexpr TraceFlag THREAD_READIED = TraceFlag::THREAD_READIED;
  static constexpr TraceFlag KERNEL_STACK_SWAPPED_OUT = TraceFlag::KERNEL_STACK_SWAPPED_OUT;
  static constexpr TraceFlag PROCESS_ADDRESS_SWAPPED_OUT = TraceFlag::PROCESS_ADDRESS_SWAPPED_OUT;
