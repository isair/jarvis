...
class PERFETTO_EXPORT_COMPONENT BlockIoStartFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kDevFieldNumber = 1,
    kSectorFieldNumber = 2,
  ...
  ~BlockIoStartFtraceEvent() override;
  BlockIoStartFtraceEvent(BlockIoStartFtraceEvent&&) noexcept;
  BlockIoStartFtraceEvent& operator=(BlockIoStartFtraceEvent&&);
  BlockIoStartFtraceEvent(const BlockIoStartFtraceEvent&);
  BlockIoStartFtraceEvent& operator=(const BlockIoStartFtraceEvent&);
  bool operator==(const BlockIoStartFtraceEvent&) const;
  bool operator!=(const BlockIoStartFtraceEvent& other) const { return !(*this == other); }
  ...
  bool has_ioprio() const { return _has_field_[5]; }
  uint32_t ioprio() const { return ioprio_; }
  void set_ioprio(uint32_t value) { ioprio_ = value; _has_field_.set(5); }

  bool has_rwbs() const { return _has_field_[6]; }
  const std::string& rwbs() const { return rwbs_; }
  void set_rwbs(const std::string& value) { rwbs_ = value; _has_field_.set(6); }

  bool has_comm() const { return _has_field_[7]; }
  const std::string& comm() const { return comm_; }
  void set_comm(const std::string& value) { comm_ = value; _has_field_.set(7); }

  bool has_cmd() const { return _has_field_[8]; }
  const std::string& cmd() const { return cmd_; }
  void set_cmd(const std::string& value) { cmd_ = value; _has_field_.set(8); }
...
class PERFETTO_EXPORT_COMPONENT BlockIoDoneFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kDevFieldNumber = 1,
    kSectorFieldNumber = 2,
  ...
  ~BlockIoDoneFtraceEvent() override;
  BlockIoDoneFtraceEvent(BlockIoDoneFtraceEvent&&) noexcept;
  BlockIoDoneFtraceEvent& operator=(BlockIoDoneFtraceEvent&&);
  BlockIoDoneFtraceEvent(const BlockIoDoneFtraceEvent&);
  BlockIoDoneFtraceEvent& operator=(const BlockIoDoneFtraceEvent&);
  bool operator==(const BlockIoDoneFtraceEvent&) const;
  bool operator!=(const BlockIoDoneFtraceEvent& other) const { return !(*this == other); }
