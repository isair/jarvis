...
class PERFETTO_EXPORT_COMPONENT ChromeCompositorSchedulerState : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeCompositorSchedulerAction& inside_action() const { return inside_action_; }
  void set_inside_action(const ChromeCompositorSchedulerAction& value) { inside_action_ = value; _has_field_.set(7); }

  bool has_deadline_mode() const { return _has_field_[8]; }
  const ChromeCompositorSchedulerState_BeginImplFrameDeadlineMode& deadline_mode() const { return deadline_mode_; }
  void set_deadline_mode(const ChromeCompositorSchedulerState_BeginImplFrameDeadlineMode& value) { deadline_mode_ = value; _has_field_.set(8); }
...
class PERFETTO_EXPORT_COMPONENT ChromeCompositorStateMachine_MinorState : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeCompositorStateMachine_MinorState_TreePriority& tree_priority() const { return tree_priority_; }
  void set_tree_priority(const ChromeCompositorStateMachine_MinorState_TreePriority& value) { tree_priority_ = value; _has_field_.set(31); }

  bool has_scroll_handler_state() const { return _has_field_[32]; }
  const ChromeCompositorStateMachine_MinorState_ScrollHandlerState& scroll_handler_state() const { return scroll_handler_state_; }
  void set_scroll_handler_state(const ChromeCompositorStateMachine_MinorState_ScrollHandlerState& value) { scroll_handler_state_ = value; _has_field_.set(32); }
...
class PERFETTO_EXPORT_COMPONENT ChromeCompositorStateMachine_MajorState : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeCompositorSchedulerAction& next_action() const { return next_action_; }
  void set_next_action(const ChromeCompositorSchedulerAction& value) { next_action_ = value; _has_field_.set(1); }

  bool has_begin_impl_frame_state() const { return _has_field_[2]; }
  const ChromeCompositorStateMachine_MajorState_BeginImplFrameState& begin_impl_frame_state() const { return begin_impl_frame_state_; }
  void set_begin_impl_frame_state(const ChromeCompositorStateMachine_MajorState_BeginImplFrameState& value) { begin_impl_frame_state_ = value; _has_field_.set(2); }

  bool has_begin_main_frame_state() const { return _has_field_[3]; }
  const ChromeCompositorStateMachine_MajorState_BeginMainFrameState& begin_main_frame_state() const { return begin_main_frame_state_; }
  void set_begin_main_frame_state(const ChromeCompositorStateMachine_MajorState_BeginMainFrameState& value) { begin_main_frame_state_ = value; _has_field_.set(3); }

  bool has_layer_tree_frame_sink_state() const { return _has_field_[4]; }
  const ChromeCompositorStateMachine_MajorState_LayerTreeFrameSinkState& layer_tree_frame_sink_state() const { return layer_tree_frame_sink_state_; }
  void set_layer_tree_frame_sink_state(const ChromeCompositorStateMachine_MajorState_LayerTreeFrameSinkState& value) { layer_tree_frame_sink_state_ = value; _has_field_.set(4); }

  bool has_forced_redraw_state() const { return _has_field_[5]; }
  const ChromeCompositorStateMachine_MajorState_ForcedRedrawOnTimeoutState& forced_redraw_state() const { return forced_redraw_state_; }
  void set_forced_redraw_state(const ChromeCompositorStateMachine_MajorState_ForcedRedrawOnTimeoutState& value) { forced_redraw_state_ = value; _has_field_.set(5); }
...
class PERFETTO_EXPORT_COMPONENT BeginFrameArgs : public ::protozero::CppMessageObj {
 public:
  ...
  const BeginFrameArgs_BeginFrameArgsType& type() const { return type_; }
  void set_type(const BeginFrameArgs_BeginFrameArgsType& value) { type_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT BeginImplFrameArgs : public ::protozero::CppMessageObj {
 public:
  ...
  const BeginImplFrameArgs_State& state() const { return state_; }
  void set_state(const BeginImplFrameArgs_State& value) { state_ = value; _has_field_.set(3); }
