...
class ProcessDescriptor : public ::protozero::Message {
 public:
  ...
  static constexpr ChromeProcessType PROCESS_UNSPECIFIED = ChromeProcessType::PROCESS_UNSPECIFIED;
  static constexpr ChromeProcessType PROCESS_BROWSER = ChromeProcessType::PROCESS_BROWSER;
  static constexpr ChromeProcessType PROCESS_RENDERER = ChromeProcessType::PROCESS_RENDERER;
  static constexpr ChromeProcessType PROCESS_UTILITY = ChromeProcessType::PROCESS_UTILITY;
  static constexpr ChromeProcessType PROCESS_ZYGOTE = ChromeProcessType::PROCESS_ZYGOTE;
  static constexpr ChromeProcessType PROCESS_SANDBOX_HELPER = ChromeProcessType::PROCESS_SANDBOX_HELPER;
  static constexpr ChromeProcessType PROCESS_GPU = ChromeProcessType::PROCESS_GPU;
  static constexpr ChromeProcessType PROCESS_PPAPI_PLUGIN = ChromeProcessType::PROCESS_PPAPI_PLUGIN;
  static constexpr ChromeProcessType PROCESS_PPAPI_BROKER = ChromeProcessType::PROCESS_PPAPI_BROKER;
