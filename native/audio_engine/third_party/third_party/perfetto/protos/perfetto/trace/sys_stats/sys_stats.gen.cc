...
bool SysStats::operator==(const SysStats& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(cpuidle_state_, other.cpuidle_state_)
    && ::protozero::internal::gen_helpers::EqualsField(gpufreq_mhz_, other.gpufreq_mhz_);
}
...
int SysStats::thermal_zone_size() const { return static_cast<int>(thermal_zone_.size()); }
void SysStats::clear_thermal_zone() { thermal_zone_.clear(); }
SysStats_ThermalZone* SysStats::add_thermal_zone() { thermal_zone_.emplace_back(); return &thermal_zone_.back(); }
int SysStats::cpuidle_state_size() const { return static_cast<int>(cpuidle_state_.size()); }
void SysStats::clear_cpuidle_state() { cpuidle_state_.clear(); }
SysStats_CpuIdleState* SysStats::add_cpuidle_state() { cpuidle_state_.emplace_back(); return &cpuidle_state_.back(); }
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 14 /* psi */:
        ...
        break;
      case 15 /* thermal_zone */:
        thermal_zone_.emplace_back();
        thermal_zone_.back().ParseFromArray(field.data(), field.size());
        break;
      case 16 /* cpuidle_state */:
        cpuidle_state_.emplace_back();
        cpuidle_state_.back().ParseFromArray(field.data(), field.size());
        break;
      case 17 /* gpufreq_mhz */:
        gpufreq_mhz_.emplace_back();
        field.get(&gpufreq_mhz_.back());
        break;
      default:
...
void SysStats::Serialize(::protozero::Message* msg) const {
  ...
  // Field 15: thermal_zone
  for (auto& it : thermal_zone_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(15));
  }

  // Field 16: cpuidle_state
  for (auto& it : cpuidle_state_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(16));
  }

  // Field 17: gpufreq_mhz
  for (auto& it : gpufreq_mhz_) {
...
SysStats_CpuIdleState::SysStats_CpuIdleState() = default;
SysStats_CpuIdleState::~SysStats_CpuIdleState() = default;
SysStats_CpuIdleState::SysStats_CpuIdleState(const SysStats_CpuIdleState&) = default;
SysStats_CpuIdleState& SysStats_CpuIdleState::operator=(const SysStats_CpuIdleState&) = default;
SysStats_CpuIdleState::SysStats_CpuIdleState(SysStats_CpuIdleState&&) noexcept = default;
SysStats_CpuIdleState& SysStats_CpuIdleState::operator=(SysStats_CpuIdleState&&) = default;

bool SysStats_CpuIdleState::operator==(const SysStats_CpuIdleState& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(cpu_id_, other.cpu_id_)
    && ::protozero::internal::gen_helpers::EqualsField(cpuidle_state_entry_, other.cpuidle_state_entry_);
}

int SysStats_CpuIdleState::cpuidle_state_entry_size() const { return static_cast<int>(cpuidle_state_entry_.size()); }
void SysStats_CpuIdleState::clear_cpuidle_state_entry() { cpuidle_state_entry_.clear(); }
SysStats_CpuIdleStateEntry* SysStats_CpuIdleState::add_cpuidle_state_entry() { cpuidle_state_entry_.emplace_back(); return &cpuidle_state_entry_.back(); }
bool SysStats_CpuIdleState::ParseFromArray(const void* raw, size_t size) {
  cpuidle_state_entry_.clear();
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      case 1 /* cpu_id */:
        field.get(&cpu_id_);
        break;
      case 2 /* cpuidle_state_entry */:
        cpuidle_state_entry_.emplace_back();
        cpuidle_state_entry_.back().ParseFromArray(field.data(), field.size());
        break;
      default:
        field.SerializeAndAppendTo(&unknown_fields_);
        break;
...
std::string SysStats_CpuIdleState::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> SysStats_CpuIdleState::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void SysStats_CpuIdleState::Serialize(::protozero::Message* msg) const {
  // Field 1: cpu_id
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, cpu_id_, msg);
  }

  // Field 2: cpuidle_state_entry
  for (auto& it : cpuidle_state_entry_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(2));
  }
...
SysStats_CpuIdleStateEntry::SysStats_CpuIdleStateEntry() = default;
SysStats_CpuIdleStateEntry::~SysStats_CpuIdleStateEntry() = default;
SysStats_CpuIdleStateEntry::SysStats_CpuIdleStateEntry(const SysStats_CpuIdleStateEntry&) = default;
SysStats_CpuIdleStateEntry& SysStats_CpuIdleStateEntry::operator=(const SysStats_CpuIdleStateEntry&) = default;
SysStats_CpuIdleStateEntry::SysStats_CpuIdleStateEntry(SysStats_CpuIdleStateEntry&&) noexcept = default;
SysStats_CpuIdleStateEntry& SysStats_CpuIdleStateEntry::operator=(SysStats_CpuIdleStateEntry&&) = default;

bool SysStats_CpuIdleStateEntry::operator==(const SysStats_CpuIdleStateEntry& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
...
bool SysStats_CpuIdleStateEntry::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string SysStats_CpuIdleStateEntry::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> SysStats_CpuIdleStateEntry::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void SysStats_CpuIdleStateEntry::Serialize(::protozero::Message* msg) const {
  // Field 1: state
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeString(1, state_, msg);
  }

  // Field 2: duration_us
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(2, duration_us_, msg);
  }
...
SysStats_ThermalZone::SysStats_ThermalZone() = default;
SysStats_ThermalZone::~SysStats_ThermalZone() = default;
SysStats_ThermalZone::SysStats_ThermalZone(const SysStats_ThermalZone&) = default;
SysStats_ThermalZone& SysStats_ThermalZone::operator=(const SysStats_ThermalZone&) = default;
SysStats_ThermalZone::SysStats_ThermalZone(SysStats_ThermalZone&&) noexcept = default;
SysStats_ThermalZone& SysStats_ThermalZone::operator=(SysStats_ThermalZone&&) = default;

bool SysStats_ThermalZone::operator==(const SysStats_ThermalZone& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
...
bool SysStats_ThermalZone::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string SysStats_ThermalZone::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> SysStats_ThermalZone::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void SysStats_ThermalZone::Serialize(::protozero::Message* msg) const {
  // Field 1: name
  if (_has_field_[1]) {
...
bool SysStats_CpuTimes::operator==(const SysStats_CpuTimes& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(steal_ns_, other.steal_ns_);
}
...
void SysStats_CpuTimes::Serialize(::protozero::Message* msg) const {
  ...
  // Field 9: steal_ns
  if (_has_field_[9]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(9, steal_ns_, msg);
  }
