...
class PERFETTO_EXPORT_COMPONENT DebugAnnotation_NestedValue : public ::protozero::CppMessageObj {
 public:
  ...
  const DebugAnnotation_NestedValue_NestedType& nested_type() const { return nested_type_; }
  void set_nested_type(const DebugAnnotation_NestedValue_NestedType& value) { nested_type_ = value; _has_field_.set(1); }
