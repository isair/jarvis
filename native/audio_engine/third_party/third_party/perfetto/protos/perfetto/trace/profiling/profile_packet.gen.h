...
class PERFETTO_EXPORT_COMPONENT ProfilePacket_ProcessHeapSamples : public ::protozero::CppMessageObj {
 public:
  ...
  const ProfilePacket_ProcessHeapSamples_ClientError& client_error() const { return client_error_; }
  void set_client_error(const ProfilePacket_ProcessHeapSamples_ClientError& value) { client_error_ = value; _has_field_.set(14); }
...
class PERFETTO_EXPORT_COMPONENT PerfSample : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto PROFILER_SKIP_NOT_IN_SCOPE = PerfSample_SampleSkipReason_PROFILER_SKIP_NOT_IN_SCOPE;
  static constexpr auto SampleSkipReason_MIN = PerfSample_SampleSkipReason_PROFILER_SKIP_UNKNOWN;
  static constexpr auto SampleSkipReason_MAX = PerfSample_SampleSkipReason_PROFILER_SKIP_NOT_IN_SCOPE;
  ...
  const Profiling_CpuMode& cpu_mode() const { return cpu_mode_; }
  void set_cpu_mode(const Profiling_CpuMode& value) { cpu_mode_ = value; _has_field_.set(5); }
  ...
  const std::vector<uint64_t>& follower_counts() const { return follower_counts_; }
  std::vector<uint64_t>* mutable_follower_counts() { return &follower_counts_; }
  int follower_counts_size() const { return static_cast<int>(follower_counts_.size()); }
  void clear_follower_counts() { follower_counts_.clear(); }
  void add_follower_counts(uint64_t value) { follower_counts_.emplace_back(value); }
  uint64_t* add_follower_counts() { follower_counts_.emplace_back(); return &follower_counts_.back(); }
  ...
  const Profiling_StackUnwindError& unwind_error() const { return unwind_error_; }
  void set_unwind_error(const Profiling_StackUnwindError& value) { unwind_error_ = value; _has_field_.set(16); }
  ...
  const PerfSample_SampleSkipReason& sample_skipped_reason() const { return sample_skipped_reason_; }
  void set_sample_skipped_reason(const PerfSample_SampleSkipReason& value) { sample_skipped_reason_ = value; _has_field_.set(18); }
 ...
 private:
  ...
  std::vector<uint64_t> follower_counts_;
...
class PERFETTO_EXPORT_COMPONENT PerfSample_ProducerEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const PerfSample_ProducerEvent_DataSourceStopReason& source_stop_reason() const { return source_stop_reason_; }
  void set_source_stop_reason(const PerfSample_ProducerEvent_DataSourceStopReason& value) { source_stop_reason_ = value; _has_field_.set(1); }
