...
class PERFETTO_EXPORT_COMPONENT InternedV8JsScript : public ::protozero::CppMessageObj {
 public:
  ...
  const InternedV8JsScript_Type& type() const { return type_; }
  void set_type(const InternedV8JsScript_Type& value) { type_ = value; _has_field_.set(3); }
...
class PERFETTO_EXPORT_COMPONENT InternedV8WasmScript : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_wire_bytes() const { return _has_field_[4]; }
  const std::string& wire_bytes() const { return wire_bytes_; }
  void set_wire_bytes(const std::string& value) { wire_bytes_ = value; _has_field_.set(4); }
  void set_wire_bytes(const void* p, size_t s) { wire_bytes_.assign(reinterpret_cast<const char*>(p), s); _has_field_.set(4); }
...
class PERFETTO_EXPORT_COMPONENT InternedV8JsFunction : public ::protozero::CppMessageObj {
 public:
  ...
  const InternedV8JsFunction_Kind& kind() const { return kind_; }
  void set_kind(const InternedV8JsFunction_Kind& value) { kind_ = value; _has_field_.set(5); }
  ...
  bool has_line() const { return _has_field_[7]; }
  uint32_t line() const { return line_; }
  void set_line(uint32_t value) { line_ = value; _has_field_.set(7); }

  bool has_column() const { return _has_field_[8]; }
  uint32_t column() const { return column_; }
  void set_column(uint32_t value) { column_ = value; _has_field_.set(8); }
...
class PERFETTO_EXPORT_COMPONENT V8JsCode : public ::protozero::CppMessageObj {
 public:
  ...
  const V8JsCode_Tier& tier() const { return tier_; }
  void set_tier(const V8JsCode_Tier& value) { tier_ = value; _has_field_.set(4); }
...
class PERFETTO_EXPORT_COMPONENT V8InternalCode : public ::protozero::CppMessageObj {
 public:
  ...
  const V8InternalCode_Type& type() const { return type_; }
  void set_type(const V8InternalCode_Type& value) { type_ = value; _has_field_.set(4); }
...
class PERFETTO_EXPORT_COMPONENT V8WasmCode : public ::protozero::CppMessageObj {
 public:
  ...
  const V8WasmCode_Tier& tier() const { return tier_; }
  void set_tier(const V8WasmCode_Tier& value) { tier_ = value; _has_field_.set(5); }
