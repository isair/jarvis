...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot : public ::protozero::CppMessageObj {
 public:
  ...
  const MemoryTrackerSnapshot_LevelOfDetail& level_of_detail() const { return level_of_detail_; }
  void set_level_of_detail(const MemoryTrackerSnapshot_LevelOfDetail& value) { level_of_detail_ = value; _has_field_.set(2); }
...
class PERFETTO_EXPORT_COMPONENT MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode_MemoryNodeEntry : public ::protozero::CppMessageObj {
 public:
  ...
  const MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode_MemoryNodeEntry_Units& units() const { return units_; }
  void set_units(const MemoryTrackerSnapshot_ProcessSnapshot_MemoryNode_MemoryNodeEntry_Units& value) { units_ = value; _has_field_.set(2); }
