...
class ActivityInfoProto : public ::protozero::Message {
 public:
  ...
  static constexpr ScreenOrientation SCREEN_ORIENTATION_UNSET = ScreenOrientation::SCREEN_ORIENTATION_UNSET;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_UNSPECIFIED = ScreenOrientation::SCREEN_ORIENTATION_UNSPECIFIED;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_LANDSCAPE = ScreenOrientation::SCREEN_ORIENTATION_LANDSCAPE;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_PORTRAIT = ScreenOrientation::SCREEN_ORIENTATION_PORTRAIT;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_USER = ScreenOrientation::SCREEN_ORIENTATION_USER;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_BEHIND = ScreenOrientation::SCREEN_ORIENTATION_BEHIND;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_SENSOR = ScreenOrientation::SCREEN_ORIENTATION_SENSOR;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_NOSENSOR = ScreenOrientation::SCREEN_ORIENTATION_NOSENSOR;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_SENSOR_LANDSCAPE = ScreenOrientation::SCREEN_ORIENTATION_SENSOR_LANDSCAPE;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_SENSOR_PORTRAIT = ScreenOrientation::SCREEN_ORIENTATION_SENSOR_PORTRAIT;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_REVERSE_LANDSCAPE = ScreenOrientation::SCREEN_ORIENTATION_REVERSE_LANDSCAPE;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_REVERSE_PORTRAIT = ScreenOrientation::SCREEN_ORIENTATION_REVERSE_PORTRAIT;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_FULL_SENSOR = ScreenOrientation::SCREEN_ORIENTATION_FULL_SENSOR;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_USER_LANDSCAPE = ScreenOrientation::SCREEN_ORIENTATION_USER_LANDSCAPE;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_USER_PORTRAIT = ScreenOrientation::SCREEN_ORIENTATION_USER_PORTRAIT;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_FULL_USER = ScreenOrientation::SCREEN_ORIENTATION_FULL_USER;
  static constexpr ScreenOrientation SCREEN_ORIENTATION_LOCKED = ScreenOrientation::SCREEN_ORIENTATION_LOCKED;
};
