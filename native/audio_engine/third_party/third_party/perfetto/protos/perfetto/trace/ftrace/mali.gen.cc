...
MaliGpuPowerStateFtraceEvent::MaliGpuPowerStateFtraceEvent() = default;
MaliGpuPowerStateFtraceEvent::~MaliGpuPowerStateFtraceEvent() = default;
MaliGpuPowerStateFtraceEvent::MaliGpuPowerStateFtraceEvent(const MaliGpuPowerStateFtraceEvent&) = default;
MaliGpuPowerStateFtraceEvent& MaliGpuPowerStateFtraceEvent::operator=(const MaliGpuPowerStateFtraceEvent&) = default;
MaliGpuPowerStateFtraceEvent::MaliGpuPowerStateFtraceEvent(MaliGpuPowerStateFtraceEvent&&) noexcept = default;
MaliGpuPowerStateFtraceEvent& MaliGpuPowerStateFtraceEvent::operator=(MaliGpuPowerStateFtraceEvent&&) = default;

bool MaliGpuPowerStateFtraceEvent::operator==(const MaliGpuPowerStateFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(change_ns_, other.change_ns_)
    && ::protozero::internal::gen_helpers::EqualsField(from_state_, other.from_state_)
    && ::protozero::internal::gen_helpers::EqualsField(to_state_, other.to_state_);
}

bool MaliGpuPowerStateFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      case 1 /* change_ns */:
        field.get(&change_ns_);
        break;
      case 2 /* from_state */:
        field.get(&from_state_);
        break;
      case 3 /* to_state */:
        field.get(&to_state_);
        break;
...
std::string MaliGpuPowerStateFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> MaliGpuPowerStateFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void MaliGpuPowerStateFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: change_ns
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, change_ns_, msg);
  }

  // Field 2: from_state
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(2, from_state_, msg);
  }

  // Field 3: to_state
  if (_has_field_[3]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(3, to_state_, msg);
  }
