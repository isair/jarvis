...
class FrameTimelineEvent : public ::protozero::Message {
 public:
  ...
  static constexpr JankType JANK_UNSPECIFIED = JankType::JANK_UNSPECIFIED;
  static constexpr JankType JANK_NONE = JankType::JANK_NONE;
  static constexpr JankType JANK_SF_SCHEDULING = JankType::JANK_SF_SCHEDULING;
  static constexpr JankType JANK_PREDICTION_ERROR = JankType::JANK_PREDICTION_ERROR;
  static constexpr JankType JANK_DISPLAY_HAL = JankType::JANK_DISPLAY_HAL;
  static constexpr JankType JANK_SF_CPU_DEADLINE_MISSED = JankType::JANK_SF_CPU_DEADLINE_MISSED;
  static constexpr JankType JANK_SF_GPU_DEADLINE_MISSED = JankType::JANK_SF_GPU_DEADLINE_MISSED;
  static constexpr JankType JANK_APP_DEADLINE_MISSED = JankType::JANK_APP_DEADLINE_MISSED;
  static constexpr JankType JANK_BUFFER_STUFFING = JankType::JANK_BUFFER_STUFFING;
  static constexpr JankType JANK_UNKNOWN = JankType::JANK_UNKNOWN;
  static constexpr JankType JANK_SF_STUFFING = JankType::JANK_SF_STUFFING;
  static constexpr JankType JANK_DROPPED = JankType::JANK_DROPPED;
  static constexpr JankSeverityType SEVERITY_UNKNOWN = JankSeverityType::SEVERITY_UNKNOWN;
  static constexpr JankSeverityType SEVERITY_NONE = JankSeverityType::SEVERITY_NONE;
  static constexpr JankSeverityType SEVERITY_PARTIAL = JankSeverityType::SEVERITY_PARTIAL;
  static constexpr JankSeverityType SEVERITY_FULL = JankSeverityType::SEVERITY_FULL;
  static constexpr PresentType PRESENT_UNSPECIFIED = PresentType::PRESENT_UNSPECIFIED;
  static constexpr PresentType PRESENT_ON_TIME = PresentType::PRESENT_ON_TIME;
  static constexpr PresentType PRESENT_LATE = PresentType::PRESENT_LATE;
  static constexpr PresentType PRESENT_EARLY = PresentType::PRESENT_EARLY;
  static constexpr PresentType PRESENT_DROPPED = PresentType::PRESENT_DROPPED;
  static constexpr PresentType PRESENT_UNKNOWN = PresentType::PRESENT_UNKNOWN;
  static constexpr PredictionType PREDICTION_UNSPECIFIED = PredictionType::PREDICTION_UNSPECIFIED;
  static constexpr PredictionType PREDICTION_VALID = PredictionType::PREDICTION_VALID;
  static constexpr PredictionType PREDICTION_EXPIRED = PredictionType::PREDICTION_EXPIRED;
  static constexpr PredictionType PREDICTION_UNKNOWN = PredictionType::PREDICTION_UNKNOWN;
