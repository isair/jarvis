...
class KernelWakelockData_Wakelock : public ::protozero::Message {
 public:
  ...
  static constexpr Type WAKELOCK_TYPE_UNKNOWN = Type::WAKELOCK_TYPE_UNKNOWN;
  static constexpr Type WAKELOCK_TYPE_KERNEL = Type::WAKELOCK_TYPE_KERNEL;
  static constexpr Type WAKELOCK_TYPE_NATIVE = Type::WAKELOCK_TYPE_NATIVE;
