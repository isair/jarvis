...
class PERFETTO_EXPORT_COMPONENT TracingServiceEvent : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_clone_started() const { return _has_field_[10]; }
  bool clone_started() const { return clone_started_; }
  void set_clone_started(bool value) { clone_started_ = value; _has_field_.set(10); }

  bool has_buffer_cloned() const { return _has_field_[11]; }
  uint32_t buffer_cloned() const { return buffer_cloned_; }
  void set_buffer_cloned(uint32_t value) { buffer_cloned_ = value; _has_field_.set(11); }
