...
class PERFETTO_EXPORT_COMPONENT AndroidCameraFrameEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const AndroidCameraFrameEvent_CaptureResultStatus& capture_result_status() const { return capture_result_status_; }
  void set_capture_result_status(const AndroidCameraFrameEvent_CaptureResultStatus& value) { capture_result_status_ = value; _has_field_.set(10); }
