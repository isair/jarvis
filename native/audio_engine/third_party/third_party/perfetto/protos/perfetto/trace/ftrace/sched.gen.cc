...
SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent() = default;
SchedWakeupTaskAttrFtraceEvent::~SchedWakeupTaskAttrFtraceEvent() = default;
SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent(const SchedWakeupTaskAttrFtraceEvent&) = default;
SchedWakeupTaskAttrFtraceEvent& SchedWakeupTaskAttrFtraceEvent::operator=(const SchedWakeupTaskAttrFtraceEvent&) = default;
SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent(SchedWakeupTaskAttrFtraceEvent&&) noexcept = default;
SchedWakeupTaskAttrFtraceEvent& SchedWakeupTaskAttrFtraceEvent::operator=(SchedWakeupTaskAttrFtraceEvent&&) = default;

bool SchedWakeupTaskAttrFtraceEvent::operator==(const SchedWakeupTaskAttrFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(pid_, other.pid_)
    && ::protozero::internal::gen_helpers::EqualsField(cpu_affinity_, other.cpu_affinity_)
    && ::protozero::internal::gen_helpers::EqualsField(task_util_, other.task_util_)
    && ::protozero::internal::gen_helpers::EqualsField(uclamp_min_, other.uclamp_min_)
    && ::protozero::internal::gen_helpers::EqualsField(vruntime_, other.vruntime_);
}

bool SchedWakeupTaskAttrFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      case 1 /* pid */:
        ...
        break;
      case 2 /* cpu_affinity */:
        field.get(&cpu_affinity_);
        break;
      case 3 /* task_util */:
        field.get(&task_util_);
        break;
      case 4 /* uclamp_min */:
        field.get(&uclamp_min_);
        break;
      case 5 /* vruntime */:
        field.get(&vruntime_);
        break;
...
std::string SchedWakeupTaskAttrFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> SchedWakeupTaskAttrFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void SchedWakeupTaskAttrFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: pid
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, pid_, msg);
  }

  // Field 2: cpu_affinity
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(2, cpu_affinity_, msg);
  }

  // Field 3: task_util
  if (_has_field_[3]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(3, task_util_, msg);
  }

  // Field 4: uclamp_min
  if (_has_field_[4]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(4, uclamp_min_, msg);
  }

  // Field 5: vruntime
  if (_has_field_[5]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(5, vruntime_, msg);
  }
