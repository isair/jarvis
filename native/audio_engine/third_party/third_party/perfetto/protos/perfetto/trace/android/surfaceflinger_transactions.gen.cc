...
bool TransactionState::operator==(const TransactionState& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(apply_token_, other.apply_token_);
}
...
void TransactionState::Serialize(::protozero::Message* msg) const {
  ...
  // Field 10: apply_token
  if (_has_field_[10]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(10, apply_token_, msg);
  }
...
bool LayerState::operator==(const LayerState& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(background_blur_scale_, other.background_blur_scale_);
}
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 43 /* trusted_overlay */:
        ...
        break;
      case 44 /* background_blur_scale */:
        field.get(&background_blur_scale_);
        break;
      default:
        field.SerializeAndAppendTo(&unknown_fields_);
        break;
...
void LayerState::Serialize(::protozero::Message* msg) const {
  ...
  // Field 44: background_blur_scale
  if (_has_field_[44]) {
    ::protozero::internal::gen_helpers::SerializeFixed(44, background_blur_scale_, msg);
  }
