...
class PERFETTO_EXPORT_COMPONENT ChromeThreadDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeThreadDescriptor_ThreadType& thread_type() const { return thread_type_; }
  void set_thread_type(const ChromeThreadDescriptor_ThreadType& value) { thread_type_ = value; _has_field_.set(1); }
