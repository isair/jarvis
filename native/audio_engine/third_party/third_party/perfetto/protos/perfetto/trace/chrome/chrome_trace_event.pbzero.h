...
class ChromeTracedValue : public ::protozero::Message {
 public:
  ...
  static constexpr NestedType DICT = NestedType::DICT;
  static constexpr NestedType ARRAY = NestedType::ARRAY;
...
class ChromeLegacyJsonTrace : public ::protozero::Message {
 public:
  ...
  static constexpr TraceType USER_TRACE = TraceType::USER_TRACE;
  static constexpr TraceType SYSTEM_TRACE = TraceType::SYSTEM_TRACE;
