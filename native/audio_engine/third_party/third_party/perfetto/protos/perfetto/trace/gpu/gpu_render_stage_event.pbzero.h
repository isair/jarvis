...
class InternedGraphicsContext : public ::protozero::Message {
 public:
  ...
  static constexpr Api UNDEFINED = Api::UNDEFINED;
  static constexpr Api OPEN_GL = Api::OPEN_GL;
  static constexpr Api VULKAN = Api::VULKAN;
  static constexpr Api OPEN_CL = Api::OPEN_CL;
...
class InternedGpuRenderStageSpecification : public ::protozero::Message {
 public:
  ...
  static constexpr RenderStageCategory OTHER = RenderStageCategory::OTHER;
  static constexpr RenderStageCategory GRAPHICS = RenderStageCategory::GRAPHICS;
  static constexpr RenderStageCategory COMPUTE = RenderStageCategory::COMPUTE;
