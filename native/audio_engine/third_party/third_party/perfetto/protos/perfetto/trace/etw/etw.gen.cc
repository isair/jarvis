...
bool CSwitchEtwEvent::operator==(const CSwitchEtwEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(old_thread_wait_reason_int_, other.old_thread_wait_reason_int_)
    && ::protozero::internal::gen_helpers::EqualsField(old_thread_wait_mode_, other.old_thread_wait_mode_)
    && ::protozero::internal::gen_helpers::EqualsField(old_thread_wait_mode_int_, other.old_thread_wait_mode_int_)
    && ::protozero::internal::gen_helpers::EqualsField(old_thread_state_, other.old_thread_state_)
    && ::protozero::internal::gen_helpers::EqualsField(old_thread_state_int_, other.old_thread_state_int_)
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 6 /* old_thread_wait_reason */:
        ...
        break;
      case 11 /* old_thread_wait_reason_int */:
        field.get(&old_thread_wait_reason_int_);
        break;
      case 7 /* old_thread_wait_mode */:
        field.get(&old_thread_wait_mode_);
        break;
      case 12 /* old_thread_wait_mode_int */:
        field.get(&old_thread_wait_mode_int_);
        break;
      case 8 /* old_thread_state */:
        field.get(&old_thread_state_);
        break;
      case 13 /* old_thread_state_int */:
        field.get_signed(&old_thread_state_int_);
        break;
...
void CSwitchEtwEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 11: old_thread_wait_reason_int
  if (_has_field_[11]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(11, old_thread_wait_reason_int_, msg);
  }
  ...
  // Field 12: old_thread_wait_mode_int
  if (_has_field_[12]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(12, old_thread_wait_mode_int_, msg);
  }
  ...
  // Field 13: old_thread_state_int
  if (_has_field_[13]) {
    ::protozero::internal::gen_helpers::SerializeSignedVarInt(13, old_thread_state_int_, msg);
  }
...
bool ReadyThreadEtwEvent::operator==(const ReadyThreadEtwEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(adjust_reason_int_, other.adjust_reason_int_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(flag_int_, other.flag_int_);
}
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 2 /* adjust_reason */:
        ...
        break;
      case 5 /* adjust_reason_int */:
        field.get(&adjust_reason_int_);
        break;
...
void ReadyThreadEtwEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 5: adjust_reason_int
  if (_has_field_[5]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(5, adjust_reason_int_, msg);
  }
  ...
  // Field 6: flag_int
  if (_has_field_[6]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(6, flag_int_, msg);
  }
