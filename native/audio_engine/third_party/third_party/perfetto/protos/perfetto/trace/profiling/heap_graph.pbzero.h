...
class HeapGraphRoot : public ::protozero::Message {
 public:
  ...
  static constexpr Type ROOT_UNKNOWN = Type::ROOT_UNKNOWN;
  static constexpr Type ROOT_JNI_GLOBAL = Type::ROOT_JNI_GLOBAL;
  static constexpr Type ROOT_JNI_LOCAL = Type::ROOT_JNI_LOCAL;
  static constexpr Type ROOT_JAVA_FRAME = Type::ROOT_JAVA_FRAME;
  static constexpr Type ROOT_NATIVE_STACK = Type::ROOT_NATIVE_STACK;
  static constexpr Type ROOT_STICKY_CLASS = Type::ROOT_STICKY_CLASS;
  static constexpr Type ROOT_THREAD_BLOCK = Type::ROOT_THREAD_BLOCK;
  static constexpr Type ROOT_MONITOR_USED = Type::ROOT_MONITOR_USED;
  static constexpr Type ROOT_THREAD_OBJECT = Type::ROOT_THREAD_OBJECT;
  static constexpr Type ROOT_INTERNED_STRING = Type::ROOT_INTERNED_STRING;
  static constexpr Type ROOT_FINALIZING = Type::ROOT_FINALIZING;
  static constexpr Type ROOT_DEBUGGER = Type::ROOT_DEBUGGER;
  static constexpr Type ROOT_REFERENCE_CLEANUP = Type::ROOT_REFERENCE_CLEANUP;
  static constexpr Type ROOT_VM_INTERNAL = Type::ROOT_VM_INTERNAL;
  static constexpr Type ROOT_JNI_MONITOR = Type::ROOT_JNI_MONITOR;
...
class HeapGraphType : public ::protozero::Message {
 public:
  ...
  static constexpr Kind KIND_NORMAL = Kind::KIND_NORMAL;
  static constexpr Kind KIND_NOREFERENCES = Kind::KIND_NOREFERENCES;
  static constexpr Kind KIND_STRING = Kind::KIND_STRING;
  static constexpr Kind KIND_ARRAY = Kind::KIND_ARRAY;
  static constexpr Kind KIND_CLASS = Kind::KIND_CLASS;
  static constexpr Kind KIND_CLASSLOADER = Kind::KIND_CLASSLOADER;
  static constexpr Kind KIND_DEXCACHE = Kind::KIND_DEXCACHE;
  static constexpr Kind KIND_SOFT_REFERENCE = Kind::KIND_SOFT_REFERENCE;
  static constexpr Kind KIND_WEAK_REFERENCE = Kind::KIND_WEAK_REFERENCE;
  static constexpr Kind KIND_FINALIZER_REFERENCE = Kind::KIND_FINALIZER_REFERENCE;
  static constexpr Kind KIND_PHANTOM_REFERENCE = Kind::KIND_PHANTOM_REFERENCE;
...
class HeapGraphObject : public ::protozero::Message {
 public:
  ...
  static constexpr HeapType HEAP_TYPE_UNKNOWN = HeapType::HEAP_TYPE_UNKNOWN;
  static constexpr HeapType HEAP_TYPE_APP = HeapType::HEAP_TYPE_APP;
  static constexpr HeapType HEAP_TYPE_ZYGOTE = HeapType::HEAP_TYPE_ZYGOTE;
  static constexpr HeapType HEAP_TYPE_BOOT_IMAGE = HeapType::HEAP_TYPE_BOOT_IMAGE;
