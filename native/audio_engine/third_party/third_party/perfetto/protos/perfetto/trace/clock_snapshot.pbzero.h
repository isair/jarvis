...
class ClockSnapshot_Clock : public ::protozero::Message {
 public:
  ...
  static constexpr BuiltinClocks UNKNOWN = BuiltinClocks::UNKNOWN;
  static constexpr BuiltinClocks REALTIME = BuiltinClocks::REALTIME;
  static constexpr BuiltinClocks REALTIME_COARSE = BuiltinClocks::REALTIME_COARSE;
  static constexpr BuiltinClocks MONOTONIC = BuiltinClocks::MONOTONIC;
  static constexpr BuiltinClocks MONOTONIC_COARSE = BuiltinClocks::MONOTONIC_COARSE;
  static constexpr BuiltinClocks MONOTONIC_RAW = BuiltinClocks::MONOTONIC_RAW;
  static constexpr BuiltinClocks BOOTTIME = BuiltinClocks::BOOTTIME;
  static constexpr BuiltinClocks BUILTIN_CLOCK_MAX_ID = BuiltinClocks::BUILTIN_CLOCK_MAX_ID;
