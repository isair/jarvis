...
class PERFETTO_EXPORT_COMPONENT FtraceEvent : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_kgsl_adreno_cmdbatch_queued() const { return _has_field_[534]; }
  const KgslAdrenoCmdbatchQueuedFtraceEvent& kgsl_adreno_cmdbatch_queued() const { return *kgsl_adreno_cmdbatch_queued_; }
  KgslAdrenoCmdbatchQueuedFtraceEvent* mutable_kgsl_adreno_cmdbatch_queued() { _has_field_.set(534); return kgsl_adreno_cmdbatch_queued_.get(); }

  bool has_kgsl_adreno_cmdbatch_submitted() const { return _has_field_[535]; }
  const KgslAdrenoCmdbatchSubmittedFtraceEvent& kgsl_adreno_cmdbatch_submitted() const { return *kgsl_adreno_cmdbatch_submitted_; }
  KgslAdrenoCmdbatchSubmittedFtraceEvent* mutable_kgsl_adreno_cmdbatch_submitted() { _has_field_.set(535); return kgsl_adreno_cmdbatch_submitted_.get(); }

  bool has_kgsl_adreno_cmdbatch_sync() const { return _has_field_[536]; }
  const KgslAdrenoCmdbatchSyncFtraceEvent& kgsl_adreno_cmdbatch_sync() const { return *kgsl_adreno_cmdbatch_sync_; }
  KgslAdrenoCmdbatchSyncFtraceEvent* mutable_kgsl_adreno_cmdbatch_sync() { _has_field_.set(536); return kgsl_adreno_cmdbatch_sync_.get(); }

  bool has_kgsl_adreno_cmdbatch_retired() const { return _has_field_[537]; }
  const KgslAdrenoCmdbatchRetiredFtraceEvent& kgsl_adreno_cmdbatch_retired() const { return *kgsl_adreno_cmdbatch_retired_; }
  KgslAdrenoCmdbatchRetiredFtraceEvent* mutable_kgsl_adreno_cmdbatch_retired() { _has_field_.set(537); return kgsl_adreno_cmdbatch_retired_.get(); }

  bool has_pixel_mm_kswapd_wake() const { return _has_field_[538]; }
  const PixelMmKswapdWakeFtraceEvent& pixel_mm_kswapd_wake() const { return *pixel_mm_kswapd_wake_; }
  PixelMmKswapdWakeFtraceEvent* mutable_pixel_mm_kswapd_wake() { _has_field_.set(538); return pixel_mm_kswapd_wake_.get(); }

  bool has_pixel_mm_kswapd_done() const { return _has_field_[539]; }
  const PixelMmKswapdDoneFtraceEvent& pixel_mm_kswapd_done() const { return *pixel_mm_kswapd_done_; }
  PixelMmKswapdDoneFtraceEvent* mutable_pixel_mm_kswapd_done() { _has_field_.set(539); return pixel_mm_kswapd_done_.get(); }

  bool has_sched_wakeup_task_attr() const { return _has_field_[540]; }
  const SchedWakeupTaskAttrFtraceEvent& sched_wakeup_task_attr() const { return *sched_wakeup_task_attr_; }
  SchedWakeupTaskAttrFtraceEvent* mutable_sched_wakeup_task_attr() { _has_field_.set(540); return sched_wakeup_task_attr_.get(); }

  bool has_devfreq_frequency() const { return _has_field_[541]; }
  const DevfreqFrequencyFtraceEvent& devfreq_frequency() const { return *devfreq_frequency_; }
  DevfreqFrequencyFtraceEvent* mutable_devfreq_frequency() { _has_field_.set(541); return devfreq_frequency_.get(); }

  bool has_kprobe_event() const { return _has_field_[542]; }
  const KprobeEvent& kprobe_event() const { return *kprobe_event_; }
  KprobeEvent* mutable_kprobe_event() { _has_field_.set(542); return kprobe_event_.get(); }

  bool has_param_set_value_cpm() const { return _has_field_[543]; }
  const ParamSetValueCpmFtraceEvent& param_set_value_cpm() const { return *param_set_value_cpm_; }
  ParamSetValueCpmFtraceEvent* mutable_param_set_value_cpm() { _has_field_.set(543); return param_set_value_cpm_.get(); }

  bool has_do_sys_open() const { return _has_field_[544]; }
  const DoSysOpenFtraceEvent& do_sys_open() const { return *do_sys_open_; }
  DoSysOpenFtraceEvent* mutable_do_sys_open() { _has_field_.set(544); return do_sys_open_.get(); }

  bool has_open_exec() const { return _has_field_[545]; }
  const OpenExecFtraceEvent& open_exec() const { return *open_exec_; }
  OpenExecFtraceEvent* mutable_open_exec() { _has_field_.set(545); return open_exec_.get(); }

  bool has_block_io_start() const { return _has_field_[546]; }
  const BlockIoStartFtraceEvent& block_io_start() const { return *block_io_start_; }
  BlockIoStartFtraceEvent* mutable_block_io_start() { _has_field_.set(546); return block_io_start_.get(); }

  bool has_block_io_done() const { return _has_field_[547]; }
  const BlockIoDoneFtraceEvent& block_io_done() const { return *block_io_done_; }
  BlockIoDoneFtraceEvent* mutable_block_io_done() { _has_field_.set(547); return block_io_done_.get(); }

  bool has_mali_gpu_power_state() const { return _has_field_[548]; }
  const MaliGpuPowerStateFtraceEvent& mali_gpu_power_state() const { return *mali_gpu_power_state_; }
  MaliGpuPowerStateFtraceEvent* mutable_mali_gpu_power_state() { _has_field_.set(548); return mali_gpu_power_state_.get(); }

  bool has_dpu_disp_dpu_underrun() const { return _has_field_[549]; }
  const DpuDispDpuUnderrunFtraceEvent& dpu_disp_dpu_underrun() const { return *dpu_disp_dpu_underrun_; }
  DpuDispDpuUnderrunFtraceEvent* mutable_dpu_disp_dpu_underrun() { _has_field_.set(549); return dpu_disp_dpu_underrun_.get(); }

  bool has_dpu_disp_vblank_irq_enable() const { return _has_field_[550]; }
  const DpuDispVblankIrqEnableFtraceEvent& dpu_disp_vblank_irq_enable() const { return *dpu_disp_vblank_irq_enable_; }
  DpuDispVblankIrqEnableFtraceEvent* mutable_dpu_disp_vblank_irq_enable() { _has_field_.set(550); return dpu_disp_vblank_irq_enable_.get(); }

  bool has_hrtimer_start() const { return _has_field_[551]; }
  const HrtimerStartFtraceEvent& hrtimer_start() const { return *hrtimer_start_; }
  HrtimerStartFtraceEvent* mutable_hrtimer_start() { _has_field_.set(551); return hrtimer_start_.get(); }

  bool has_hrtimer_cancel() const { return _has_field_[552]; }
  const HrtimerCancelFtraceEvent& hrtimer_cancel() const { return *hrtimer_cancel_; }
  HrtimerCancelFtraceEvent* mutable_hrtimer_cancel() { _has_field_.set(552); return hrtimer_cancel_.get(); }

  bool has_hrtimer_expire_entry() const { return _has_field_[553]; }
  const HrtimerExpireEntryFtraceEvent& hrtimer_expire_entry() const { return *hrtimer_expire_entry_; }
  HrtimerExpireEntryFtraceEvent* mutable_hrtimer_expire_entry() { _has_field_.set(553); return hrtimer_expire_entry_.get(); }

  bool has_hrtimer_expire_exit() const { return _has_field_[554]; }
  const HrtimerExpireExitFtraceEvent& hrtimer_expire_exit() const { return *hrtimer_expire_exit_; }
  HrtimerExpireExitFtraceEvent* mutable_hrtimer_expire_exit() { _has_field_.set(554); return hrtimer_expire_exit_.get(); }

  bool has_timer_start() const { return _has_field_[555]; }
  const TimerStartFtraceEvent& timer_start() const { return *timer_start_; }
  TimerStartFtraceEvent* mutable_timer_start() { _has_field_.set(555); return timer_start_.get(); }

  bool has_timer_cancel() const { return _has_field_[556]; }
  const TimerCancelFtraceEvent& timer_cancel() const { return *timer_cancel_; }
  TimerCancelFtraceEvent* mutable_timer_cancel() { _has_field_.set(556); return timer_cancel_.get(); }

  bool has_timer_expire_entry() const { return _has_field_[557]; }
  const TimerExpireEntryFtraceEvent& timer_expire_entry() const { return *timer_expire_entry_; }
  TimerExpireEntryFtraceEvent* mutable_timer_expire_entry() { _has_field_.set(557); return timer_expire_entry_.get(); }

  bool has_timer_expire_exit() const { return _has_field_[558]; }
  const TimerExpireExitFtraceEvent& timer_expire_exit() const { return *timer_expire_exit_; }
  TimerExpireExitFtraceEvent* mutable_timer_expire_exit() { _has_field_.set(558); return timer_expire_exit_.get(); }

  bool has_local_timer_entry() const { return _has_field_[559]; }
  const LocalTimerEntryFtraceEvent& local_timer_entry() const { return *local_timer_entry_; }
  LocalTimerEntryFtraceEvent* mutable_local_timer_entry() { _has_field_.set(559); return local_timer_entry_.get(); }

  bool has_local_timer_exit() const { return _has_field_[560]; }
  const LocalTimerExitFtraceEvent& local_timer_exit() const { return *local_timer_exit_; }
  LocalTimerExitFtraceEvent* mutable_local_timer_exit() { _has_field_.set(560); return local_timer_exit_.get(); }

  bool has_dwc3_alloc_request() const { return _has_field_[561]; }
  const Dwc3AllocRequestFtraceEvent& dwc3_alloc_request() const { return *dwc3_alloc_request_; }
  Dwc3AllocRequestFtraceEvent* mutable_dwc3_alloc_request() { _has_field_.set(561); return dwc3_alloc_request_.get(); }

  bool has_dwc3_complete_trb() const { return _has_field_[562]; }
  const Dwc3CompleteTrbFtraceEvent& dwc3_complete_trb() const { return *dwc3_complete_trb_; }
  Dwc3CompleteTrbFtraceEvent* mutable_dwc3_complete_trb() { _has_field_.set(562); return dwc3_complete_trb_.get(); }

  bool has_dwc3_ctrl_req() const { return _has_field_[563]; }
  const Dwc3CtrlReqFtraceEvent& dwc3_ctrl_req() const { return *dwc3_ctrl_req_; }
  Dwc3CtrlReqFtraceEvent* mutable_dwc3_ctrl_req() { _has_field_.set(563); return dwc3_ctrl_req_.get(); }

  bool has_dwc3_ep_dequeue() const { return _has_field_[564]; }
  const Dwc3EpDequeueFtraceEvent& dwc3_ep_dequeue() const { return *dwc3_ep_dequeue_; }
  Dwc3EpDequeueFtraceEvent* mutable_dwc3_ep_dequeue() { _has_field_.set(564); return dwc3_ep_dequeue_.get(); }

  bool has_dwc3_ep_queue() const { return _has_field_[565]; }
  const Dwc3EpQueueFtraceEvent& dwc3_ep_queue() const { return *dwc3_ep_queue_; }
  Dwc3EpQueueFtraceEvent* mutable_dwc3_ep_queue() { _has_field_.set(565); return dwc3_ep_queue_.get(); }

  bool has_dwc3_event() const { return _has_field_[566]; }
  const Dwc3EventFtraceEvent& dwc3_event() const { return *dwc3_event_; }
  Dwc3EventFtraceEvent* mutable_dwc3_event() { _has_field_.set(566); return dwc3_event_.get(); }

  bool has_dwc3_free_request() const { return _has_field_[567]; }
  const Dwc3FreeRequestFtraceEvent& dwc3_free_request() const { return *dwc3_free_request_; }
  Dwc3FreeRequestFtraceEvent* mutable_dwc3_free_request() { _has_field_.set(567); return dwc3_free_request_.get(); }

  bool has_dwc3_gadget_ep_cmd() const { return _has_field_[568]; }
  const Dwc3GadgetEpCmdFtraceEvent& dwc3_gadget_ep_cmd() const { return *dwc3_gadget_ep_cmd_; }
  Dwc3GadgetEpCmdFtraceEvent* mutable_dwc3_gadget_ep_cmd() { _has_field_.set(568); return dwc3_gadget_ep_cmd_.get(); }

  bool has_dwc3_gadget_ep_disable() const { return _has_field_[569]; }
  const Dwc3GadgetEpDisableFtraceEvent& dwc3_gadget_ep_disable() const { return *dwc3_gadget_ep_disable_; }
  Dwc3GadgetEpDisableFtraceEvent* mutable_dwc3_gadget_ep_disable() { _has_field_.set(569); return dwc3_gadget_ep_disable_.get(); }

  bool has_dwc3_gadget_ep_enable() const { return _has_field_[570]; }
  const Dwc3GadgetEpEnableFtraceEvent& dwc3_gadget_ep_enable() const { return *dwc3_gadget_ep_enable_; }
  Dwc3GadgetEpEnableFtraceEvent* mutable_dwc3_gadget_ep_enable() { _has_field_.set(570); return dwc3_gadget_ep_enable_.get(); }

  bool has_dwc3_gadget_generic_cmd() const { return _has_field_[571]; }
  const Dwc3GadgetGenericCmdFtraceEvent& dwc3_gadget_generic_cmd() const { return *dwc3_gadget_generic_cmd_; }
  Dwc3GadgetGenericCmdFtraceEvent* mutable_dwc3_gadget_generic_cmd() { _has_field_.set(571); return dwc3_gadget_generic_cmd_.get(); }

  bool has_dwc3_gadget_giveback() const { return _has_field_[572]; }
  const Dwc3GadgetGivebackFtraceEvent& dwc3_gadget_giveback() const { return *dwc3_gadget_giveback_; }
  Dwc3GadgetGivebackFtraceEvent* mutable_dwc3_gadget_giveback() { _has_field_.set(572); return dwc3_gadget_giveback_.get(); }

  bool has_dwc3_prepare_trb() const { return _has_field_[573]; }
  const Dwc3PrepareTrbFtraceEvent& dwc3_prepare_trb() const { return *dwc3_prepare_trb_; }
  Dwc3PrepareTrbFtraceEvent* mutable_dwc3_prepare_trb() { _has_field_.set(573); return dwc3_prepare_trb_.get(); }

  bool has_dwc3_readl() const { return _has_field_[574]; }
  const Dwc3ReadlFtraceEvent& dwc3_readl() const { return *dwc3_readl_; }
  Dwc3ReadlFtraceEvent* mutable_dwc3_readl() { _has_field_.set(574); return dwc3_readl_.get(); }

  bool has_dwc3_writel() const { return _has_field_[575]; }
  const Dwc3WritelFtraceEvent& dwc3_writel() const { return *dwc3_writel_; }
  Dwc3WritelFtraceEvent* mutable_dwc3_writel() { _has_field_.set(575); return dwc3_writel_.get(); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<KgslAdrenoCmdbatchQueuedFtraceEvent> kgsl_adreno_cmdbatch_queued_;
  ::protozero::CopyablePtr<KgslAdrenoCmdbatchSubmittedFtraceEvent> kgsl_adreno_cmdbatch_submitted_;
  ::protozero::CopyablePtr<KgslAdrenoCmdbatchSyncFtraceEvent> kgsl_adreno_cmdbatch_sync_;
  ::protozero::CopyablePtr<KgslAdrenoCmdbatchRetiredFtraceEvent> kgsl_adreno_cmdbatch_retired_;
  ::protozero::CopyablePtr<PixelMmKswapdWakeFtraceEvent> pixel_mm_kswapd_wake_;
  ::protozero::CopyablePtr<PixelMmKswapdDoneFtraceEvent> pixel_mm_kswapd_done_;
  ::protozero::CopyablePtr<SchedWakeupTaskAttrFtraceEvent> sched_wakeup_task_attr_;
  ::protozero::CopyablePtr<DevfreqFrequencyFtraceEvent> devfreq_frequency_;
  ::protozero::CopyablePtr<KprobeEvent> kprobe_event_;
  ::protozero::CopyablePtr<ParamSetValueCpmFtraceEvent> param_set_value_cpm_;
  ::protozero::CopyablePtr<DoSysOpenFtraceEvent> do_sys_open_;
  ::protozero::CopyablePtr<OpenExecFtraceEvent> open_exec_;
  ::protozero::CopyablePtr<BlockIoStartFtraceEvent> block_io_start_;
  ::protozero::CopyablePtr<BlockIoDoneFtraceEvent> block_io_done_;
  ::protozero::CopyablePtr<MaliGpuPowerStateFtraceEvent> mali_gpu_power_state_;
  ::protozero::CopyablePtr<DpuDispDpuUnderrunFtraceEvent> dpu_disp_dpu_underrun_;
  ::protozero::CopyablePtr<DpuDispVblankIrqEnableFtraceEvent> dpu_disp_vblank_irq_enable_;
  ::protozero::CopyablePtr<HrtimerStartFtraceEvent> hrtimer_start_;
  ::protozero::CopyablePtr<HrtimerCancelFtraceEvent> hrtimer_cancel_;
  ::protozero::CopyablePtr<HrtimerExpireEntryFtraceEvent> hrtimer_expire_entry_;
  ::protozero::CopyablePtr<HrtimerExpireExitFtraceEvent> hrtimer_expire_exit_;
  ::protozero::CopyablePtr<TimerStartFtraceEvent> timer_start_;
  ::protozero::CopyablePtr<TimerCancelFtraceEvent> timer_cancel_;
  ::protozero::CopyablePtr<TimerExpireEntryFtraceEvent> timer_expire_entry_;
  ::protozero::CopyablePtr<TimerExpireExitFtraceEvent> timer_expire_exit_;
  ::protozero::CopyablePtr<LocalTimerEntryFtraceEvent> local_timer_entry_;
  ::protozero::CopyablePtr<LocalTimerExitFtraceEvent> local_timer_exit_;
  ::protozero::CopyablePtr<Dwc3AllocRequestFtraceEvent> dwc3_alloc_request_;
  ::protozero::CopyablePtr<Dwc3CompleteTrbFtraceEvent> dwc3_complete_trb_;
  ::protozero::CopyablePtr<Dwc3CtrlReqFtraceEvent> dwc3_ctrl_req_;
  ::protozero::CopyablePtr<Dwc3EpDequeueFtraceEvent> dwc3_ep_dequeue_;
  ::protozero::CopyablePtr<Dwc3EpQueueFtraceEvent> dwc3_ep_queue_;
  ::protozero::CopyablePtr<Dwc3EventFtraceEvent> dwc3_event_;
  ::protozero::CopyablePtr<Dwc3FreeRequestFtraceEvent> dwc3_free_request_;
  ::protozero::CopyablePtr<Dwc3GadgetEpCmdFtraceEvent> dwc3_gadget_ep_cmd_;
  ::protozero::CopyablePtr<Dwc3GadgetEpDisableFtraceEvent> dwc3_gadget_ep_disable_;
  ::protozero::CopyablePtr<Dwc3GadgetEpEnableFtraceEvent> dwc3_gadget_ep_enable_;
  ::protozero::CopyablePtr<Dwc3GadgetGenericCmdFtraceEvent> dwc3_gadget_generic_cmd_;
  ::protozero::CopyablePtr<Dwc3GadgetGivebackFtraceEvent> dwc3_gadget_giveback_;
  ::protozero::CopyablePtr<Dwc3PrepareTrbFtraceEvent> dwc3_prepare_trb_;
  ::protozero::CopyablePtr<Dwc3ReadlFtraceEvent> dwc3_readl_;
  ::protozero::CopyablePtr<Dwc3WritelFtraceEvent> dwc3_writel_;

  // Allows to preserve unknown protobuf fields for compatibility
  // with future versions of .proto files.
  std::string unknown_fields_;

  std::bitset<576> _has_field_{};
};
