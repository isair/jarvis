...
class FtraceStats : public ::protozero::Message {
 public:
  ...
  static constexpr Phase UNSPECIFIED = Phase::UNSPECIFIED;
  static constexpr Phase START_OF_TRACE = Phase::START_OF_TRACE;
  static constexpr Phase END_OF_TRACE = Phase::END_OF_TRACE;
