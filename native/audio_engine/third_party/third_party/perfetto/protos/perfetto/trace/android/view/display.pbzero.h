...
class ViewDisplayProto : public ::protozero::Message {
 public:
  ...
  static constexpr ColorMode COLOR_MODE_INVALID = ColorMode::COLOR_MODE_INVALID;
  static constexpr ColorMode COLOR_MODE_DEFAULT = ColorMode::COLOR_MODE_DEFAULT;
  static constexpr ColorMode COLOR_MODE_BT601_625 = ColorMode::COLOR_MODE_BT601_625;
  static constexpr ColorMode COLOR_MODE_BT601_625_UNADJUSTED = ColorMode::COLOR_MODE_BT601_625_UNADJUSTED;
  static constexpr ColorMode COLOR_MODE_BT601_525 = ColorMode::COLOR_MODE_BT601_525;
  static constexpr ColorMode COLOR_MODE_BT601_525_UNADJUSTED = ColorMode::COLOR_MODE_BT601_525_UNADJUSTED;
  static constexpr ColorMode COLOR_MODE_BT709 = ColorMode::COLOR_MODE_BT709;
  static constexpr ColorMode COLOR_MODE_DCI_P3 = ColorMode::COLOR_MODE_DCI_P3;
  static constexpr ColorMode COLOR_MODE_SRGB = ColorMode::COLOR_MODE_SRGB;
  static constexpr ColorMode COLOR_MODE_ADOBE_RGB = ColorMode::COLOR_MODE_ADOBE_RGB;
  static constexpr ColorMode COLOR_MODE_DISPLAY_P3 = ColorMode::COLOR_MODE_DISPLAY_P3;
};
