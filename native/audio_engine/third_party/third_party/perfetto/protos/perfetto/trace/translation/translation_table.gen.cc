...
bool TranslationTable::operator==(const TranslationTable& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(chrome_study_, other.chrome_study_);
}
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 5 /* process_track_name */:
        ...
        break;
      case 6 /* chrome_study */:
        (*chrome_study_) .ParseFromArray(field.data(), field.size());
        break;
      default:
...
void TranslationTable::Serialize(::protozero::Message* msg) const {
  ...
  // Field 6: chrome_study
  if (_has_field_[6]) {
    (*chrome_study_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(6));
  }
...
ChromeStudyTranslationTable::ChromeStudyTranslationTable() = default;
ChromeStudyTranslationTable::~ChromeStudyTranslationTable() = default;
ChromeStudyTranslationTable::ChromeStudyTranslationTable(const ChromeStudyTranslationTable&) = default;
ChromeStudyTranslationTable& ChromeStudyTranslationTable::operator=(const ChromeStudyTranslationTable&) = default;
ChromeStudyTranslationTable::ChromeStudyTranslationTable(ChromeStudyTranslationTable&&) noexcept = default;
ChromeStudyTranslationTable& ChromeStudyTranslationTable::operator=(ChromeStudyTranslationTable&&) = default;

bool ChromeStudyTranslationTable::operator==(const ChromeStudyTranslationTable& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(hash_to_name_, other.hash_to_name_);
}

int ChromeStudyTranslationTable::hash_to_name_size() const { return static_cast<int>(hash_to_name_.size()); }
void ChromeStudyTranslationTable::clear_hash_to_name() { hash_to_name_.clear(); }
ChromeStudyTranslationTable_HashToNameEntry* ChromeStudyTranslationTable::add_hash_to_name() { hash_to_name_.emplace_back(); return &hash_to_name_.back(); }
bool ChromeStudyTranslationTable::ParseFromArray(const void* raw, size_t size) {
  hash_to_name_.clear();
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string ChromeStudyTranslationTable::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> ChromeStudyTranslationTable::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void ChromeStudyTranslationTable::Serialize(::protozero::Message* msg) const {
  // Field 1: hash_to_name
  for (auto& it : hash_to_name_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(1));
  }
...
ChromeStudyTranslationTable_HashToNameEntry::ChromeStudyTranslationTable_HashToNameEntry() = default;
ChromeStudyTranslationTable_HashToNameEntry::~ChromeStudyTranslationTable_HashToNameEntry() = default;
ChromeStudyTranslationTable_HashToNameEntry::ChromeStudyTranslationTable_HashToNameEntry(const ChromeStudyTranslationTable_HashToNameEntry&) = default;
ChromeStudyTranslationTable_HashToNameEntry& ChromeStudyTranslationTable_HashToNameEntry::operator=(const ChromeStudyTranslationTable_HashToNameEntry&) = default;
ChromeStudyTranslationTable_HashToNameEntry::ChromeStudyTranslationTable_HashToNameEntry(ChromeStudyTranslationTable_HashToNameEntry&&) noexcept = default;
ChromeStudyTranslationTable_HashToNameEntry& ChromeStudyTranslationTable_HashToNameEntry::operator=(ChromeStudyTranslationTable_HashToNameEntry&&) = default;

bool ChromeStudyTranslationTable_HashToNameEntry::operator==(const ChromeStudyTranslationTable_HashToNameEntry& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(key_, other.key_)
    && ::protozero::internal::gen_helpers::EqualsField(value_, other.value_);
}

bool ChromeStudyTranslationTable_HashToNameEntry::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string ChromeStudyTranslationTable_HashToNameEntry::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> ChromeStudyTranslationTable_HashToNameEntry::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void ChromeStudyTranslationTable_HashToNameEntry::Serialize(::protozero::Message* msg) const {
  // Field 1: key
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, key_, msg);
  }
