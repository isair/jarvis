...
class PERFETTO_EXPORT_COMPONENT AndroidLogPacket_LogEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const AndroidLogId& log_id() const { return log_id_; }
  void set_log_id(const AndroidLogId& value) { log_id_ = value; _has_field_.set(1); }
  ...
  const AndroidLogPriority& prio() const { return prio_; }
  void set_prio(const AndroidLogPriority& value) { prio_ = value; _has_field_.set(7); }
