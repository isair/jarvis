...
bool TracePacket::operator==(const TracePacket& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(clone_snapshot_trigger_, other.clone_snapshot_trigger_)
    && ::protozero::internal::gen_helpers::EqualsField(bluetooth_trace_event_, other.bluetooth_trace_event_)
    && ::protozero::internal::gen_helpers::EqualsField(kernel_wakelock_data_, other.kernel_wakelock_data_)
    && ::protozero::internal::gen_helpers::EqualsField(app_wakelock_bundle_, other.app_wakelock_bundle_)
    && ::protozero::internal::gen_helpers::EqualsField(generic_kernel_task_state_event_, other.generic_kernel_task_state_event_)
    && ::protozero::internal::gen_helpers::EqualsField(generic_kernel_cpu_freq_event_, other.generic_kernel_cpu_freq_event_)
    && ::protozero::internal::gen_helpers::EqualsField(generic_kernel_task_rename_event_, other.generic_kernel_task_rename_event_)
    && ::protozero::internal::gen_helpers::EqualsField(cpu_per_uid_data_, other.cpu_per_uid_data_)
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 111 /* pixel_modem_token_database */:
        ...
        break;
      case 113 /* clone_snapshot_trigger */:
        (*clone_snapshot_trigger_) .ParseFromArray(field.data(), field.size());
        break;
      case 114 /* bluetooth_trace_event */:
        (*bluetooth_trace_event_) .ParseFromArray(field.data(), field.size());
        break;
      case 115 /* kernel_wakelock_data */:
        (*kernel_wakelock_data_) .ParseFromArray(field.data(), field.size());
        break;
      case 116 /* app_wakelock_bundle */:
        (*app_wakelock_bundle_) .ParseFromArray(field.data(), field.size());
        break;
      case 117 /* generic_kernel_task_state_event */:
        (*generic_kernel_task_state_event_) .ParseFromArray(field.data(), field.size());
        break;
      case 118 /* generic_kernel_cpu_freq_event */:
        (*generic_kernel_cpu_freq_event_) .ParseFromArray(field.data(), field.size());
        break;
      case 120 /* generic_kernel_task_rename_event */:
        (*generic_kernel_task_rename_event_) .ParseFromArray(field.data(), field.size());
        break;
      case 119 /* cpu_per_uid_data */:
        (*cpu_per_uid_data_) .ParseFromArray(field.data(), field.size());
        break;
...
void TracePacket::Serialize(::protozero::Message* msg) const {
  ...
  // Field 113: clone_snapshot_trigger
  if (_has_field_[113]) {
    (*clone_snapshot_trigger_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(113));
  }

  // Field 114: bluetooth_trace_event
  if (_has_field_[114]) {
    (*bluetooth_trace_event_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(114));
  }

  // Field 115: kernel_wakelock_data
  if (_has_field_[115]) {
    (*kernel_wakelock_data_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(115));
  }

  // Field 116: app_wakelock_bundle
  if (_has_field_[116]) {
    (*app_wakelock_bundle_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(116));
  }

  // Field 117: generic_kernel_task_state_event
  if (_has_field_[117]) {
    (*generic_kernel_task_state_event_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(117));
  }

  // Field 118: generic_kernel_cpu_freq_event
  if (_has_field_[118]) {
    (*generic_kernel_cpu_freq_event_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(118));
  }

  // Field 120: generic_kernel_task_rename_event
  if (_has_field_[120]) {
    (*generic_kernel_task_rename_event_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(120));
  }

  // Field 119: cpu_per_uid_data
  if (_has_field_[119]) {
    (*cpu_per_uid_data_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(119));
  }
