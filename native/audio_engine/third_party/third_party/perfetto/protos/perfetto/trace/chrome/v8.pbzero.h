...
class InternedV8JsScript : public ::protozero::Message {
 public:
  ...
  static constexpr Type TYPE_UNKNOWN = Type::TYPE_UNKNOWN;
  static constexpr Type TYPE_NORMAL = Type::TYPE_NORMAL;
  static constexpr Type TYPE_EVAL = Type::TYPE_EVAL;
  static constexpr Type TYPE_MODULE = Type::TYPE_MODULE;
  static constexpr Type TYPE_NATIVE = Type::TYPE_NATIVE;
  static constexpr Type TYPE_EXTENSION = Type::TYPE_EXTENSION;
  static constexpr Type TYPE_INSPECTOR = Type::TYPE_INSPECTOR;
...
class InternedV8JsFunction : public ::protozero::Message {
 public:
  ...
  static constexpr Kind KIND_UNKNOWN = Kind::KIND_UNKNOWN;
  static constexpr Kind KIND_NORMAL_FUNCTION = Kind::KIND_NORMAL_FUNCTION;
  static constexpr Kind KIND_MODULE = Kind::KIND_MODULE;
  static constexpr Kind KIND_ASYNC_MODULE = Kind::KIND_ASYNC_MODULE;
  static constexpr Kind KIND_BASE_CONSTRUCTOR = Kind::KIND_BASE_CONSTRUCTOR;
  static constexpr Kind KIND_DEFAULT_BASE_CONSTRUCTOR = Kind::KIND_DEFAULT_BASE_CONSTRUCTOR;
  static constexpr Kind KIND_DEFAULT_DERIVED_CONSTRUCTOR = Kind::KIND_DEFAULT_DERIVED_CONSTRUCTOR;
  static constexpr Kind KIND_DERIVED_CONSTRUCTOR = Kind::KIND_DERIVED_CONSTRUCTOR;
  static constexpr Kind KIND_GETTER_FUNCTION = Kind::KIND_GETTER_FUNCTION;
  static constexpr Kind KIND_STATIC_GETTER_FUNCTION = Kind::KIND_STATIC_GETTER_FUNCTION;
  static constexpr Kind KIND_SETTER_FUNCTION = Kind::KIND_SETTER_FUNCTION;
  static constexpr Kind KIND_STATIC_SETTER_FUNCTION = Kind::KIND_STATIC_SETTER_FUNCTION;
  static constexpr Kind KIND_ARROW_FUNCTION = Kind::KIND_ARROW_FUNCTION;
  static constexpr Kind KIND_ASYNC_ARROW_FUNCTION = Kind::KIND_ASYNC_ARROW_FUNCTION;
  static constexpr Kind KIND_ASYNC_FUNCTION = Kind::KIND_ASYNC_FUNCTION;
  static constexpr Kind KIND_ASYNC_CONCISE_METHOD = Kind::KIND_ASYNC_CONCISE_METHOD;
  static constexpr Kind KIND_STATIC_ASYNC_CONCISE_METHOD = Kind::KIND_STATIC_ASYNC_CONCISE_METHOD;
  static constexpr Kind KIND_ASYNC_CONCISE_GENERATOR_METHOD = Kind::KIND_ASYNC_CONCISE_GENERATOR_METHOD;
  static constexpr Kind KIND_STATIC_ASYNC_CONCISE_GENERATOR_METHOD = Kind::KIND_STATIC_ASYNC_CONCISE_GENERATOR_METHOD;
  static constexpr Kind KIND_ASYNC_GENERATOR_FUNCTION = Kind::KIND_ASYNC_GENERATOR_FUNCTION;
  static constexpr Kind KIND_GENERATOR_FUNCTION = Kind::KIND_GENERATOR_FUNCTION;
  static constexpr Kind KIND_CONCISE_GENERATOR_METHOD = Kind::KIND_CONCISE_GENERATOR_METHOD;
  static constexpr Kind KIND_STATIC_CONCISE_GENERATOR_METHOD = Kind::KIND_STATIC_CONCISE_GENERATOR_METHOD;
  static constexpr Kind KIND_CONCISE_METHOD = Kind::KIND_CONCISE_METHOD;
  static constexpr Kind KIND_STATIC_CONCISE_METHOD = Kind::KIND_STATIC_CONCISE_METHOD;
  static constexpr Kind KIND_CLASS_MEMBERS_INITIALIZER_FUNCTION = Kind::KIND_CLASS_MEMBERS_INITIALIZER_FUNCTION;
  static constexpr Kind KIND_CLASS_STATIC_INITIALIZER_FUNCTION = Kind::KIND_CLASS_STATIC_INITIALIZER_FUNCTION;
  static constexpr Kind KIND_INVALID = Kind::KIND_INVALID;
...
class V8JsCode : public ::protozero::Message {
 public:
  ...
  static constexpr Tier TIER_UNKNOWN = Tier::TIER_UNKNOWN;
  static constexpr Tier TIER_IGNITION = Tier::TIER_IGNITION;
  static constexpr Tier TIER_SPARKPLUG = Tier::TIER_SPARKPLUG;
  static constexpr Tier TIER_MAGLEV = Tier::TIER_MAGLEV;
  static constexpr Tier TIER_TURBOSHAFT = Tier::TIER_TURBOSHAFT;
  static constexpr Tier TIER_TURBOFAN = Tier::TIER_TURBOFAN;
...
class V8InternalCode : public ::protozero::Message {
 public:
  ...
  static constexpr Type TYPE_UNKNOWN = Type::TYPE_UNKNOWN;
  static constexpr Type TYPE_BYTECODE_HANDLER = Type::TYPE_BYTECODE_HANDLER;
  static constexpr Type TYPE_FOR_TESTING = Type::TYPE_FOR_TESTING;
  static constexpr Type TYPE_BUILTIN = Type::TYPE_BUILTIN;
  static constexpr Type TYPE_WASM_FUNCTION = Type::TYPE_WASM_FUNCTION;
  static constexpr Type TYPE_WASM_TO_CAPI_FUNCTION = Type::TYPE_WASM_TO_CAPI_FUNCTION;
  static constexpr Type TYPE_WASM_TO_JS_FUNCTION = Type::TYPE_WASM_TO_JS_FUNCTION;
  static constexpr Type TYPE_JS_TO_WASM_FUNCTION = Type::TYPE_JS_TO_WASM_FUNCTION;
  static constexpr Type TYPE_JS_TO_JS_FUNCTION = Type::TYPE_JS_TO_JS_FUNCTION;
  static constexpr Type TYPE_C_WASM_ENTRY = Type::TYPE_C_WASM_ENTRY;
...
class V8WasmCode : public ::protozero::Message {
 public:
  ...
  static constexpr Tier TIER_UNKNOWN = Tier::TIER_UNKNOWN;
  static constexpr Tier TIER_LIFTOFF = Tier::TIER_LIFTOFF;
  static constexpr Tier TIER_TURBOFAN = Tier::TIER_TURBOFAN;
