...
class TrackEvent : public ::protozero::Message {
 public:
  ...
  static constexpr Type TYPE_UNSPECIFIED = Type::TYPE_UNSPECIFIED;
  static constexpr Type TYPE_SLICE_BEGIN = Type::TYPE_SLICE_BEGIN;
  static constexpr Type TYPE_SLICE_END = Type::TYPE_SLICE_END;
  static constexpr Type TYPE_INSTANT = Type::TYPE_INSTANT;
  static constexpr Type TYPE_COUNTER = Type::TYPE_COUNTER;
...
class TrackEvent_LegacyEvent : public ::protozero::Message {
 public:
  ...
  static constexpr FlowDirection FLOW_UNSPECIFIED = FlowDirection::FLOW_UNSPECIFIED;
  static constexpr FlowDirection FLOW_IN = FlowDirection::FLOW_IN;
  static constexpr FlowDirection FLOW_OUT = FlowDirection::FLOW_OUT;
  static constexpr FlowDirection FLOW_INOUT = FlowDirection::FLOW_INOUT;
  static constexpr InstantEventScope SCOPE_UNSPECIFIED = InstantEventScope::SCOPE_UNSPECIFIED;
  static constexpr InstantEventScope SCOPE_GLOBAL = InstantEventScope::SCOPE_GLOBAL;
  static constexpr InstantEventScope SCOPE_PROCESS = InstantEventScope::SCOPE_PROCESS;
  static constexpr InstantEventScope SCOPE_THREAD = InstantEventScope::SCOPE_THREAD;
