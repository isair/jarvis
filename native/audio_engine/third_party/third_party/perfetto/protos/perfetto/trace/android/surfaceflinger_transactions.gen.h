...
class PERFETTO_EXPORT_COMPONENT TransactionState : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_apply_token() const { return _has_field_[10]; }
  uint64_t apply_token() const { return apply_token_; }
  void set_apply_token(uint64_t value) { apply_token_ = value; _has_field_.set(10); }
...
class PERFETTO_EXPORT_COMPONENT LayerState : public ::protozero::CppMessageObj {
 public:
  ...
  const LayerState_DropInputMode& drop_input_mode() const { return drop_input_mode_; }
  void set_drop_input_mode(const LayerState_DropInputMode& value) { drop_input_mode_ = value; _has_field_.set(42); }

  bool has_trusted_overlay() const { return _has_field_[43]; }
  const TrustedOverlay& trusted_overlay() const { return trusted_overlay_; }
  void set_trusted_overlay(const TrustedOverlay& value) { trusted_overlay_ = value; _has_field_.set(43); }

  bool has_background_blur_scale() const { return _has_field_[44]; }
  float background_blur_scale() const { return background_blur_scale_; }
  void set_background_blur_scale(float value) { background_blur_scale_ = value; _has_field_.set(44); }
...
class PERFETTO_EXPORT_COMPONENT LayerState_BufferData : public ::protozero::CppMessageObj {
 public:
  ...
  const LayerState_BufferData_PixelFormat& pixel_format() const { return pixel_format_; }
  void set_pixel_format(const LayerState_BufferData_PixelFormat& value) { pixel_format_ = value; _has_field_.set(7); }
