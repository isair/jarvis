...
class PERFETTO_EXPORT_COMPONENT TrackDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const TrackDescriptor_ChildTracksOrdering& child_ordering() const { return child_ordering_; }
  void set_child_ordering(const TrackDescriptor_ChildTracksOrdering& value) { child_ordering_ = value; _has_field_.set(11); }
