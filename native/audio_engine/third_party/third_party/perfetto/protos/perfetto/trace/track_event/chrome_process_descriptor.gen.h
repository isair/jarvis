...
class PERFETTO_EXPORT_COMPONENT ChromeProcessDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeProcessDescriptor_ProcessType& process_type() const { return process_type_; }
  void set_process_type(const ChromeProcessDescriptor_ProcessType& value) { process_type_ = value; _has_field_.set(1); }
