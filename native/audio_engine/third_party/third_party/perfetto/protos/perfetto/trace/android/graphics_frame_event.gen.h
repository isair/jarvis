...
class PERFETTO_EXPORT_COMPONENT GraphicsFrameEvent_BufferEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const GraphicsFrameEvent_BufferEventType& type() const { return type_; }
  void set_type(const GraphicsFrameEvent_BufferEventType& value) { type_ = value; _has_field_.set(2); }
