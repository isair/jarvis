...
bool PerfSample::operator==(const PerfSample& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(follower_counts_, other.follower_counts_)
    && ::protozero::internal::gen_helpers::EqualsField(callstack_iid_, other.callstack_iid_)
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 6 /* timebase_count */:
        ...
        break;
      case 7 /* follower_counts */:
        follower_counts_.emplace_back();
        field.get(&follower_counts_.back());
        break;
...
void PerfSample::Serialize(::protozero::Message* msg) const {
  ...
  // Field 7: follower_counts
  for (auto& it : follower_counts_) {
...
int PerfSampleDefaults::followers_size() const { return static_cast<int>(followers_.size()); }
void PerfSampleDefaults::clear_followers() { followers_.clear(); }
FollowerEvent* PerfSampleDefaults::add_followers() { followers_.emplace_back(); return &followers_.back(); }
