...
class PixelFormatProto : public ::protozero::Message {
 public:
  ...
  static constexpr Format UNKNOWN = Format::UNKNOWN;
  static constexpr Format TRANSLUCENT = Format::TRANSLUCENT;
  static constexpr Format TRANSPARENT = Format::TRANSPARENT;
  static constexpr Format OPAQUE = Format::OPAQUE;
  static constexpr Format RGBA_8888 = Format::RGBA_8888;
  static constexpr Format RGBX_8888 = Format::RGBX_8888;
  static constexpr Format RGB_888 = Format::RGB_888;
  static constexpr Format RGB_565 = Format::RGB_565;
  static constexpr Format RGBA_F16 = Format::RGBA_F16;
  static constexpr Format RGBA_1010102 = Format::RGBA_1010102;
};
