...
class PERFETTO_EXPORT_COMPONENT TranslationTable : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_chrome_study() const { return _has_field_[6]; }
  const ChromeStudyTranslationTable& chrome_study() const { return *chrome_study_; }
  ChromeStudyTranslationTable* mutable_chrome_study() { _has_field_.set(6); return chrome_study_.get(); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<ChromeStudyTranslationTable> chrome_study_;
...
class PERFETTO_EXPORT_COMPONENT ChromeStudyTranslationTable : public ::protozero::CppMessageObj {
 public:
  using HashToNameEntry = ChromeStudyTranslationTable_HashToNameEntry;
  enum FieldNumbers {
    kHashToNameFieldNumber = 1,
  };

  ChromeStudyTranslationTable();
  ~ChromeStudyTranslationTable() override;
  ChromeStudyTranslationTable(ChromeStudyTranslationTable&&) noexcept;
  ChromeStudyTranslationTable& operator=(ChromeStudyTranslationTable&&);
  ChromeStudyTranslationTable(const ChromeStudyTranslationTable&);
  ChromeStudyTranslationTable& operator=(const ChromeStudyTranslationTable&);
  bool operator==(const ChromeStudyTranslationTable&) const;
  bool operator!=(const ChromeStudyTranslationTable& other) const { return !(*this == other); }
  ...
  const std::vector<ChromeStudyTranslationTable_HashToNameEntry>& hash_to_name() const { return hash_to_name_; }
  std::vector<ChromeStudyTranslationTable_HashToNameEntry>* mutable_hash_to_name() { return &hash_to_name_; }
  int hash_to_name_size() const;
  void clear_hash_to_name();
  ChromeStudyTranslationTable_HashToNameEntry* add_hash_to_name();

 private:
  std::vector<ChromeStudyTranslationTable_HashToNameEntry> hash_to_name_;
...
class PERFETTO_EXPORT_COMPONENT ChromeStudyTranslationTable_HashToNameEntry : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kKeyFieldNumber = 1,
    kValueFieldNumber = 2,
  ...
  ~ChromeStudyTranslationTable_HashToNameEntry() override;
  ChromeStudyTranslationTable_HashToNameEntry(ChromeStudyTranslationTable_HashToNameEntry&&) noexcept;
  ChromeStudyTranslationTable_HashToNameEntry& operator=(ChromeStudyTranslationTable_HashToNameEntry&&);
  ChromeStudyTranslationTable_HashToNameEntry(const ChromeStudyTranslationTable_HashToNameEntry&);
  ChromeStudyTranslationTable_HashToNameEntry& operator=(const ChromeStudyTranslationTable_HashToNameEntry&);
  bool operator==(const ChromeStudyTranslationTable_HashToNameEntry&) const;
  bool operator!=(const ChromeStudyTranslationTable_HashToNameEntry& other) const { return !(*this == other); }
