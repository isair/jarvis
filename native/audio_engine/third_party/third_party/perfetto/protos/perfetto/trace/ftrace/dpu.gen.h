...
class PERFETTO_EXPORT_COMPONENT DpuDispDpuUnderrunFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIdFieldNumber = 1,
  ...
  ~DpuDispDpuUnderrunFtraceEvent() override;
  DpuDispDpuUnderrunFtraceEvent(DpuDispDpuUnderrunFtraceEvent&&) noexcept;
  DpuDispDpuUnderrunFtraceEvent& operator=(DpuDispDpuUnderrunFtraceEvent&&);
  DpuDispDpuUnderrunFtraceEvent(const DpuDispDpuUnderrunFtraceEvent&);
  DpuDispDpuUnderrunFtraceEvent& operator=(const DpuDispDpuUnderrunFtraceEvent&);
  bool operator==(const DpuDispDpuUnderrunFtraceEvent&) const;
  bool operator!=(const DpuDispDpuUnderrunFtraceEvent& other) const { return !(*this == other); }
  ...
  bool has_frames_pending() const { return _has_field_[2]; }
  int32_t frames_pending() const { return frames_pending_; }
  void set_frames_pending(int32_t value) { frames_pending_ = value; _has_field_.set(2); }

  bool has_vsync_count() const { return _has_field_[3]; }
  int32_t vsync_count() const { return vsync_count_; }
  void set_vsync_count(int32_t value) { vsync_count_ = value; _has_field_.set(3); }
...
class PERFETTO_EXPORT_COMPONENT DpuDispVblankIrqEnableFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kIdFieldNumber = 1,
  ...
  ~DpuDispVblankIrqEnableFtraceEvent() override;
  DpuDispVblankIrqEnableFtraceEvent(DpuDispVblankIrqEnableFtraceEvent&&) noexcept;
  DpuDispVblankIrqEnableFtraceEvent& operator=(DpuDispVblankIrqEnableFtraceEvent&&);
  DpuDispVblankIrqEnableFtraceEvent(const DpuDispVblankIrqEnableFtraceEvent&);
  DpuDispVblankIrqEnableFtraceEvent& operator=(const DpuDispVblankIrqEnableFtraceEvent&);
  bool operator==(const DpuDispVblankIrqEnableFtraceEvent&) const;
  bool operator!=(const DpuDispVblankIrqEnableFtraceEvent& other) const { return !(*this == other); }
  ...
  int32_t output_id() const { return output_id_; }
  void set_output_id(int32_t value) { output_id_ = value; _has_field_.set(2); }

  bool has_enable() const { return _has_field_[3]; }
  int32_t enable() const { return enable_; }
  void set_enable(int32_t value) { enable_ = value; _has_field_.set(3); }
