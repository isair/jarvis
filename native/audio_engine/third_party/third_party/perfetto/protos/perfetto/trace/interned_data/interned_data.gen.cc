...
bool InternedData::operator==(const InternedData& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(app_wakelock_info_, other.app_wakelock_info_)
...
int InternedData::app_wakelock_info_size() const { return static_cast<int>(app_wakelock_info_.size()); }
void InternedData::clear_app_wakelock_info() { app_wakelock_info_.clear(); }
AppWakelockInfo* InternedData::add_app_wakelock_info() { app_wakelock_info_.emplace_back(); return &app_wakelock_info_.back(); }
int InternedData::correlation_id_str_size() const { return static_cast<int>(correlation_id_str_.size()); }
void InternedData::clear_correlation_id_str() { correlation_id_str_.clear(); }
InternedString* InternedData::add_correlation_id_str() { correlation_id_str_.emplace_back(); return &correlation_id_str_.back(); }
bool InternedData::ParseFromArray(const void* raw, size_t size) {
  ...
  app_wakelock_info_.clear();
  correlation_id_str_.clear();
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 41 /* viewcapture_class_name */:
        ...
        break;
      case 42 /* app_wakelock_info */:
        app_wakelock_info_.emplace_back();
        app_wakelock_info_.back().ParseFromArray(field.data(), field.size());
        break;
      case 43 /* correlation_id_str */:
        correlation_id_str_.emplace_back();
        correlation_id_str_.back().ParseFromArray(field.data(), field.size());
        break;
      default:
...
void InternedData::Serialize(::protozero::Message* msg) const {
  ...
  // Field 42: app_wakelock_info
  for (auto& it : app_wakelock_info_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(42));
  }

  // Field 43: correlation_id_str
  for (auto& it : correlation_id_str_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(43));
  }
