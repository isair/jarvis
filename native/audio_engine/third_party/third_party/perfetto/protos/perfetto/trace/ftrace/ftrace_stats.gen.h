...
class PERFETTO_EXPORT_COMPONENT FtraceKprobeStats : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kHitsFieldNumber = 1,
  ...
  FtraceKprobeStats();
  ~FtraceKprobeStats() override;
  FtraceKprobeStats(FtraceKprobeStats&&) noexcept;
  FtraceKprobeStats& operator=(FtraceKprobeStats&&);
  FtraceKprobeStats(const FtraceKprobeStats&);
  FtraceKprobeStats& operator=(const FtraceKprobeStats&);
  bool operator==(const FtraceKprobeStats&) const;
  bool operator!=(const FtraceKprobeStats& other) const { return !(*this == other); }
  ...
  bool has_hits() const { return _has_field_[1]; }
  int64_t hits() const { return hits_; }
  void set_hits(int64_t value) { hits_ = value; _has_field_.set(1); }

  bool has_misses() const { return _has_field_[2]; }
  int64_t misses() const { return misses_; }
  void set_misses(int64_t value) { misses_ = value; _has_field_.set(2); }
...
class PERFETTO_EXPORT_COMPONENT FtraceStats : public ::protozero::CppMessageObj {
 public:
  ...
  const FtraceStats_Phase& phase() const { return phase_; }
  void set_phase(const FtraceStats_Phase& value) { phase_ = value; _has_field_.set(1); }
  ...
  bool has_kprobe_stats() const { return _has_field_[10]; }
  const FtraceKprobeStats& kprobe_stats() const { return *kprobe_stats_; }
  FtraceKprobeStats* mutable_kprobe_stats() { _has_field_.set(10); return kprobe_stats_.get(); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<FtraceKprobeStats> kprobe_stats_;
