...
DpuDispDpuUnderrunFtraceEvent::DpuDispDpuUnderrunFtraceEvent() = default;
DpuDispDpuUnderrunFtraceEvent::~DpuDispDpuUnderrunFtraceEvent() = default;
DpuDispDpuUnderrunFtraceEvent::DpuDispDpuUnderrunFtraceEvent(const DpuDispDpuUnderrunFtraceEvent&) = default;
DpuDispDpuUnderrunFtraceEvent& DpuDispDpuUnderrunFtraceEvent::operator=(const DpuDispDpuUnderrunFtraceEvent&) = default;
DpuDispDpuUnderrunFtraceEvent::DpuDispDpuUnderrunFtraceEvent(DpuDispDpuUnderrunFtraceEvent&&) noexcept = default;
DpuDispDpuUnderrunFtraceEvent& DpuDispDpuUnderrunFtraceEvent::operator=(DpuDispDpuUnderrunFtraceEvent&&) = default;

bool DpuDispDpuUnderrunFtraceEvent::operator==(const DpuDispDpuUnderrunFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(id_, other.id_)
    && ::protozero::internal::gen_helpers::EqualsField(frames_pending_, other.frames_pending_)
    && ::protozero::internal::gen_helpers::EqualsField(vsync_count_, other.vsync_count_);
}

bool DpuDispDpuUnderrunFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      case 1 /* id */:
        field.get(&id_);
        break;
      case 2 /* frames_pending */:
        field.get(&frames_pending_);
        break;
      case 3 /* vsync_count */:
...
std::string DpuDispDpuUnderrunFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> DpuDispDpuUnderrunFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void DpuDispDpuUnderrunFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: id
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, id_, msg);
  }

  // Field 2: frames_pending
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(2, frames_pending_, msg);
  }

  // Field 3: vsync_count
  if (_has_field_[3]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(3, vsync_count_, msg);
  }
...
DpuDispVblankIrqEnableFtraceEvent::DpuDispVblankIrqEnableFtraceEvent() = default;
DpuDispVblankIrqEnableFtraceEvent::~DpuDispVblankIrqEnableFtraceEvent() = default;
DpuDispVblankIrqEnableFtraceEvent::DpuDispVblankIrqEnableFtraceEvent(const DpuDispVblankIrqEnableFtraceEvent&) = default;
DpuDispVblankIrqEnableFtraceEvent& DpuDispVblankIrqEnableFtraceEvent::operator=(const DpuDispVblankIrqEnableFtraceEvent&) = default;
DpuDispVblankIrqEnableFtraceEvent::DpuDispVblankIrqEnableFtraceEvent(DpuDispVblankIrqEnableFtraceEvent&&) noexcept = default;
DpuDispVblankIrqEnableFtraceEvent& DpuDispVblankIrqEnableFtraceEvent::operator=(DpuDispVblankIrqEnableFtraceEvent&&) = default;

bool DpuDispVblankIrqEnableFtraceEvent::operator==(const DpuDispVblankIrqEnableFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(id_, other.id_)
    && ::protozero::internal::gen_helpers::EqualsField(output_id_, other.output_id_)
    && ::protozero::internal::gen_helpers::EqualsField(enable_, other.enable_);
}

bool DpuDispVblankIrqEnableFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string DpuDispVblankIrqEnableFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> DpuDispVblankIrqEnableFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void DpuDispVblankIrqEnableFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: id
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, id_, msg);
  }
  ...
  // Field 3: enable
  if (_has_field_[3]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(3, enable_, msg);
  }
