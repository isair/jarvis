...
bool InternedV8WasmScript::operator==(const InternedV8WasmScript& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(wire_bytes_, other.wire_bytes_);
}
...
void InternedV8WasmScript::Serialize(::protozero::Message* msg) const {
  ...
  // Field 4: wire_bytes
  if (_has_field_[4]) {
    ::protozero::internal::gen_helpers::SerializeString(4, wire_bytes_, msg);
  }
...
void InternedV8JsFunction::Serialize(::protozero::Message* msg) const {
  ...
  // Field 7: line
  if (_has_field_[7]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(7, line_, msg);
  }

  // Field 8: column
  if (_has_field_[8]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(8, column_, msg);
  }
