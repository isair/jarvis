...
FtraceKprobeStats::FtraceKprobeStats() = default;
FtraceKprobeStats::~FtraceKprobeStats() = default;
FtraceKprobeStats::FtraceKprobeStats(const FtraceKprobeStats&) = default;
FtraceKprobeStats& FtraceKprobeStats::operator=(const FtraceKprobeStats&) = default;
FtraceKprobeStats::FtraceKprobeStats(FtraceKprobeStats&&) noexcept = default;
FtraceKprobeStats& FtraceKprobeStats::operator=(FtraceKprobeStats&&) = default;

bool FtraceKprobeStats::operator==(const FtraceKprobeStats& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(hits_, other.hits_)
    && ::protozero::internal::gen_helpers::EqualsField(misses_, other.misses_);
}

bool FtraceKprobeStats::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string FtraceKprobeStats::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> FtraceKprobeStats::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void FtraceKprobeStats::Serialize(::protozero::Message* msg) const {
  // Field 1: hits
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, hits_, msg);
  }

  // Field 2: misses
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(2, misses_, msg);
  }
...
bool FtraceStats::operator==(const FtraceStats& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(kprobe_stats_, other.kprobe_stats_);
}
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 9 /* ftrace_parse_errors */:
        ...
        break;
      case 10 /* kprobe_stats */:
        (*kprobe_stats_) .ParseFromArray(field.data(), field.size());
        break;
      default:
        field.SerializeAndAppendTo(&unknown_fields_);
        break;
...
void FtraceStats::Serialize(::protozero::Message* msg) const {
  ...
  // Field 10: kprobe_stats
  if (_has_field_[10]) {
    (*kprobe_stats_) .Serialize(msg->BeginNestedMessage<::protozero::Message>(10));
  }
