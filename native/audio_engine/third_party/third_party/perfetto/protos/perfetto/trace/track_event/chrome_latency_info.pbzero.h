...
class ChromeLatencyInfo : public ::protozero::Message {
 public:
  ...
  static constexpr InputType UNSPECIFIED_OR_OTHER = InputType::UNSPECIFIED_OR_OTHER;
  static constexpr InputType TOUCH_MOVED = InputType::TOUCH_MOVED;
  static constexpr InputType GESTURE_SCROLL_BEGIN = InputType::GESTURE_SCROLL_BEGIN;
  static constexpr InputType GESTURE_SCROLL_UPDATE = InputType::GESTURE_SCROLL_UPDATE;
  static constexpr InputType GESTURE_SCROLL_END = InputType::GESTURE_SCROLL_END;
  static constexpr InputType GESTURE_TAP = InputType::GESTURE_TAP;
  static constexpr InputType GESTURE_TAP_CANCEL = InputType::GESTURE_TAP_CANCEL;
