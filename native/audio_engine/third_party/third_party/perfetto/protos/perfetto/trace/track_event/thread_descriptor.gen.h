...
class PERFETTO_EXPORT_COMPONENT ThreadDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const ThreadDescriptor_ChromeThreadType& chrome_thread_type() const { return chrome_thread_type_; }
  void set_chrome_thread_type(const ThreadDescriptor_ChromeThreadType& value) { chrome_thread_type_ = value; _has_field_.set(4); }
