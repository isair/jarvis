...
class PERFETTO_EXPORT_COMPONENT ProcessDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const ProcessDescriptor_ChromeProcessType& chrome_process_type() const { return chrome_process_type_; }
  void set_chrome_process_type(const ProcessDescriptor_ChromeProcessType& value) { chrome_process_type_ = value; _has_field_.set(4); }
