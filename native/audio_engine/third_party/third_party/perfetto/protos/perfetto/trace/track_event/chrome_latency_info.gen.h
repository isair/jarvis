...
class PERFETTO_EXPORT_COMPONENT ChromeLatencyInfo : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeLatencyInfo_Step& step() const { return step_; }
  void set_step(const ChromeLatencyInfo_Step& value) { step_ = value; _has_field_.set(2); }
  ...
  const ChromeLatencyInfo_InputType& input_type() const { return input_type_; }
  void set_input_type(const ChromeLatencyInfo_InputType& value) { input_type_ = value; _has_field_.set(8); }
...
class PERFETTO_EXPORT_COMPONENT ChromeLatencyInfo_ComponentInfo : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeLatencyInfo_LatencyComponentType& component_type() const { return component_type_; }
  void set_component_type(const ChromeLatencyInfo_LatencyComponentType& value) { component_type_ = value; _has_field_.set(1); }
