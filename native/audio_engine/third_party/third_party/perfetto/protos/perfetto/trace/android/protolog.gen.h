...
class PERFETTO_EXPORT_COMPONENT ProtoLogViewerConfig_MessageData : public ::protozero::CppMessageObj {
 public:
  ...
  const ProtoLogLevel& level() const { return level_; }
  void set_level(const ProtoLogLevel& value) { level_ = value; _has_field_.set(3); }
  ...
  bool has_location() const { return _has_field_[5]; }
  const std::string& location() const { return location_; }
  void set_location(const std::string& value) { location_ = value; _has_field_.set(5); }
