...
class PERFETTO_EXPORT_COMPONENT ChromeApplicationStateInfo : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeApplicationStateInfo_ChromeApplicationState& application_state() const { return application_state_; }
  void set_application_state(const ChromeApplicationStateInfo_ChromeApplicationState& value) { application_state_ = value; _has_field_.set(1); }
