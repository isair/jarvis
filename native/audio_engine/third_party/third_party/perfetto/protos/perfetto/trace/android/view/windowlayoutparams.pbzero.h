...
class WindowLayoutParamsProto : public ::protozero::Message {
 public:
  ...
  static constexpr RotationAnimation ROTATION_ANIMATION_UNSPECIFIED = RotationAnimation::ROTATION_ANIMATION_UNSPECIFIED;
  static constexpr RotationAnimation ROTATION_ANIMATION_CROSSFADE = RotationAnimation::ROTATION_ANIMATION_CROSSFADE;
  static constexpr RotationAnimation ROTATION_ANIMATION_JUMPCUT = RotationAnimation::ROTATION_ANIMATION_JUMPCUT;
  static constexpr RotationAnimation ROTATION_ANIMATION_SEAMLESS = RotationAnimation::ROTATION_ANIMATION_SEAMLESS;
