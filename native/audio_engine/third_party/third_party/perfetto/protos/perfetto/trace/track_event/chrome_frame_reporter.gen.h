...
class PERFETTO_EXPORT_COMPONENT ChromeFrameReporter : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeFrameReporter_State& state() const { return state_; }
  void set_state(const ChromeFrameReporter_State& value) { state_ = value; _has_field_.set(1); }

  bool has_reason() const { return _has_field_[2]; }
  const ChromeFrameReporter_FrameDropReason& reason() const { return reason_; }
  void set_reason(const ChromeFrameReporter_FrameDropReason& value) { reason_ = value; _has_field_.set(2); }
  ...
  const ChromeFrameReporter_ScrollState& scroll_state() const { return scroll_state_; }
  void set_scroll_state(const ChromeFrameReporter_ScrollState& value) { scroll_state_ = value; _has_field_.set(6); }
  ...
  const ChromeFrameReporter_FrameType& frame_type() const { return frame_type_; }
  void set_frame_type(const ChromeFrameReporter_FrameType& value) { frame_type_ = value; _has_field_.set(13); }
