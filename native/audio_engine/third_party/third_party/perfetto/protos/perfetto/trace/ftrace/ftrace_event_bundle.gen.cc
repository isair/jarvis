...
bool FtraceEventBundle::operator==(const FtraceEventBundle& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    ...
    && ::protozero::internal::gen_helpers::EqualsField(previous_bundle_end_timestamp_, other.previous_bundle_end_timestamp_)
    && ::protozero::internal::gen_helpers::EqualsField(generic_event_descriptors_, other.generic_event_descriptors_)
    && ::protozero::internal::gen_helpers::EqualsField(broken_abi_trace_page_, other.broken_abi_trace_page_);
}
...
int FtraceEventBundle::generic_event_descriptors_size() const { return static_cast<int>(generic_event_descriptors_.size()); }
void FtraceEventBundle::clear_generic_event_descriptors() { generic_event_descriptors_.clear(); }
FtraceEventBundle_GenericEventDescriptor* FtraceEventBundle::add_generic_event_descriptors() { generic_event_descriptors_.emplace_back(); return &generic_event_descriptors_.back(); }
bool FtraceEventBundle::ParseFromArray(const void* raw, size_t size) {
  event_.clear();
  error_.clear();
  generic_event_descriptors_.clear();
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 9 /* last_read_event_timestamp */:
        ...
        break;
      case 10 /* previous_bundle_end_timestamp */:
        field.get(&previous_bundle_end_timestamp_);
        break;
      case 11 /* generic_event_descriptors */:
        generic_event_descriptors_.emplace_back();
        generic_event_descriptors_.back().ParseFromArray(field.data(), field.size());
        break;
      case 512 /* broken_abi_trace_page */:
        field.get(&broken_abi_trace_page_);
        break;
      default:
...
void FtraceEventBundle::Serialize(::protozero::Message* msg) const {
  ...
  // Field 10: previous_bundle_end_timestamp
  if (_has_field_[10]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(10, previous_bundle_end_timestamp_, msg);
  }

  // Field 11: generic_event_descriptors
  for (auto& it : generic_event_descriptors_) {
    it.Serialize(msg->BeginNestedMessage<::protozero::Message>(11));
  }

  // Field 512: broken_abi_trace_page
  if (_has_field_[512]) {
    ::protozero::internal::gen_helpers::SerializeString(512, broken_abi_trace_page_, msg);
  }
...
FtraceEventBundle_GenericEventDescriptor::FtraceEventBundle_GenericEventDescriptor() = default;
FtraceEventBundle_GenericEventDescriptor::~FtraceEventBundle_GenericEventDescriptor() = default;
FtraceEventBundle_GenericEventDescriptor::FtraceEventBundle_GenericEventDescriptor(const FtraceEventBundle_GenericEventDescriptor&) = default;
FtraceEventBundle_GenericEventDescriptor& FtraceEventBundle_GenericEventDescriptor::operator=(const FtraceEventBundle_GenericEventDescriptor&) = default;
FtraceEventBundle_GenericEventDescriptor::FtraceEventBundle_GenericEventDescriptor(FtraceEventBundle_GenericEventDescriptor&&) noexcept = default;
FtraceEventBundle_GenericEventDescriptor& FtraceEventBundle_GenericEventDescriptor::operator=(FtraceEventBundle_GenericEventDescriptor&&) = default;

bool FtraceEventBundle_GenericEventDescriptor::operator==(const FtraceEventBundle_GenericEventDescriptor& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(field_id_, other.field_id_)
    && ::protozero::internal::gen_helpers::EqualsField(event_descriptor_, other.event_descriptor_);
}

bool FtraceEventBundle_GenericEventDescriptor::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      case 1 /* field_id */:
        field.get(&field_id_);
        break;
      case 2 /* event_descriptor */:
        field.get(&event_descriptor_);
        break;
      default:
        field.SerializeAndAppendTo(&unknown_fields_);
        break;
...
std::string FtraceEventBundle_GenericEventDescriptor::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> FtraceEventBundle_GenericEventDescriptor::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void FtraceEventBundle_GenericEventDescriptor::Serialize(::protozero::Message* msg) const {
  // Field 1: field_id
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, field_id_, msg);
  }

  // Field 2: event_descriptor
  if (_has_field_[2]) {
    ::protozero::internal::gen_helpers::SerializeString(2, event_descriptor_, msg);
  }
