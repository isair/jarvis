...
class PERFETTO_EXPORT_COMPONENT SchedWakeupTaskAttrFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kPidFieldNumber = 1,
  ...
  SchedWakeupTaskAttrFtraceEvent(SchedWakeupTaskAttrFtraceEvent&&) noexcept;
  SchedWakeupTaskAttrFtraceEvent& operator=(SchedWakeupTaskAttrFtraceEvent&&);
  SchedWakeupTaskAttrFtraceEvent(const SchedWakeupTaskAttrFtraceEvent&);
  SchedWakeupTaskAttrFtraceEvent& operator=(const SchedWakeupTaskAttrFtraceEvent&);
  bool operator==(const SchedWakeupTaskAttrFtraceEvent&) const;
  bool operator!=(const SchedWakeupTaskAttrFtraceEvent& other) const { return !(*this == other); }
  ...
  bool has_cpu_affinity() const { return _has_field_[2]; }
  uint64_t cpu_affinity() const { return cpu_affinity_; }
  void set_cpu_affinity(uint64_t value) { cpu_affinity_ = value; _has_field_.set(2); }

  bool has_task_util() const { return _has_field_[3]; }
  uint64_t task_util() const { return task_util_; }
  void set_task_util(uint64_t value) { task_util_ = value; _has_field_.set(3); }

  bool has_uclamp_min() const { return _has_field_[4]; }
  uint64_t uclamp_min() const { return uclamp_min_; }
  void set_uclamp_min(uint64_t value) { uclamp_min_ = value; _has_field_.set(4); }

  bool has_vruntime() const { return _has_field_[5]; }
  uint64_t vruntime() const { return vruntime_; }
  void set_vruntime(uint64_t value) { vruntime_ = value; _has_field_.set(5); }
