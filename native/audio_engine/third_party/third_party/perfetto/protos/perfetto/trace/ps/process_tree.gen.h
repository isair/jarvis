...
class PERFETTO_EXPORT_COMPONENT ProcessTree_Process : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_cmdline_is_comm() const { return _has_field_[9]; }
  bool cmdline_is_comm() const { return cmdline_is_comm_; }
  void set_cmdline_is_comm(bool value) { cmdline_is_comm_ = value; _has_field_.set(9); }
  ...
  bool has_is_kthread() const { return _has_field_[8]; }
  bool is_kthread() const { return is_kthread_; }
  void set_is_kthread(bool value) { is_kthread_ = value; _has_field_.set(8); }
