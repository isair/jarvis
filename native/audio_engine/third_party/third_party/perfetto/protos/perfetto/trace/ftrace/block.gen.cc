...
BlockIoStartFtraceEvent::BlockIoStartFtraceEvent() = default;
BlockIoStartFtraceEvent::~BlockIoStartFtraceEvent() = default;
BlockIoStartFtraceEvent::BlockIoStartFtraceEvent(const BlockIoStartFtraceEvent&) = default;
BlockIoStartFtraceEvent& BlockIoStartFtraceEvent::operator=(const BlockIoStartFtraceEvent&) = default;
BlockIoStartFtraceEvent::BlockIoStartFtraceEvent(BlockIoStartFtraceEvent&&) noexcept = default;
BlockIoStartFtraceEvent& BlockIoStartFtraceEvent::operator=(BlockIoStartFtraceEvent&&) = default;

bool BlockIoStartFtraceEvent::operator==(const BlockIoStartFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(dev_, other.dev_)
    && ::protozero::internal::gen_helpers::EqualsField(sector_, other.sector_)
    && ::protozero::internal::gen_helpers::EqualsField(nr_sector_, other.nr_sector_)
    && ::protozero::internal::gen_helpers::EqualsField(bytes_, other.bytes_)
    && ::protozero::internal::gen_helpers::EqualsField(ioprio_, other.ioprio_)
    && ::protozero::internal::gen_helpers::EqualsField(rwbs_, other.rwbs_)
    && ::protozero::internal::gen_helpers::EqualsField(comm_, other.comm_)
    && ::protozero::internal::gen_helpers::EqualsField(cmd_, other.cmd_);
}

bool BlockIoStartFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string BlockIoStartFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> BlockIoStartFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void BlockIoStartFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: dev
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, dev_, msg);
  }
  ...
  // Field 5: ioprio
  if (_has_field_[5]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(5, ioprio_, msg);
  }
  ...
  // Field 7: comm
  if (_has_field_[7]) {
    ::protozero::internal::gen_helpers::SerializeString(7, comm_, msg);
  }

  // Field 8: cmd
  if (_has_field_[8]) {
    ::protozero::internal::gen_helpers::SerializeString(8, cmd_, msg);
  }
...
BlockIoDoneFtraceEvent::BlockIoDoneFtraceEvent() = default;
BlockIoDoneFtraceEvent::~BlockIoDoneFtraceEvent() = default;
BlockIoDoneFtraceEvent::BlockIoDoneFtraceEvent(const BlockIoDoneFtraceEvent&) = default;
BlockIoDoneFtraceEvent& BlockIoDoneFtraceEvent::operator=(const BlockIoDoneFtraceEvent&) = default;
BlockIoDoneFtraceEvent::BlockIoDoneFtraceEvent(BlockIoDoneFtraceEvent&&) noexcept = default;
BlockIoDoneFtraceEvent& BlockIoDoneFtraceEvent::operator=(BlockIoDoneFtraceEvent&&) = default;

bool BlockIoDoneFtraceEvent::operator==(const BlockIoDoneFtraceEvent& other) const {
  return ::protozero::internal::gen_helpers::EqualsField(unknown_fields_, other.unknown_fields_)
    && ::protozero::internal::gen_helpers::EqualsField(dev_, other.dev_)
    && ::protozero::internal::gen_helpers::EqualsField(sector_, other.sector_)
    && ::protozero::internal::gen_helpers::EqualsField(nr_sector_, other.nr_sector_)
...
bool BlockIoDoneFtraceEvent::ParseFromArray(const void* raw, size_t size) {
  unknown_fields_.clear();
  bool packed_error = false;
...
std::string BlockIoDoneFtraceEvent::SerializeAsString() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsString();
}

std::vector<uint8_t> BlockIoDoneFtraceEvent::SerializeAsArray() const {
  ::protozero::internal::gen_helpers::MessageSerializer msg;
  Serialize(msg.get());
  return msg.SerializeAsArray();
}

void BlockIoDoneFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: dev
  if (_has_field_[1]) {
    ::protozero::internal::gen_helpers::SerializeVarInt(1, dev_, msg);
  }
