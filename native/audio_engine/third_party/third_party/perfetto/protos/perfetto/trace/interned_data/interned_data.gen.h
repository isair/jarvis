...
class PERFETTO_EXPORT_COMPONENT InternedData : public ::protozero::CppMessageObj {
 public:
  ...
  const std::vector<AppWakelockInfo>& app_wakelock_info() const { return app_wakelock_info_; }
  std::vector<AppWakelockInfo>* mutable_app_wakelock_info() { return &app_wakelock_info_; }
  int app_wakelock_info_size() const;
  void clear_app_wakelock_info();
  AppWakelockInfo* add_app_wakelock_info();

  const std::vector<InternedString>& correlation_id_str() const { return correlation_id_str_; }
  std::vector<InternedString>* mutable_correlation_id_str() { return &correlation_id_str_; }
  int correlation_id_str_size() const;
  void clear_correlation_id_str();
  InternedString* add_correlation_id_str();
 ...
 private:
  ...
  std::vector<AppWakelockInfo> app_wakelock_info_;
  std::vector<InternedString> correlation_id_str_;
