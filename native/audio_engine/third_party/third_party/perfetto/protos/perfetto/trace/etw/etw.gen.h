...
class PERFETTO_EXPORT_COMPONENT CSwitchEtwEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const CSwitchEtwEvent_OldThreadWaitReason& old_thread_wait_reason() const { return old_thread_wait_reason_; }
  void set_old_thread_wait_reason(const CSwitchEtwEvent_OldThreadWaitReason& value) { old_thread_wait_reason_ = value; _has_field_.set(6); }

  bool has_old_thread_wait_reason_int() const { return _has_field_[11]; }
  int32_t old_thread_wait_reason_int() const { return old_thread_wait_reason_int_; }
  void set_old_thread_wait_reason_int(int32_t value) { old_thread_wait_reason_int_ = value; _has_field_.set(11); }

  bool has_old_thread_wait_mode() const { return _has_field_[7]; }
  const CSwitchEtwEvent_OldThreadWaitMode& old_thread_wait_mode() const { return old_thread_wait_mode_; }
  void set_old_thread_wait_mode(const CSwitchEtwEvent_OldThreadWaitMode& value) { old_thread_wait_mode_ = value; _has_field_.set(7); }

  bool has_old_thread_wait_mode_int() const { return _has_field_[12]; }
  int32_t old_thread_wait_mode_int() const { return old_thread_wait_mode_int_; }
  void set_old_thread_wait_mode_int(int32_t value) { old_thread_wait_mode_int_ = value; _has_field_.set(12); }

  bool has_old_thread_state() const { return _has_field_[8]; }
  const CSwitchEtwEvent_OldThreadState& old_thread_state() const { return old_thread_state_; }
  void set_old_thread_state(const CSwitchEtwEvent_OldThreadState& value) { old_thread_state_ = value; _has_field_.set(8); }

  bool has_old_thread_state_int() const { return _has_field_[13]; }
  int32_t old_thread_state_int() const { return old_thread_state_int_; }
  void set_old_thread_state_int(int32_t value) { old_thread_state_int_ = value; _has_field_.set(13); }
...
class PERFETTO_EXPORT_COMPONENT ReadyThreadEtwEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const ReadyThreadEtwEvent_AdjustReason& adjust_reason() const { return adjust_reason_; }
  void set_adjust_reason(const ReadyThreadEtwEvent_AdjustReason& value) { adjust_reason_ = value; _has_field_.set(2); }

  bool has_adjust_reason_int() const { return _has_field_[5]; }
  int32_t adjust_reason_int() const { return adjust_reason_int_; }
  void set_adjust_reason_int(int32_t value) { adjust_reason_int_ = value; _has_field_.set(5); }
  ...
  const ReadyThreadEtwEvent_TraceFlag& flag() const { return flag_; }
  void set_flag(const ReadyThreadEtwEvent_TraceFlag& value) { flag_ = value; _has_field_.set(4); }

  bool has_flag_int() const { return _has_field_[6]; }
  int32_t flag_int() const { return flag_int_; }
  void set_flag_int(int32_t value) { flag_int_ = value; _has_field_.set(6); }
