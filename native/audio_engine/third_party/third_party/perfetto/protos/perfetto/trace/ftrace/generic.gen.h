...
class PERFETTO_EXPORT_COMPONENT KprobeEvent : public ::protozero::CppMessageObj {
 public:
  using KprobeType = KprobeEvent_KprobeType;
  static constexpr auto KPROBE_TYPE_UNKNOWN = KprobeEvent_KprobeType_KPROBE_TYPE_UNKNOWN;
  static constexpr auto KPROBE_TYPE_BEGIN = KprobeEvent_KprobeType_KPROBE_TYPE_BEGIN;
  static constexpr auto KPROBE_TYPE_END = KprobeEvent_KprobeType_KPROBE_TYPE_END;
  static constexpr auto KPROBE_TYPE_INSTANT = KprobeEvent_KprobeType_KPROBE_TYPE_INSTANT;
  static constexpr auto KprobeType_MIN = KprobeEvent_KprobeType_KPROBE_TYPE_UNKNOWN;
  static constexpr auto KprobeType_MAX = KprobeEvent_KprobeType_KPROBE_TYPE_INSTANT;
  ...
  KprobeEvent();
  ~KprobeEvent() override;
  KprobeEvent(KprobeEvent&&) noexcept;
  KprobeEvent& operator=(KprobeEvent&&);
  KprobeEvent(const KprobeEvent&);
  KprobeEvent& operator=(const KprobeEvent&);
  bool operator==(const KprobeEvent&) const;
  bool operator!=(const KprobeEvent& other) const { return !(*this == other); }
  ...
  const KprobeEvent_KprobeType& type() const { return type_; }
  void set_type(const KprobeEvent_KprobeType& value) { type_ = value; _has_field_.set(2); }

 private:
  std::string name_;
  KprobeEvent_KprobeType type_;
