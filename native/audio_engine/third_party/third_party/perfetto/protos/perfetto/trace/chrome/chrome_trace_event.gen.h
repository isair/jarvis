...
class PERFETTO_EXPORT_COMPONENT ChromeTracedValue : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeTracedValue_NestedType& nested_type() const { return nested_type_; }
  void set_nested_type(const ChromeTracedValue_NestedType& value) { nested_type_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT ChromeLegacyJsonTrace : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeLegacyJsonTrace_TraceType& type() const { return type_; }
  void set_type(const ChromeLegacyJsonTrace_TraceType& value) { type_ = value; _has_field_.set(1); }
