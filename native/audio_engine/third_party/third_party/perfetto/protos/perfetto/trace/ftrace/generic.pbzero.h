...
class KprobeEvent : public ::protozero::Message {
 public:
  ...
  static constexpr KprobeType KPROBE_TYPE_BEGIN = KprobeType::KPROBE_TYPE_BEGIN;
  static constexpr KprobeType KPROBE_TYPE_END = KprobeType::KPROBE_TYPE_END;
  static constexpr KprobeType KPROBE_TYPE_INSTANT = KprobeType::KPROBE_TYPE_INSTANT;
