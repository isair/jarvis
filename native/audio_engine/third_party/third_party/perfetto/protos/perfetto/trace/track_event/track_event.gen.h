...
class PERFETTO_EXPORT_COMPONENT TrackEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const TrackEvent_Type& type() const { return type_; }
  void set_type(const TrackEvent_Type& value) { type_ = value; _has_field_.set(9); }
...
class PERFETTO_EXPORT_COMPONENT TrackEvent_LegacyEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const TrackEvent_LegacyEvent_FlowDirection& flow_direction() const { return flow_direction_; }
  void set_flow_direction(const TrackEvent_LegacyEvent_FlowDirection& value) { flow_direction_ = value; _has_field_.set(13); }

  bool has_instant_event_scope() const { return _has_field_[14]; }
  const TrackEvent_LegacyEvent_InstantEventScope& instant_event_scope() const { return instant_event_scope_; }
  void set_instant_event_scope(const TrackEvent_LegacyEvent_InstantEventScope& value) { instant_event_scope_ = value; _has_field_.set(14); }
