...
class GpuLog : public ::protozero::Message {
 public:
  ...
  static constexpr Severity LOG_SEVERITY_UNSPECIFIED = Severity::LOG_SEVERITY_UNSPECIFIED;
  static constexpr Severity LOG_SEVERITY_VERBOSE = Severity::LOG_SEVERITY_VERBOSE;
  static constexpr Severity LOG_SEVERITY_DEBUG = Severity::LOG_SEVERITY_DEBUG;
  static constexpr Severity LOG_SEVERITY_INFO = Severity::LOG_SEVERITY_INFO;
  static constexpr Severity LOG_SEVERITY_WARNING = Severity::LOG_SEVERITY_WARNING;
  static constexpr Severity LOG_SEVERITY_ERROR = Severity::LOG_SEVERITY_ERROR;
