...
class PERFETTO_EXPORT_COMPONENT MaliGpuPowerStateFtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
  ...
  ~MaliGpuPowerStateFtraceEvent() override;
  MaliGpuPowerStateFtraceEvent(MaliGpuPowerStateFtraceEvent&&) noexcept;
  MaliGpuPowerStateFtraceEvent& operator=(MaliGpuPowerStateFtraceEvent&&);
  MaliGpuPowerStateFtraceEvent(const MaliGpuPowerStateFtraceEvent&);
  MaliGpuPowerStateFtraceEvent& operator=(const MaliGpuPowerStateFtraceEvent&);
  bool operator==(const MaliGpuPowerStateFtraceEvent&) const;
  bool operator!=(const MaliGpuPowerStateFtraceEvent& other) const { return !(*this == other); }
  ...
  bool has_change_ns() const { return _has_field_[1]; }
  uint64_t change_ns() const { return change_ns_; }
  void set_change_ns(uint64_t value) { change_ns_ = value; _has_field_.set(1); }

  bool has_from_state() const { return _has_field_[2]; }
  int32_t from_state() const { return from_state_; }
  void set_from_state(int32_t value) { from_state_ = value; _has_field_.set(2); }

  bool has_to_state() const { return _has_field_[3]; }
  int32_t to_state() const { return to_state_; }
  void set_to_state(int32_t value) { to_state_ = value; _has_field_.set(3); }
