...
class PERFETTO_EXPORT_COMPONENT BackgroundTracingMetadata_TriggerRule : public ::protozero::CppMessageObj {
 public:
  ...
  const BackgroundTracingMetadata_TriggerRule_TriggerType& trigger_type() const { return trigger_type_; }
  void set_trigger_type(const BackgroundTracingMetadata_TriggerRule_TriggerType& value) { trigger_type_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT BackgroundTracingMetadata_TriggerRule_NamedRule : public ::protozero::CppMessageObj {
 public:
  ...
  const BackgroundTracingMetadata_TriggerRule_NamedRule_EventType& event_type() const { return event_type_; }
  void set_event_type(const BackgroundTracingMetadata_TriggerRule_NamedRule_EventType& value) { event_type_ = value; _has_field_.set(1); }
