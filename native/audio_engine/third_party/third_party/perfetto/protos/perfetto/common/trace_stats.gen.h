...
class PERFETTO_EXPORT_COMPONENT TraceStats : public ::protozero::CppMessageObj {
 public:
  ...
  const TraceStats_FinalFlushOutcome& final_flush_outcome() const { return final_flush_outcome_; }
  void set_final_flush_outcome(const TraceStats_FinalFlushOutcome& value) { final_flush_outcome_ = value; _has_field_.set(15); }
