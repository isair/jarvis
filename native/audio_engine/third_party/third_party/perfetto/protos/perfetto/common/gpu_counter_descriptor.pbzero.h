...
class GpuCounterDescriptor : public ::protozero::Message {
 public:
  ...
  static constexpr GpuCounterGroup UNCLASSIFIED = GpuCounterGroup::UNCLASSIFIED;
  static constexpr GpuCounterGroup SYSTEM = GpuCounterGroup::SYSTEM;
  static constexpr GpuCounterGroup VERTICES = GpuCounterGroup::VERTICES;
  static constexpr GpuCounterGroup FRAGMENTS = GpuCounterGroup::FRAGMENTS;
  static constexpr GpuCounterGroup PRIMITIVES = GpuCounterGroup::PRIMITIVES;
  static constexpr GpuCounterGroup MEMORY = GpuCounterGroup::MEMORY;
  static constexpr GpuCounterGroup COMPUTE = GpuCounterGroup::COMPUTE;
  static constexpr MeasureUnit NONE = MeasureUnit::NONE;
  static constexpr MeasureUnit BIT = MeasureUnit::BIT;
  static constexpr MeasureUnit KILOBIT = MeasureUnit::KILOBIT;
  static constexpr MeasureUnit MEGABIT = MeasureUnit::MEGABIT;
  static constexpr MeasureUnit GIGABIT = MeasureUnit::GIGABIT;
  static constexpr MeasureUnit TERABIT = MeasureUnit::TERABIT;
  static constexpr MeasureUnit PETABIT = MeasureUnit::PETABIT;
  static constexpr MeasureUnit BYTE = MeasureUnit::BYTE;
  static constexpr MeasureUnit KILOBYTE = MeasureUnit::KILOBYTE;
  static constexpr MeasureUnit MEGABYTE = MeasureUnit::MEGABYTE;
  static constexpr MeasureUnit GIGABYTE = MeasureUnit::GIGABYTE;
  static constexpr MeasureUnit TERABYTE = MeasureUnit::TERABYTE;
  static constexpr MeasureUnit PETABYTE = MeasureUnit::PETABYTE;
  static constexpr MeasureUnit HERTZ = MeasureUnit::HERTZ;
  static constexpr MeasureUnit KILOHERTZ = MeasureUnit::KILOHERTZ;
  static constexpr MeasureUnit MEGAHERTZ = MeasureUnit::MEGAHERTZ;
  static constexpr MeasureUnit GIGAHERTZ = MeasureUnit::GIGAHERTZ;
  static constexpr MeasureUnit TERAHERTZ = MeasureUnit::TERAHERTZ;
  static constexpr MeasureUnit PETAHERTZ = MeasureUnit::PETAHERTZ;
  static constexpr MeasureUnit NANOSECOND = MeasureUnit::NANOSECOND;
  static constexpr MeasureUnit MICROSECOND = MeasureUnit::MICROSECOND;
  static constexpr MeasureUnit MILLISECOND = MeasureUnit::MILLISECOND;
  static constexpr MeasureUnit SECOND = MeasureUnit::SECOND;
  static constexpr MeasureUnit MINUTE = MeasureUnit::MINUTE;
  static constexpr MeasureUnit HOUR = MeasureUnit::HOUR;
  static constexpr MeasureUnit VERTEX = MeasureUnit::VERTEX;
  static constexpr MeasureUnit PIXEL = MeasureUnit::PIXEL;
  static constexpr MeasureUnit TRIANGLE = MeasureUnit::TRIANGLE;
  static constexpr MeasureUnit PRIMITIVE = MeasureUnit::PRIMITIVE;
  static constexpr MeasureUnit FRAGMENT = MeasureUnit::FRAGMENT;
  static constexpr MeasureUnit MILLIWATT = MeasureUnit::MILLIWATT;
  static constexpr MeasureUnit WATT = MeasureUnit::WATT;
  static constexpr MeasureUnit KILOWATT = MeasureUnit::KILOWATT;
  static constexpr MeasureUnit JOULE = MeasureUnit::JOULE;
  static constexpr MeasureUnit VOLT = MeasureUnit::VOLT;
  static constexpr MeasureUnit AMPERE = MeasureUnit::AMPERE;
  static constexpr MeasureUnit CELSIUS = MeasureUnit::CELSIUS;
  static constexpr MeasureUnit FAHRENHEIT = MeasureUnit::FAHRENHEIT;
  static constexpr MeasureUnit KELVIN = MeasureUnit::KELVIN;
  static constexpr MeasureUnit PERCENT = MeasureUnit::PERCENT;
  static constexpr MeasureUnit INSTRUCTION = MeasureUnit::INSTRUCTION;
