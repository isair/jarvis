...
class PERFETTO_EXPORT_COMPONENT DataSourceDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  void set_gpu_counter_descriptor_raw(std::string raw) { gpu_counter_descriptor_ = std::move(raw); _has_field_.set(5); }

  const std::string& track_event_descriptor_raw() const { return track_event_descriptor_; }
  void set_track_event_descriptor_raw(std::string raw) { track_event_descriptor_ = std::move(raw); _has_field_.set(6); }

  const std::string& ftrace_descriptor_raw() const { return ftrace_descriptor_; }
  void set_ftrace_descriptor_raw(std::string raw) { ftrace_descriptor_ = std::move(raw); _has_field_.set(8); }
