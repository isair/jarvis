...
class PERFETTO_EXPORT_COMPONENT PerfEvents_Timebase : public ::protozero::CppMessageObj {
 public:
  ...
  const PerfEvents_Counter& counter() const { return counter_; }
  void set_counter(const PerfEvents_Counter& value) { counter_ = value; _has_field_.set(4); }
  ...
  const PerfEvents_PerfClock& timestamp_clock() const { return timestamp_clock_; }
  void set_timestamp_clock(const PerfEvents_PerfClock& value) { timestamp_clock_ = value; _has_field_.set(11); }
...
class PERFETTO_EXPORT_COMPONENT FollowerEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const PerfEvents_Counter& counter() const { return counter_; }
  void set_counter(const PerfEvents_Counter& value) { counter_ = value; _has_field_.set(1); }
