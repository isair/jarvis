...
class PERFETTO_EXPORT_COMPONENT ObservableEvents_DataSourceInstanceStateChange : public ::protozero::CppMessageObj {
 public:
  ...
  const ObservableEvents_DataSourceInstanceState& state() const { return state_; }
  void set_state(const ObservableEvents_DataSourceInstanceState& value) { state_ = value; _has_field_.set(3); }
