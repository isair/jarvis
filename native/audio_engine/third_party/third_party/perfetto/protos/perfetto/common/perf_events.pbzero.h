...
class PerfEvents : public ::protozero::Message {
 public:
  ...
  static constexpr Counter UNKNOWN_COUNTER = Counter::UNKNOWN_COUNTER;
  static constexpr Counter SW_CPU_CLOCK = Counter::SW_CPU_CLOCK;
  static constexpr Counter SW_PAGE_FAULTS = Counter::SW_PAGE_FAULTS;
  static constexpr Counter SW_TASK_CLOCK = Counter::SW_TASK_CLOCK;
  static constexpr Counter SW_CONTEXT_SWITCHES = Counter::SW_CONTEXT_SWITCHES;
  static constexpr Counter SW_CPU_MIGRATIONS = Counter::SW_CPU_MIGRATIONS;
  static constexpr Counter SW_PAGE_FAULTS_MIN = Counter::SW_PAGE_FAULTS_MIN;
  static constexpr Counter SW_PAGE_FAULTS_MAJ = Counter::SW_PAGE_FAULTS_MAJ;
  static constexpr Counter SW_ALIGNMENT_FAULTS = Counter::SW_ALIGNMENT_FAULTS;
  static constexpr Counter SW_EMULATION_FAULTS = Counter::SW_EMULATION_FAULTS;
  static constexpr Counter SW_DUMMY = Counter::SW_DUMMY;
  static constexpr Counter HW_CPU_CYCLES = Counter::HW_CPU_CYCLES;
  static constexpr Counter HW_INSTRUCTIONS = Counter::HW_INSTRUCTIONS;
  static constexpr Counter HW_CACHE_REFERENCES = Counter::HW_CACHE_REFERENCES;
  static constexpr Counter HW_CACHE_MISSES = Counter::HW_CACHE_MISSES;
  static constexpr Counter HW_BRANCH_INSTRUCTIONS = Counter::HW_BRANCH_INSTRUCTIONS;
  static constexpr Counter HW_BRANCH_MISSES = Counter::HW_BRANCH_MISSES;
  static constexpr Counter HW_BUS_CYCLES = Counter::HW_BUS_CYCLES;
  static constexpr Counter HW_STALLED_CYCLES_FRONTEND = Counter::HW_STALLED_CYCLES_FRONTEND;
  static constexpr Counter HW_STALLED_CYCLES_BACKEND = Counter::HW_STALLED_CYCLES_BACKEND;
  static constexpr Counter HW_REF_CPU_CYCLES = Counter::HW_REF_CPU_CYCLES;
  static constexpr PerfClock UNKNOWN_PERF_CLOCK = PerfClock::UNKNOWN_PERF_CLOCK;
  static constexpr PerfClock PERF_CLOCK_REALTIME = PerfClock::PERF_CLOCK_REALTIME;
  static constexpr PerfClock PERF_CLOCK_MONOTONIC = PerfClock::PERF_CLOCK_MONOTONIC;
  static constexpr PerfClock PERF_CLOCK_MONOTONIC_RAW = PerfClock::PERF_CLOCK_MONOTONIC_RAW;
  static constexpr PerfClock PERF_CLOCK_BOOTTIME = PerfClock::PERF_CLOCK_BOOTTIME;
};
