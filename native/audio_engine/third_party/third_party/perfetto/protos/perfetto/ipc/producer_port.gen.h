...
class PERFETTO_EXPORT_COMPONENT InitializeConnectionRequest : public ::protozero::CppMessageObj {
 public:
  ...
  const InitializeConnectionRequest_ProducerSMBScrapingMode& smb_scraping_mode() const { return smb_scraping_mode_; }
  void set_smb_scraping_mode(const InitializeConnectionRequest_ProducerSMBScrapingMode& value) { smb_scraping_mode_ = value; _has_field_.set(4); }
