...
class PERFETTO_EXPORT_COMPONENT TraceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const TraceConfig_LockdownModeOperation& lockdown_mode() const { return lockdown_mode_; }
  void set_lockdown_mode(const TraceConfig_LockdownModeOperation& value) { lockdown_mode_ = value; _has_field_.set(5); }
  ...
  const TraceConfig_CompressionType& compression_type() const { return compression_type_; }
  void set_compression_type(const TraceConfig_CompressionType& value) { compression_type_ = value; _has_field_.set(24); }
  ...
  const TraceConfig_StatsdLogging& statsd_logging() const { return statsd_logging_; }
  void set_statsd_logging(const TraceConfig_StatsdLogging& value) { statsd_logging_ = value; _has_field_.set(31); }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_TraceFilter_StringFilterRule : public ::protozero::CppMessageObj {
 public:
  ...
  const TraceConfig_TraceFilter_StringFilterPolicy& policy() const { return policy_; }
  void set_policy(const TraceConfig_TraceFilter_StringFilterPolicy& value) { policy_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_TriggerConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const TraceConfig_TriggerConfig_TriggerMode& trigger_mode() const { return trigger_mode_; }
  void set_trigger_mode(const TraceConfig_TriggerConfig_TriggerMode& value) { trigger_mode_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_BuiltinDataSource : public ::protozero::CppMessageObj {
 public:
  ...
  const BuiltinClock& primary_trace_clock() const { return primary_trace_clock_; }
  void set_primary_trace_clock(const BuiltinClock& value) { primary_trace_clock_ = value; _has_field_.set(5); }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_BufferConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const TraceConfig_BufferConfig_FillPolicy& fill_policy() const { return fill_policy_; }
  void set_fill_policy(const TraceConfig_BufferConfig_FillPolicy& value) { fill_policy_ = value; _has_field_.set(4); }
