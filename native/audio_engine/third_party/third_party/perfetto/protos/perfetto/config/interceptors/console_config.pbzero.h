...
class ConsoleConfig : public ::protozero::Message {
 public:
  ...
  static constexpr Output OUTPUT_UNSPECIFIED = Output::OUTPUT_UNSPECIFIED;
  static constexpr Output OUTPUT_STDOUT = Output::OUTPUT_STDOUT;
  static constexpr Output OUTPUT_STDERR = Output::OUTPUT_STDERR;
