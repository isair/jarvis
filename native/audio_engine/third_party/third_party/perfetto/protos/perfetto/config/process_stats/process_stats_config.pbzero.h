...
class ProcessStatsConfig : public ::protozero::Message {
 public:
  ...
  static constexpr Quirks QUIRKS_UNSPECIFIED = Quirks::QUIRKS_UNSPECIFIED;
  static constexpr Quirks DISABLE_INITIAL_DUMP = Quirks::DISABLE_INITIAL_DUMP;
  static constexpr Quirks DISABLE_ON_DEMAND = Quirks::DISABLE_ON_DEMAND;
