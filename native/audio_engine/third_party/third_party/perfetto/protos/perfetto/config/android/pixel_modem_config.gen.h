...
class PERFETTO_EXPORT_COMPONENT PixelModemConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const PixelModemConfig_EventGroup& event_group() const { return event_group_; }
  void set_event_group(const PixelModemConfig_EventGroup& value) { event_group_ = value; _has_field_.set(1); }
