...
class PERFETTO_EXPORT_COMPONENT SurfaceFlingerTransactionsConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const SurfaceFlingerTransactionsConfig_Mode& mode() const { return mode_; }
  void set_mode(const SurfaceFlingerTransactionsConfig_Mode& value) { mode_ = value; _has_field_.set(1); }
