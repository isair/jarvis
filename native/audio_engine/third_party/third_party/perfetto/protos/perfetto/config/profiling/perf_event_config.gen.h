...
class PERFETTO_EXPORT_COMPONENT PerfEventConfig_CallstackSampling : public ::protozero::CppMessageObj {
 public:
  ...
  const PerfEventConfig_UnwindMode& user_frames() const { return user_frames_; }
  void set_user_frames(const PerfEventConfig_UnwindMode& value) { user_frames_ = value; _has_field_.set(3); }
