...
class PERFETTO_EXPORT_COMPONENT DataSourceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const DataSourceConfig_SessionInitiator& session_initiator() const { return session_initiator_; }
  void set_session_initiator(const DataSourceConfig_SessionInitiator& value) { session_initiator_ = value; _has_field_.set(8); }
  ...
  const DataSourceConfig_BufferExhaustedPolicy& buffer_exhausted_policy() const { return buffer_exhausted_policy_; }
  void set_buffer_exhausted_policy(const DataSourceConfig_BufferExhaustedPolicy& value) { buffer_exhausted_policy_ = value; _has_field_.set(9); }

  const std::string& ftrace_config_raw() const { return ftrace_config_; }
  void set_ftrace_config_raw(std::string raw) { ftrace_config_ = std::move(raw); _has_field_.set(100); }

  const std::string& inode_file_config_raw() const { return inode_file_config_; }
  void set_inode_file_config_raw(std::string raw) { inode_file_config_ = std::move(raw); _has_field_.set(102); }

  const std::string& process_stats_config_raw() const { return process_stats_config_; }
  void set_process_stats_config_raw(std::string raw) { process_stats_config_ = std::move(raw); _has_field_.set(103); }

  const std::string& sys_stats_config_raw() const { return sys_stats_config_; }
  void set_sys_stats_config_raw(std::string raw) { sys_stats_config_ = std::move(raw); _has_field_.set(104); }

  const std::string& heapprofd_config_raw() const { return heapprofd_config_; }
  void set_heapprofd_config_raw(std::string raw) { heapprofd_config_ = std::move(raw); _has_field_.set(105); }

  const std::string& java_hprof_config_raw() const { return java_hprof_config_; }
  void set_java_hprof_config_raw(std::string raw) { java_hprof_config_ = std::move(raw); _has_field_.set(110); }

  const std::string& android_power_config_raw() const { return android_power_config_; }
  void set_android_power_config_raw(std::string raw) { android_power_config_ = std::move(raw); _has_field_.set(106); }

  const std::string& android_log_config_raw() const { return android_log_config_; }
  void set_android_log_config_raw(std::string raw) { android_log_config_ = std::move(raw); _has_field_.set(107); }

  const std::string& gpu_counter_config_raw() const { return gpu_counter_config_; }
  void set_gpu_counter_config_raw(std::string raw) { gpu_counter_config_ = std::move(raw); _has_field_.set(108); }

  const std::string& android_game_intervention_list_config_raw() const { return android_game_intervention_list_config_; }
  void set_android_game_intervention_list_config_raw(std::string raw) { android_game_intervention_list_config_ = std::move(raw); _has_field_.set(116); }

  const std::string& packages_list_config_raw() const { return packages_list_config_; }
  void set_packages_list_config_raw(std::string raw) { packages_list_config_ = std::move(raw); _has_field_.set(109); }

  const std::string& perf_event_config_raw() const { return perf_event_config_; }
  void set_perf_event_config_raw(std::string raw) { perf_event_config_ = std::move(raw); _has_field_.set(111); }

  const std::string& vulkan_memory_config_raw() const { return vulkan_memory_config_; }
  void set_vulkan_memory_config_raw(std::string raw) { vulkan_memory_config_ = std::move(raw); _has_field_.set(112); }

  const std::string& track_event_config_raw() const { return track_event_config_; }
  void set_track_event_config_raw(std::string raw) { track_event_config_ = std::move(raw); _has_field_.set(113); }

  const std::string& android_polled_state_config_raw() const { return android_polled_state_config_; }
  void set_android_polled_state_config_raw(std::string raw) { android_polled_state_config_ = std::move(raw); _has_field_.set(114); }

  const std::string& android_system_property_config_raw() const { return android_system_property_config_; }
  void set_android_system_property_config_raw(std::string raw) { android_system_property_config_ = std::move(raw); _has_field_.set(118); }

  const std::string& statsd_tracing_config_raw() const { return statsd_tracing_config_; }
  void set_statsd_tracing_config_raw(std::string raw) { statsd_tracing_config_ = std::move(raw); _has_field_.set(117); }
  ...
  void set_frozen_ftrace_config_raw(std::string raw) { frozen_ftrace_config_ = std::move(raw); _has_field_.set(136); }
  ...
  void set_v8_config_raw(std::string raw) { v8_config_ = std::move(raw); _has_field_.set(127); }
  ...
  void set_network_packet_trace_config_raw(std::string raw) { network_packet_trace_config_ = std::move(raw); _has_field_.set(120); }

  const std::string& surfaceflinger_layers_config_raw() const { return surfaceflinger_layers_config_; }
  void set_surfaceflinger_layers_config_raw(std::string raw) { surfaceflinger_layers_config_ = std::move(raw); _has_field_.set(121); }

  const std::string& surfaceflinger_transactions_config_raw() const { return surfaceflinger_transactions_config_; }
  void set_surfaceflinger_transactions_config_raw(std::string raw) { surfaceflinger_transactions_config_ = std::move(raw); _has_field_.set(123); }

  const std::string& android_sdk_sysprop_guard_config_raw() const { return android_sdk_sysprop_guard_config_; }
  void set_android_sdk_sysprop_guard_config_raw(std::string raw) { android_sdk_sysprop_guard_config_ = std::move(raw); _has_field_.set(124); }

  const std::string& etw_config_raw() const { return etw_config_; }
  void set_etw_config_raw(std::string raw) { etw_config_ = std::move(raw); _has_field_.set(125); }

  const std::string& protolog_config_raw() const { return protolog_config_; }
  void set_protolog_config_raw(std::string raw) { protolog_config_ = std::move(raw); _has_field_.set(126); }

  const std::string& android_input_event_config_raw() const { return android_input_event_config_; }
  void set_android_input_event_config_raw(std::string raw) { android_input_event_config_ = std::move(raw); _has_field_.set(128); }

  const std::string& pixel_modem_config_raw() const { return pixel_modem_config_; }
  void set_pixel_modem_config_raw(std::string raw) { pixel_modem_config_ = std::move(raw); _has_field_.set(129); }

  const std::string& windowmanager_config_raw() const { return windowmanager_config_; }
  void set_windowmanager_config_raw(std::string raw) { windowmanager_config_ = std::move(raw); _has_field_.set(130); }

  const std::string& chromium_system_metrics_raw() const { return chromium_system_metrics_; }
  void set_chromium_system_metrics_raw(std::string raw) { chromium_system_metrics_ = std::move(raw); _has_field_.set(131); }

  const std::string& kernel_wakelocks_config_raw() const { return kernel_wakelocks_config_; }
  void set_kernel_wakelocks_config_raw(std::string raw) { kernel_wakelocks_config_ = std::move(raw); _has_field_.set(132); }

  const std::string& gpu_renderstages_config_raw() const { return gpu_renderstages_config_; }
  void set_gpu_renderstages_config_raw(std::string raw) { gpu_renderstages_config_ = std::move(raw); _has_field_.set(133); }

  const std::string& chromium_histogram_samples_raw() const { return chromium_histogram_samples_; }
  void set_chromium_histogram_samples_raw(std::string raw) { chromium_histogram_samples_ = std::move(raw); _has_field_.set(134); }

  const std::string& app_wakelocks_config_raw() const { return app_wakelocks_config_; }
  void set_app_wakelocks_config_raw(std::string raw) { app_wakelocks_config_ = std::move(raw); _has_field_.set(135); }

  const std::string& cpu_per_uid_config_raw() const { return cpu_per_uid_config_; }
  void set_cpu_per_uid_config_raw(std::string raw) { cpu_per_uid_config_ = std::move(raw); _has_field_.set(137); }
