...
class ChromeConfig : public ::protozero::Message {
 public:
  ...
  static constexpr ClientPriority UNKNOWN = ClientPriority::UNKNOWN;
  static constexpr ClientPriority BACKGROUND = ClientPriority::BACKGROUND;
  static constexpr ClientPriority USER_INITIATED = ClientPriority::USER_INITIATED;
