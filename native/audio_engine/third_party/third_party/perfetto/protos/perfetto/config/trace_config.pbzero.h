...
class TraceConfig : public ::protozero::Message {
 public:
  ...
  static constexpr LockdownModeOperation LOCKDOWN_UNCHANGED = LockdownModeOperation::LOCKDOWN_UNCHANGED;
  static constexpr LockdownModeOperation LOCKDOWN_CLEAR = LockdownModeOperation::LOCKDOWN_CLEAR;
  static constexpr LockdownModeOperation LOCKDOWN_SET = LockdownModeOperation::LOCKDOWN_SET;
  static constexpr CompressionType COMPRESSION_TYPE_UNSPECIFIED = CompressionType::COMPRESSION_TYPE_UNSPECIFIED;
  static constexpr CompressionType COMPRESSION_TYPE_DEFLATE = CompressionType::COMPRESSION_TYPE_DEFLATE;
  static constexpr StatsdLogging STATSD_LOGGING_UNSPECIFIED = StatsdLogging::STATSD_LOGGING_UNSPECIFIED;
  static constexpr StatsdLogging STATSD_LOGGING_ENABLED = StatsdLogging::STATSD_LOGGING_ENABLED;
  static constexpr StatsdLogging STATSD_LOGGING_DISABLED = StatsdLogging::STATSD_LOGGING_DISABLED;
...
class TraceConfig_TraceFilter : public ::protozero::Message {
 public:
  ...
  static constexpr StringFilterPolicy SFP_UNSPECIFIED = StringFilterPolicy::SFP_UNSPECIFIED;
  static constexpr StringFilterPolicy SFP_MATCH_REDACT_GROUPS = StringFilterPolicy::SFP_MATCH_REDACT_GROUPS;
  static constexpr StringFilterPolicy SFP_ATRACE_MATCH_REDACT_GROUPS = StringFilterPolicy::SFP_ATRACE_MATCH_REDACT_GROUPS;
  static constexpr StringFilterPolicy SFP_MATCH_BREAK = StringFilterPolicy::SFP_MATCH_BREAK;
  static constexpr StringFilterPolicy SFP_ATRACE_MATCH_BREAK = StringFilterPolicy::SFP_ATRACE_MATCH_BREAK;
  static constexpr StringFilterPolicy SFP_ATRACE_REPEATED_SEARCH_REDACT_GROUPS = StringFilterPolicy::SFP_ATRACE_REPEATED_SEARCH_REDACT_GROUPS;
...
class TraceConfig_TriggerConfig : public ::protozero::Message {
 public:
  ...
  static constexpr TriggerMode UNSPECIFIED = TriggerMode::UNSPECIFIED;
  static constexpr TriggerMode START_TRACING = TriggerMode::START_TRACING;
  static constexpr TriggerMode STOP_TRACING = TriggerMode::STOP_TRACING;
  static constexpr TriggerMode CLONE_SNAPSHOT = TriggerMode::CLONE_SNAPSHOT;
...
class TraceConfig_BufferConfig : public ::protozero::Message {
 public:
  ...
  static constexpr FillPolicy UNSPECIFIED = FillPolicy::UNSPECIFIED;
  static constexpr FillPolicy RING_BUFFER = FillPolicy::RING_BUFFER;
  static constexpr FillPolicy DISCARD = FillPolicy::DISCARD;
