...
class PERFETTO_EXPORT_COMPONENT WindowManagerConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const WindowManagerConfig_LogFrequency& log_frequency() const { return log_frequency_; }
  void set_log_frequency(const WindowManagerConfig_LogFrequency& value) { log_frequency_ = value; _has_field_.set(1); }

  bool has_log_level() const { return _has_field_[2]; }
  const WindowManagerConfig_LogLevel& log_level() const { return log_level_; }
  void set_log_level(const WindowManagerConfig_LogLevel& value) { log_level_ = value; _has_field_.set(2); }
