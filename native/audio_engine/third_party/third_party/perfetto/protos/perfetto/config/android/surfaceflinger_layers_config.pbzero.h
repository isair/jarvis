...
class SurfaceFlingerLayersConfig : public ::protozero::Message {
 public:
  ...
  static constexpr Mode MODE_UNSPECIFIED = Mode::MODE_UNSPECIFIED;
  static constexpr Mode MODE_ACTIVE = Mode::MODE_ACTIVE;
  static constexpr Mode MODE_GENERATED = Mode::MODE_GENERATED;
  static constexpr Mode MODE_DUMP = Mode::MODE_DUMP;
  static constexpr Mode MODE_GENERATED_BUGREPORT_ONLY = Mode::MODE_GENERATED_BUGREPORT_ONLY;
  static constexpr TraceFlag TRACE_FLAG_UNSPECIFIED = TraceFlag::TRACE_FLAG_UNSPECIFIED;
  static constexpr TraceFlag TRACE_FLAG_INPUT = TraceFlag::TRACE_FLAG_INPUT;
  static constexpr TraceFlag TRACE_FLAG_COMPOSITION = TraceFlag::TRACE_FLAG_COMPOSITION;
  static constexpr TraceFlag TRACE_FLAG_EXTRA = TraceFlag::TRACE_FLAG_EXTRA;
  static constexpr TraceFlag TRACE_FLAG_HWC = TraceFlag::TRACE_FLAG_HWC;
  static constexpr TraceFlag TRACE_FLAG_BUFFERS = TraceFlag::TRACE_FLAG_BUFFERS;
  static constexpr TraceFlag TRACE_FLAG_VIRTUAL_DISPLAYS = TraceFlag::TRACE_FLAG_VIRTUAL_DISPLAYS;
  static constexpr TraceFlag TRACE_FLAG_ALL = TraceFlag::TRACE_FLAG_ALL;
