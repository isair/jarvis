...
class SysStatsConfig : public ::protozero::Message {
 public:
  ...
  static constexpr StatCounters STAT_UNSPECIFIED = StatCounters::STAT_UNSPECIFIED;
  static constexpr StatCounters STAT_CPU_TIMES = StatCounters::STAT_CPU_TIMES;
  static constexpr StatCounters STAT_IRQ_COUNTS = StatCounters::STAT_IRQ_COUNTS;
  static constexpr StatCounters STAT_SOFTIRQ_COUNTS = StatCounters::STAT_SOFTIRQ_COUNTS;
  static constexpr StatCounters STAT_FORK_COUNT = StatCounters::STAT_FORK_COUNT;
