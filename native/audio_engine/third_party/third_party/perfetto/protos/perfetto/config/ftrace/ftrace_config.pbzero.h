...
class FtraceConfig : public ::protozero::Message {
 public:
  ...
  static constexpr KsymsMemPolicy KSYMS_UNSPECIFIED = KsymsMemPolicy::KSYMS_UNSPECIFIED;
  static constexpr KsymsMemPolicy KSYMS_CLEANUP_ON_STOP = KsymsMemPolicy::KSYMS_CLEANUP_ON_STOP;
  static constexpr KsymsMemPolicy KSYMS_RETAIN = KsymsMemPolicy::KSYMS_RETAIN;
...
class FtraceConfig_KprobeEvent : public ::protozero::Message {
 public:
  ...
  static constexpr KprobeType KPROBE_TYPE_UNKNOWN = KprobeType::KPROBE_TYPE_UNKNOWN;
  static constexpr KprobeType KPROBE_TYPE_KPROBE = KprobeType::KPROBE_TYPE_KPROBE;
  static constexpr KprobeType KPROBE_TYPE_KRETPROBE = KprobeType::KPROBE_TYPE_KRETPROBE;
  static constexpr KprobeType KPROBE_TYPE_BOTH = KprobeType::KPROBE_TYPE_BOTH;
