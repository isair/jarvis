...
class PERFETTO_EXPORT_COMPONENT ProtoLogConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const ProtoLogConfig_TracingMode& tracing_mode() const { return tracing_mode_; }
  void set_tracing_mode(const ProtoLogConfig_TracingMode& value) { tracing_mode_ = value; _has_field_.set(2); }

  bool has_default_log_from_level() const { return _has_field_[3]; }
  const ProtoLogLevel& default_log_from_level() const { return default_log_from_level_; }
  void set_default_log_from_level(const ProtoLogLevel& value) { default_log_from_level_ = value; _has_field_.set(3); }
...
class PERFETTO_EXPORT_COMPONENT ProtoLogGroup : public ::protozero::CppMessageObj {
 public:
  ...
  const ProtoLogLevel& log_from() const { return log_from_; }
  void set_log_from(const ProtoLogLevel& value) { log_from_ = value; _has_field_.set(2); }
