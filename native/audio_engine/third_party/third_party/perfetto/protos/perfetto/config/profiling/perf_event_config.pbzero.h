...
class PerfEventConfig : public ::protozero::Message {
 public:
  ...
  static constexpr UnwindMode UNWIND_UNKNOWN = UnwindMode::UNWIND_UNKNOWN;
  static constexpr UnwindMode UNWIND_SKIP = UnwindMode::UNWIND_SKIP;
  static constexpr UnwindMode UNWIND_DWARF = UnwindMode::UNWIND_DWARF;
  static constexpr UnwindMode UNWIND_FRAME_POINTER = UnwindMode::UNWIND_FRAME_POINTER;
