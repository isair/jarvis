...
class PERFETTO_EXPORT_COMPONENT FtraceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const FtraceConfig_KsymsMemPolicy& ksyms_mem_policy() const { return ksyms_mem_policy_; }
  void set_ksyms_mem_policy(const FtraceConfig_KsymsMemPolicy& value) { ksyms_mem_policy_ = value; _has_field_.set(17); }
...
class PERFETTO_EXPORT_COMPONENT FtraceConfig_KprobeEvent : public ::protozero::CppMessageObj {
 public:
  ...
  const FtraceConfig_KprobeEvent_KprobeType& type() const { return type_; }
  void set_type(const FtraceConfig_KprobeEvent_KprobeType& value) { type_ = value; _has_field_.set(2); }
