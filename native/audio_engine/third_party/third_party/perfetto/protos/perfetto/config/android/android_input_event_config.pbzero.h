...
class AndroidInputEventConfig : public ::protozero::Message {
 public:
  ...
  static constexpr TraceMode TRACE_MODE_TRACE_ALL = TraceMode::TRACE_MODE_TRACE_ALL;
  static constexpr TraceMode TRACE_MODE_USE_RULES = TraceMode::TRACE_MODE_USE_RULES;
  static constexpr TraceLevel TRACE_LEVEL_NONE = TraceLevel::TRACE_LEVEL_NONE;
  static constexpr TraceLevel TRACE_LEVEL_REDACTED = TraceLevel::TRACE_LEVEL_REDACTED;
  static constexpr TraceLevel TRACE_LEVEL_COMPLETE = TraceLevel::TRACE_LEVEL_COMPLETE;
