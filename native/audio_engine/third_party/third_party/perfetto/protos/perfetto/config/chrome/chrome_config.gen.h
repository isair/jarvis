...
class PERFETTO_EXPORT_COMPONENT ChromeConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const ChromeConfig_ClientPriority& client_priority() const { return client_priority_; }
  void set_client_priority(const ChromeConfig_ClientPriority& value) { client_priority_ = value; _has_field_.set(4); }
