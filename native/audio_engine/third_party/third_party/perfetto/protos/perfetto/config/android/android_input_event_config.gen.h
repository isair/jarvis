...
class PERFETTO_EXPORT_COMPONENT AndroidInputEventConfig : public ::protozero::CppMessageObj {
 public:
  ...
  const AndroidInputEventConfig_TraceMode& mode() const { return mode_; }
  void set_mode(const AndroidInputEventConfig_TraceMode& value) { mode_ = value; _has_field_.set(1); }
...
class PERFETTO_EXPORT_COMPONENT AndroidInputEventConfig_TraceRule : public ::protozero::CppMessageObj {
 public:
  ...
  const AndroidInputEventConfig_TraceLevel& trace_level() const { return trace_level_; }
  void set_trace_level(const AndroidInputEventConfig_TraceLevel& value) { trace_level_ = value; _has_field_.set(1); }
