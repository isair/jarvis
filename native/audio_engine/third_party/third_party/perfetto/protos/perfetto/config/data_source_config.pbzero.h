...
class DataSourceConfig : public ::protozero::Message {
 public:
  ...
  static constexpr SessionInitiator SESSION_INITIATOR_UNSPECIFIED = SessionInitiator::SESSION_INITIATOR_UNSPECIFIED;
  static constexpr SessionInitiator SESSION_INITIATOR_TRUSTED_SYSTEM = SessionInitiator::SESSION_INITIATOR_TRUSTED_SYSTEM;
  static constexpr BufferExhaustedPolicy BUFFER_EXHAUSTED_UNSPECIFIED = BufferExhaustedPolicy::BUFFER_EXHAUSTED_UNSPECIFIED;
  static constexpr BufferExhaustedPolicy BUFFER_EXHAUSTED_DROP = BufferExhaustedPolicy::BUFFER_EXHAUSTED_DROP;
  static constexpr BufferExhaustedPolicy BUFFER_EXHAUSTED_STALL_THEN_ABORT = BufferExhaustedPolicy::BUFFER_EXHAUSTED_STALL_THEN_ABORT;
  static constexpr BufferExhaustedPolicy BUFFER_EXHAUSTED_STALL_THEN_DROP = BufferExhaustedPolicy::BUFFER_EXHAUSTED_STALL_THEN_DROP;
